var g_catalog=[{name:"基本信息",icon:"info_36.png",link:"admin_use.php"},{name:"用户管理",icon:"user.png",link:"admin_users.html"},{name:"访问统计",icon:"chart.png",link:"admin_job.html"},{name:"数据管理",icon:"db.png",link:"admin_data.html"},{name:"节点管理",icon:"monitor.png",link:"http://ourgis.digitalearth.cn/monitor/"},{name:"负载均衡",icon:"computer_36.png",link:"admin_ha.php"},{name:"API",icon:"note.png",link:"../API/index_admin.html"}];
