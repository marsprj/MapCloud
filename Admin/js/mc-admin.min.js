var g_catalog=[{name:"用户管理",icon:"user.png",link:"admin_users.html"},{name:"访问统计",icon:"chart.png",link:"admin_job.html"},{name:"数据管理",icon:"db.png",link:"admin_data.html"},{name:"节点管理",icon:"monitor.png",link:"http://ourgis.digitalearth.cn/monitor/"},{name:"API",icon:"note.png",link:"../API/index_admin.html"}];
