...
MapCloud.ProjectPanel=MapCloud.Class(MapCloud.Panel,{showFlag:!1,server:"/ows/radi/mgr",baseSourceName:"base",earthquakeLayerName:"x3_地震",earthquakeFeatures:null,earthquakeFeatureType:null,earthquakeFields:["location","shape"],exerciseLayerName:"x3_演习",exerciseFeatures:null,exerciseFeatureType:null,exerciseFields:["title","shape"],fluLayerName:"流感",fluFeatures:null,fluFeatureType:null,fluFields:["shape"],africaLayerName:"gz_africa",africaFeatures:null,africaFeatureType:null,africaFields:["cnname","shape"],usaLayerName:"x3_美日东盟会议",usaFeatures:null,usaFeatureType:null,usaFields:["title","shape"],chinaLayerName:"x3_中国东盟会议",chinaFeatures:null,chinaFeatureType:null,chinaFields:["title","shape"],initialize:function(e){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent(),this.showFlag=MapCloud.topicPanel.showFlag;var a=new GeoBeans.WFSWorkspace("tmp",this.server,"1.0.0");this.earthquakeFeatureType=new GeoBeans.FeatureType(a,this.earthquakeLayerName),this.exerciseFeatureType=new GeoBeans.FeatureType(a,this.exerciseLayerName),this.fluFeatureType=new GeoBeans.FeatureType(a,this.fluLayerName),this.africaFeatureType=new GeoBeans.FeatureType(a,this.africaLayerName),this.usaFeatureType=new GeoBeans.FeatureType(a,this.usaLayerName),this.chinaFeatureType=new GeoBeans.FeatureType(a,this.chinaLayerName)},registerEvent:function(){var e=this;this.panel.find("[data-toggle='tooltip']").tooltip({container:"body"}),this.panel.find(".mc-icon").each(function(a,l){$(this).click(function(){switch(a){case 0:e.onStretch(this);break;case 1:1==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getEarthquake(),e.showFlag=!0);break;case 2:2==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getExercise(),e.showFlag=!0);break;case 3:3==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getFlu(),e.showFlag=!0);break;case 4:4==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getAfrica(),e.showFlag=!0);break;case 5:5==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getUsa(),e.showFlag=!0);break;case 6:6==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getChina(),e.showFlag=!0)}e.preIndex=a})})},onStretch:function(e){$(e).hasClass("mc-icon-left")?(this.panel.children().not(".mc-stretch").css("display","block"),$(e).removeClass("mc-icon-left"),$(e).addClass("mc-icon-right"),this.panel.animate({width:"282px"},300)):(this.panel.children().not(".mc-stretch").css("display","none"),$(e).removeClass("mc-icon-right"),$(e).addClass("mc-icon-left"),this.panel.animate({width:"40px"},300))},getEarthquake:function(){if(null!=this.earthquakeFeatures)return void this.showEarthquake(this.earthquakeFeatures);var e="js/data/earthquake.xml",a=this;this.earthquakeFeatureType.fields=this.earthquakeFeatureType.getFields(null,this.baseSourceName),$.get(e,function(e){var l=a.earthquakeFeatureType.parseFeatures(e);a.earthquakeFeatures=l,a.showEarthquake(l)})},showEarthquake:function(e){if(null!=e){Radi.Earth.cleanup();for(var a="../images/flag_2.png",l=null,t=null,r=null,u=null,s=null,i=0;i<e.length;++i)l=e[i],null!=l&&(t=l.values,null!=t&&(r=l.geometry,null!=r&&(u=r.x,s=r.y,null!=u&&null!=s&&Radi.Earth.addBillboard(u,s,"",a))));var n=107,h=30,c=8260681,o=360,F=-90,d=0;Radi.Earth.flyTo(n,h,c,o,F,d)}},getEarthquake_callback:function(e){console.log(e.length)},getExercise:function(){var e="js/data/exercise.xml",a=this;this.exerciseFeatureType.fields=this.exerciseFeatureType.getFields(null,this.baseSourceName),$.get(e,function(e){var l=a.exerciseFeatureType.parseFeatures(e);a.exerciseFeatures=l,a.showExercise(l)})},getExercise_callback:function(e){if($.isArray(e)){var a=MapCloud.projectPanel;a.exerciseFeatures=e,a.showExercise(e)}},showExercise:function(e){if(null!=e){Radi.Earth.cleanup();for(var a="../images/marker.png",l=null,t=null,r=null,u=null,s=null,i=0;i<e.length;++i)l=e[i],null!=l&&(t=l.values,null!=t&&(r=l.geometry,null!=r&&(u=r.x,s=r.y,null!=u&&null!=s&&Radi.Earth.addBillboard(u,s,"",a))));var n=107,h=30,c=8260681,o=360,F=-90,d=0;Radi.Earth.flyTo(n,h,c,o,F,d)}},getFlu:function(){if(null!=this.fluFeatures)return void this.showFlu(this.fluFeatures);var e="js/data/flu.xml",a=this;this.fluFeatureType.fields=this.fluFeatureType.getFields(null,this.baseSourceName),$.get(e,function(e){var l=a.fluFeatureType.parseFeatures(e);a.fluFeatures=l,a.showFlu(l)})},getFlu_callback:function(e){if($.isArray(e)){var a=MapCloud.projectPanel;a.fluFeatures=e,a.showFlu(e)}},showFlu:function(e){if(null!=e){Radi.Earth.cleanup();for(var a="../images/virus-red.png",l=null,t=null,r=null,u=null,s=null,i=0;i<e.length;++i)l=e[i],null!=l&&(t=l.values,null!=t&&(r=l.geometry,null!=r&&(u=r.x,s=r.y,null!=u&&null!=s&&Radi.Earth.addBillboard(u,s,"",a))));var n=107.2598,h=34.4148,c=4633881,o=360,F=-90,d=0;Radi.Earth.flyTo(n,h,c,o,F,d)}},getAfrica:function(){if(null!=this.africaFeatures)return void this.showAfrica(this.africaFeatures);var e="js/data/africa.xml",a=this,l="gisdb";this.africaFeatureType.fields=this.africaFeatureType.getFields(null,l),$.get(e,function(e){var l=a.africaFeatureType.parseFeatures(e);a.africaFeatures=l,a.showAfrica(l)})},getAfrica_callback:function(e){if($.isArray(e)){var a=MapCloud.projectPanel;a.africaFeatures=e,a.showAfrica(e)}},showAfrica:function(e){if(null!=e){Radi.Earth.cleanup();for(var a="../images/marker.png",l=null,t=null,r=null,u=null,s=null,i=null,n=this.africaFeatureType.getFieldIndex("cnname"),h=0;h<e.length;++h)l=e[h],null!=l&&(t=l.values,null!=t&&(i=t[n],null==i&&(i=""),r=l.geometry,null!=r&&(u=r.x,s=r.y,null!=u&&null!=s&&Radi.Earth.addBillboard(u,s,i,a))));var c=7.2598,o=15.4148,F=4633881,d=360,p=-90,f=0;Radi.Earth.flyTo(c,o,F,d,p,f)}},getUsa:function(){if(null!=this.usaFeatures)return void this.showUsa(this.usaFeatures);var e="js/data/usa.xml",a=this;this.usaFeatureType.fields=this.usaFeatureType.getFields(null,this.baseSourceName),$.get(e,function(e){var l=a.usaFeatureType.parseFeatures(e);a.usaFeatures=l,a.showUsa(l)})},showUsa:function(e){if(null!=e){Radi.Earth.cleanup();for(var a="../images/flag_1.png",l=null,t=null,r=null,u=null,s=null,i=null,n=this.usaFeatureType.getFieldIndex("title"),h=0;h<e.length;++h)l=e[h],null!=l&&(t=l.values,null!=t&&(i=t[n],null==i&&(i=""),r=l.geometry,null!=r&&(u=r.x,s=r.y,null!=u&&null!=s&&Radi.Earth.addBillboard(u,s,"",a))));var c=107,o=30,F=8260681,d=360,p=-90,f=0;Radi.Earth.flyTo(c,o,F,d,p,f)}},getChina:function(){if(null!=this.chinaFeatures)return void this.showChina(this.chinaFeatures);var e="js/data/china.xml",a=this;this.chinaFeatureType.fields=this.chinaFeatureType.getFields(null,this.baseSourceName),$.get(e,function(e){var l=a.chinaFeatureType.parseFeatures(e);a.chinaFeatures=l,a.showChina(l)})},showChina:function(e){if(null!=e){Radi.Earth.cleanup();for(var a="../images/flag_1.png",l=null,t=null,r=null,u=null,s=null,i=null,n=this.chinaFeatureType.getFieldIndex("title"),h=0;h<e.length;++h)l=e[h],null!=l&&(t=l.values,null!=t&&(i=t[n],null==i&&(i=""),r=l.geometry,null!=r&&(u=r.x,s=r.y,null!=u&&null!=s&&Radi.Earth.addBillboard(u,s,"",a))));var c=107,o=30,F=8260681,d=360,p=-90,f=0;Radi.Earth.flyTo(c,o,F,d,p,f)}}});
