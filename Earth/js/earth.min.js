...
MapCloud.TopicPanel=MapCloud.Class(MapCloud.Panel,{aqiChart:null,popRangeChart:null,encoRangeChart:null,perRangeChart:null,agroMapName:"agro",agroLayerName:"agro",agroFields:["ppt","x","y"],agroFeatureType:null,agroChartFlag:!1,preIndex:null,showFlag:!1,argoFeatures:null,initialize:function(a){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent();var e=new GeoBeans.WFSWorkspace("tmp",MapCloud.server,"1.0.0");this.agroFeatureType=new GeoBeans.FeatureType(e,this.agroLayerName)},registerEvent:function(){var a=this;this.panel.find("[data-toggle='tooltip']").tooltip({container:"body"}),this.panel.find(".mc-icon").each(function(e,t){$(this).click(function(){switch(e){case 0:a.onStretch(this);break;case 1:1==a.preIndex&&a.showFlag?(Radi.Earth.cleanup(),a.showFlag=!1):(a.showPerRangeChart(),a.showFlag=!0);break;case 2:2==a.preIndex&&a.showFlag?(Radi.Earth.cleanup(),a.showFlag=!1):(a.showEncoRangeChart(),a.showFlag=!0);break;case 3:3==a.preIndex&&a.showFlag?(Radi.Earth.cleanup(),a.showFlag=!1):(a.showPopRangeChart(),a.showFlag=!0);break;case 4:4==a.preIndex&&a.showFlag?(Radi.Earth.cleanup(),a.showFlag=!1):(a.getAgroData(),a.showFlag=!0);break;case 5:5==a.preIndex&&a.showFlag?(Radi.Earth.cleanup(),a.showFlag=!1):(a.showAQIChart(),a.showFlag=!0);break;case 6:a.show24AQITimeLineChart();break;case 7:a.showAQITimeLineChart()}a.preIndex=e})})},onStretch:function(a){$(a).hasClass("mc-icon-left")?(this.panel.children().not(".mc-stretch").css("display","block"),$(a).removeClass("mc-icon-left"),$(a).addClass("mc-icon-right"),this.panel.animate({width:"322px"},300)):(this.panel.children().not(".mc-stretch").css("display","none"),$(a).removeClass("mc-icon-right"),$(a).addClass("mc-icon-left"),this.panel.animate({width:"40px"},300),MapCloud.aqiTimelinePanel.hide(),MapCloud.aqi24TimelinePanel.hide())},showAQIChart:function(){if(null==this.aqiChart){var a=MapCloud.server,e="aqi",t=MapCloud.searchPanel.timepoint,n=new MapCloud.AQIChart(a,e,t);n.show(),this.aqiChart=n}else Radi.Earth.cleanup(),this.aqiChart.show()},showPopRangeChart:function(){if(null==this.popRangeChart){var a=MapCloud.server,e={sourceName:"base",layerName:"prov_bount_4m",positionField:"name"},t={sourceName:"base",layerName:"china_econmic_2014",positionField:"省区市",chartField:"人口_万人"},n=12,i=new MapCloud.RangeChart(a,e,t,n);i.show(),this.popRangeChart=i,this.setCameraPosition()}else Radi.Earth.cleanup(),this.popRangeChart.show(),this.setCameraPosition()},showEncoRangeChart:function(){if(null==this.encoRangeChart){this.cleanupChart();var a=MapCloud.server,e={sourceName:"base",layerName:"prov_bount_4m",positionField:"name"},t={sourceName:"base",layerName:"china_econmic_2014",positionField:"省区市",chartField:"gdp_亿元"},n=12,i=new MapCloud.RangeChart(a,e,t,n);i.show(),this.encoRangeChart=i,this.setCameraPosition()}else Radi.Earth.cleanup(),this.encoRangeChart.show(),this.setCameraPosition()},showPerRangeChart:function(){if(null==this.perRangeChart){this.cleanupChart();var a=MapCloud.server,e={sourceName:"base",layerName:"prov_bount_4m",positionField:"name"},t={sourceName:"base",layerName:"china_econmic_2014",positionField:"省区市",chartField:"人均gdp_元"},n=12,i=new MapCloud.RangeChart(a,e,t,n);i.show(),this.perRangeChart=i,this.setCameraPosition()}else Radi.Earth.cleanup(),this.perRangeChart.show(),this.setCameraPosition()},cleanupChart:function(){null!=this.popRangeChart&&(this.popRangeChart.cleanup(),this.popRangeChart=null),null!=this.encoRangeChart&&(this.encoRangeChart.cleanup(),this.encoRangeChart=null),null!=this.perRangeChart&&(this.perRangeChart.cleanup(),this.perRangeChart=null)},setCameraPosition:function(){var a=97.92627,e=15.730198,t=5543911,n=8.9819126,i=-70.75989,l=359.990288;Radi.Earth.flyTo(a,e,t,n,i,l)},getAgroData:function(){return null!=this.argoFeatures?void this.showArgoData(this.argoFeatures):(this.agroFeatureType.fields=this.agroFeatureType.getFields(this.agroMapName,null),void this.agroFeatureType.getFeaturesFilterAsync(this.agroMapName,null,null,333,0,this.agroFields,null,this.getAgroData_callback))},getAgroData_callback:function(a){if($.isArray(a)){var e=MapCloud.topicPanel;e.argoFeatures=a,e.showArgoData(a)}},showArgoData:function(a){if(null!=a){Radi.Earth.cleanup();for(var e="../images/agro_marker.png",t=this.agroFeatureType.getFieldIndex("ppt"),n=this.agroFeatureType.getFieldIndex("x"),i=this.agroFeatureType.getFieldIndex("y"),l=null,o=null,r=null,s=null,h=null,p=null,u=[],c=0;c<a.length;++c)l=a[c],null!=l&&(o=l.values,null!=o&&(r=o[t],s=o[n],h=o[i],null!=s&&null!=h&&(p=Radi.Earth.addBillboard(s,h,"",e),u.push(p))));var g=107.18924,d=25.566601,C=11677693,m=358.15,w=-89.76141,F=0;Radi.Earth.flyTo(g,d,C,m,w,F),this.agroChartFlag=!0}},showAQITimeLineChart:function(){var a=MapCloud.aqi24TimelinePanel,e=MapCloud.aqiTimelinePanel;"none"==e.panel.css("display")?("block"==a.panel.css("display")&&a.hide(),e.show()):e.hide()},show24AQITimeLineChart:function(){var a=MapCloud.aqi24TimelinePanel,e=MapCloud.aqiTimelinePanel;"none"==a.panel.css("display")?("block"==e.panel.css("display")&&e.hide(),a.show()):a.hide()}});
...
MapCloud.AQI24TimeLinePanel=MapCloud.Class(MapCloud.Panel,{initialize:function(i){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent()},registerEvent:function(){var i=this;this.panel.find(".aqi-24h").click(function(){i.show24AQITimeLineChart()}),this.panel.find(".start_form_datetime").datetimepicker({format:"yyyy-mm-dd",autoclose:!0,minView:"month",maxView:"year",language:"zh-CN"}).on("changeDate",function(e){var a=e.date;if(null!=a){var t=a.getUTCFullYear(),n=a.getUTCMonth(),l=a.getUTCDate(),o=(new Date(t+"-"+(n+1)+"-"+l+" 00:00:00"),i.panel.find(".aqi-start-time-points"),MapCloud.dateAdd(a,"day",1));o.setHours(0),i.panel.find(".timepoint").empty();var r=MapCloud.dateFormat(o,"yyyy-MM-dd hh:mm:ss");MapCloud.aqiTimeList.get24hTimeList(r,i.get24hTimeList_callback_2)}}),this.panel.find(".btn-chart").click(function(){var e=i.panel.find(".timepoint").val();return""==e?void alert("请设定一个时刻"):void MapCloud.aqiTimeList.get24hTimeList(e,i.get24hTimeList_callback)}),this.panel.find(".btn-remove").click(function(){i.cleanupChart()})},show:function(){this.panel.slideDown()},hide:function(){this.panel.slideUp()},show24AQITimeLineChart:function(){this.cleanupChart();var i=MapCloud.searchPanel.timepoint;MapCloud.aqiTimeList.get24hTimeList(i,this.get24hTimeList_callback)},get24hTimeList_callback:function(i){if($.isArray(i)){if(i.length<=1)return void alert("请选择有效的时间段");var e=MapCloud.aqi24TimelinePanel;e.cleanupChart();var a=MapCloud.server,t="aqi",n="3000",l=new MapCloud.AQITimeLineChart(a,t,i,n);l.show(),MapCloud.aqiTimeLineChart=l}},cleanupChart:function(){null!=MapCloud.aqiTimeLineChart&&(MapCloud.aqiTimeLineChart.cleanup(),MapCloud.aqiTimeLineChart=null),Radi.Earth.cleanup()},get24hTimeList_callback_2:function(i){if($.isArray(i)){if(i.length<=1)return void alert("请选择有效的时间段");var e=MapCloud.aqi24TimelinePanel;e.setTimepoints(i)}},setTimepoints:function(i){if(null!=i){for(var e=null,a="",t=0;t<i.length;++t)e=i[t],null!=e&&(a+="<option>"+e+"</option>");this.panel.find(".timepoint").html(a)}}});
MapCloud.ChartPanel=MapCloud.Class(MapCloud.Panel,{initialize:function(a){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent()},registerEvent:function(){var a=this;this.panel.find("[data-toggle='tooltip']").tooltip({container:"body"}),this.panel.find(".mc-stretch").click(function(){var t=a.panel.find(".chart-content-div");"none"==t.css("display")?t.slideDown():t.slideUp()}),this.panel.find(".chart-content-div li").click(function(){var t=$(this).attr("mname");switch(t){case"tj":a.showTianjinModel()}})},showTianjinModel:function(){Radi.Earth.cleanup();var a="./data/tj/hepingqu/1-4/1-4.gltf",t=117.184,d=39.0986,i=0;Radi.Earth.addModel(a,t,d,i,2.5);var a="./data/tj/hepingqu/4330517/5.gltf",t=117.1998,d=39.1136,i=0;Radi.Earth.addModel(a,t,d,i,2.5);var a="./data/tj/hepingqu/4331515/4331515.gltf",t=117.18155,d=39.1216,i=0;Radi.Earth.addModel(a,t,d,i,1);var a="./data/tj/hepingqu/4331516/4331516.gltf",t=117.188,d=39.1261,i=0;Radi.Earth.addModel(a,t,d,i,1);var a="./data/tj/hepingqu/4331517/4331517.gltf",t=117.19305,d=39.11028,i=0;Radi.Earth.addModel(a,t,d,i,1);var a="./data/tj/hepingqu/4331518/4331518.gltf",t=117.20988,d=39.1113,i=0;Radi.Earth.addModel(a,t,d,i,2.5);var a="./data/tj/hepingqu/4332515/4332515.gltf",t=117.180775,d=39.12379,i=0;Radi.Earth.addModel(a,t,d,i,1);var a="./data/tj/hepingqu/4332516/4332516.gltf",t=117.1878,d=39.12658,i=0;Radi.Earth.addModel(a,t,d,i,1);var a="./data/tj/hepingqu/4332517/4332517.gltf",t=117.1985,d=39.131025,i=0;Radi.Earth.addModel(a,t,d,i,1);var a="./data/tj/hepingqu/4333515-7/4333515-7.gltf",t=117.1849,d=39.1331,i=0;Radi.Earth.addModel(a,t,d,i,1)},showFenghuangModel:function(){var a="./data/test/028.gltf",t=109.482,d=18.255,i=0;Radi.Earth.addModel(a,t,d,i,.01)}});