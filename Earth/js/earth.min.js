...
MapCloud.TopicPanel=MapCloud.Class(MapCloud.Panel,{aqiChart:null,popRangeChart:null,encoRangeChart:null,perRangeChart:null,agroMapName:"agro",agroLayerName:"agro",agroFields:["ppt","x","y"],agroFeatureType:null,agroChartFlag:!1,initialize:function(a){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent();var e=new GeoBeans.WFSWorkspace("tmp",MapCloud.server,"1.0.0");this.agroFeatureType=new GeoBeans.FeatureType(e,this.agroLayerName)},registerEvent:function(){var a=this;this.panel.find("[data-toggle='tooltip']").tooltip({container:"body"}),this.panel.find(".mc-icon").click(function(){$(this).hasClass("mc-stretch")?a.onStretch(this):$(this).hasClass("mc-icon-enco")?a.showEncoRangeChart():$(this).hasClass("mc-icon-aqi")?a.showAQIChart():$(this).hasClass("mc-icon-pop")?a.showPopRangeChart():$(this).hasClass("mc-icon-per")?a.showPerRangeChart():$(this).hasClass("mc-icon-agro")?a.agroChartFlag?(Radi.Earth.cleanup(),a.agroChartFlag=!1):a.getAgroData():$(this).hasClass("mc-icon-aqi-timeline")&&a.showAQITimeLineChart()})},onStretch:function(a){$(a).hasClass("mc-icon-left")?(this.panel.children().not(".mc-stretch").css("display","block"),$(a).removeClass("mc-icon-left"),$(a).addClass("mc-icon-right"),this.panel.animate({width:"282px"},300)):(this.panel.children().not(".mc-stretch").css("display","none"),$(a).removeClass("mc-icon-right"),$(a).addClass("mc-icon-left"),this.panel.animate({width:"40px"},300))},showAQIChart:function(){if(null==this.aqiChart){var a=MapCloud.server,e="aqi",t=MapCloud.searchPanel.timepoint,i=new MapCloud.AQIChart(a,e,t);i.show(),this.aqiChart=i}else this.aqiChart=null,Radi.Earth.cleanup()},showPopRangeChart:function(){if(null==this.popRangeChart){var a=MapCloud.server,e={sourceName:"base",layerName:"prov_bount_4m",positionField:"name"},t={sourceName:"base",layerName:"china_econmic_2014",positionField:"省区市",chartField:"人口_万人"},i=12,n=new MapCloud.RangeChart(a,e,t,i);n.show(),this.popRangeChart=n,this.setCameraPosition()}else this.popRangeChart.cleanup(),this.popRangeChart=null},showEncoRangeChart:function(){if(null==this.encoRangeChart){this.cleanupChart();var a=MapCloud.server,e={sourceName:"base",layerName:"prov_bount_4m",positionField:"name"},t={sourceName:"base",layerName:"china_econmic_2014",positionField:"省区市",chartField:"gdp_亿元"},i=12,n=new MapCloud.RangeChart(a,e,t,i);n.show(),this.encoRangeChart=n,this.setCameraPosition()}else this.encoRangeChart.cleanup(),this.encoRangeChart=null},showPerRangeChart:function(){if(null==this.perRangeChart){this.cleanupChart();var a=MapCloud.server,e={sourceName:"base",layerName:"prov_bount_4m",positionField:"name"},t={sourceName:"base",layerName:"china_econmic_2014",positionField:"省区市",chartField:"人均gdp_元"},i=12,n=new MapCloud.RangeChart(a,e,t,i);n.show(),this.perRangeChart=n,this.setCameraPosition()}else this.perRangeChart.cleanup(),this.perRangeChart=null},cleanupChart:function(){null!=this.popRangeChart&&(this.popRangeChart.cleanup(),this.popRangeChart=null),null!=this.encoRangeChart&&(this.encoRangeChart.cleanup(),this.encoRangeChart=null),null!=this.perRangeChart&&(this.perRangeChart.cleanup(),this.perRangeChart=null)},setCameraPosition:function(){var a=97.92627,e=15.730198,t=5543911,i=8.9819126,n=-70.75989,l=359.990288;Radi.Earth.flyTo(a,e,t,i,n,l)},getAgroData:function(){this.agroFeatureType.fields=this.agroFeatureType.getFields(this.agroMapName,null),this.agroFeatureType.getFeaturesFilterAsync(this.agroMapName,null,null,333,0,this.agroFields,null,this.getAgroData_callback)},getAgroData_callback:function(a){if($.isArray(a)){var e=MapCloud.topicPanel;e.showArgoData(a)}},showArgoData:function(a){if(null!=a){Radi.Earth.cleanup();for(var e="../images/agro_marker.png",t=this.agroFeatureType.getFieldIndex("ppt"),i=this.agroFeatureType.getFieldIndex("x"),n=this.agroFeatureType.getFieldIndex("y"),l=null,r=null,o=null,s=null,h=null,p=null,c=[],u=0;u<a.length;++u)l=a[u],null!=l&&(r=l.values,null!=r&&(o=r[t],s=r[i],h=r[n],null!=s&&null!=h&&(p=Radi.Earth.addBillboard(s,h,"",e),c.push(p))));var C=107.18924,g=25.566601,m=11677693,d=358.15,R=-89.76141,f=0;Radi.Earth.flyTo(C,g,m,d,R,f),this.agroChartFlag=!0}},showAQITimeLineChart:function(){"none"==MapCloud.aqiTimelinePanel.panel.css("display")?MapCloud.aqiTimelinePanel.show():MapCloud.aqiTimelinePanel.hide()},showAQITimeLineChart2:function(){if(null==this.aqiTimeLineChart){var a=(MapCloud.searchPanel.timepoint,"2015-12-28 04:00:00"),e="2015-12-31 04:00:00";MapCloud.aqiTimeList.getDayHourTimeList(a,e,this.get24hTimeList_callback)}else this.aqiTimeLineChart.cleanup(),this.aqiTimeLineChart=null,Radi.Earth.cleanup()},get24hTimeList_callback:function(a){var e=MapCloud.topicPanel,t=MapCloud.server,i="aqi",n="3000",l=new MapCloud.AQITimeLineChart(t,i,a,n);l.show(),e.aqiTimeLineChart=l}});
...
MapCloud.AQITimeLineBar=MapCloud.Class({slider:null,wrapper:null,broadcastIntervalId:null,initialized:!1,boardcast:null,layer:null,initialize:function(i){if(null!=i){this.layer=i,$("#slider").remove();var t='<div class="slider-wrap" id="slider">	<button class="timeline-play" id="slider_player">		<img src="../images/timeline-play.png">	</button>   <div class="timeline"></div>	  <div class="label-div"></div></div>';$("body").append(t);var a=i.timepoints;this.timepoints=a;var e=this;if(!this.initialized){this.wrapper=$("#slider"),this.slider=this.wrapper.find(".timeline"),this.slider.noUiSlider({start:0,range:{min:0,max:a.length-1},step:1});for(var l=1,s=1;s<a.length-1;s++){var r=s/(a.length-1)*100,n=$('<span class="ui-slider-segment"></span>');n.attr("data-content",l+s).css("left",r+"%"),this.slider.append(n)}this.boardcast=this.wrapper.find(".timeline-play"),this.boardcast.click(function(i){var t=$(this).find("img"),a=t.attr("src");/play/.test(a)?t.attr("src",a.replace("play","pause")):t.attr("src",a.replace("pause","play")),e.broadcast()}),this.slider.on("set",function(){var i=parseInt($(this).val());e.layer.currentLayerID=i,e.layer.drawAQIChart(i)}),this.addLabels(),this.initialized=!0}}},broadcast:function(){var i=this;null!=this.broadcastIntervalId?(clearInterval(this.broadcastIntervalId),this.broadcastIntervalId=null):this.broadcastIntervalId=setInterval(function(){var t=i.slider.val();t=parseInt(t),t===i.timepoints.length-1?i.slider.val(0):i.slider.val(t+1)},this.layer.interval)},cleanup:function(){$("#slider").remove(),clearInterval(this.broadcastIntervalId),this.broadcastIntervalId=null,this.slider=null,this.wrapper=null,this.initialized=!1,this.boardcast=null},addLabels:function(){if(!(null==this.timepoints||this.timepoints.length<2)){var i=this.timepoints.length,t=this.timepoints[0],a=document.createElement("canvas"),e=a.getContext("2d");e.font="12px Arial, Verdana, sans-seri";var l=e.measureText(t).width,s=this.slider.width(),r=s/(i-1),n="";if(r>l){var d=l/2*-1;this.wrapper.find(".label-div").css("margin-left",d).css("width","calc(100% + "+l+"px)");for(var p=0;i>p;++p){var h=0;h=0==p?0:r-l,n+="<div class='time-label' style='padding-left:"+h+"px'>"+this.timepoints[p]+"</div>"}this.wrapper.find(".label-div").html(n)}else{for(var c=Math.ceil(l/r),p=0;i>p+c;p+=c){var h=0;h=0==p?0:c*r-l,n+="<div class='time-label' style='padding-left:"+h+"px'>"+this.timepoints[p]+"</div>"}h+=(i-1-p)*r,n+="<div class='time-label' style='padding-left:"+h+"px'>"+this.timepoints[i-1]+"</div>";var d=l/2*-1;this.wrapper.find(".label-div").css("margin-left",d).css("width","calc(100% + "+l+"px)"),this.wrapper.find(".label-div").html(n)}}}});
...
MapCloud.AQITimeLinePanel=MapCloud.Class(MapCloud.Panel,{aqiTimeLineChart:null,initialize:function(i){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent()},show:function(){this.panel.slideDown()},hide:function(){this.panel.slideUp()},registerEvent:function(){var i=this;this.panel.find(".aqi-24h").click(function(){i.show24AQITimeLineChart()}),this.panel.find(".start_form_datetime").datetimepicker({format:"yyyy-mm-dd",autoclose:!0,minView:"month",maxView:"year",language:"zh-CN"}).on("changeDate",function(i){}),this.panel.find(".end_form_datetime").datetimepicker({format:"yyyy-mm-dd",autoclose:!0,minView:"month",maxView:"year",language:"zh-CN"}).on("changeDate",function(i){}),this.panel.find(".btn-chart").click(function(){var e=i.panel.find(".timepoint").val(),a=i.panel.find(".start_form_datetime input").val();if(""==a)return void alert("请选择起始日期");var t=i.panel.find(".end_form_datetime input").val();if(""==t)return void alert("请选择终止日期");var n=a+" "+e,l=t+" "+e;i.cleanupChart(),MapCloud.aqiTimeList.getDayHourTimeList(n,l,i.get24hTimeList_callback)}),this.panel.find(".btn-remove").click(function(){i.cleanupChart()})},show24AQITimeLineChart:function(){this.cleanupChart();var i=MapCloud.searchPanel.timepoint;MapCloud.aqiTimeList.get24hTimeList(i,this.get24hTimeList_callback)},get24hTimeList_callback:function(i){var e=MapCloud.aqiTimelinePanel,a=MapCloud.server,t="aqi",n="3000",l=new MapCloud.AQITimeLineChart(a,t,i,n);l.show(),e.aqiTimeLineChart=l},cleanupChart:function(){null!=this.aqiTimeLineChart&&(this.aqiTimeLineChart.cleanup(),this.aqiTimeLineChart=null),Radi.Earth.cleanup()}});