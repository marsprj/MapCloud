...
MapCloud.ProjectPanel=MapCloud.Class(MapCloud.Panel,{showFlag:!1,server:"/ows/radi/mgr",baseSourceName:"base",earthquakeNodes:null,exerciseNodes:null,fluNodes:null,africaNodes:null,usaNodes:null,chinaNodes:null,initialize:function(e){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent(),this.showFlag=MapCloud.topicPanel.showFlag,Radi.Earth.addMoveModelEventListener()},registerEvent:function(){var e=this;this.panel.find("[data-toggle='tooltip']").tooltip({container:"body"}),this.panel.find(".mc-icon").each(function(a,o){$(this).click(function(){switch(a){case 0:e.onStretch(this);break;case 1:e.preIndex==a&&e.showFlag?(e.cleanup(),e.showFlag=!1):(e.getEarthquakeJson(),e.showFlag=!0);break;case 2:e.preIndex==a&&e.showFlag?(e.cleanup(),e.showFlag=!1):(e.getExerciseJson(),e.showFlag=!0);break;case 3:e.preIndex==a&&e.showFlag?(e.cleanup(),e.showFlag=!1):(e.getAfricaJson(),e.showFlag=!0);break;case 4:e.preIndex==a&&e.showFlag?(e.cleanup(),e.showFlag=!1):(e.getChinaJson(),e.showFlag=!0);break;case 5:e.preIndex==a&&e.showFlag?(e.cleanup(),e.showFlag=!1):(e.getNanhaiIslandsJson(),e.showFlag=!0);break;case 6:e.preIndex==a&&e.showFlag?(e.cleanup(),e.showFlag=!1):(e.getNaihaiAirportJson(),e.showFlag=!0);break;case 7:e.preIndex==a&&e.showFlag?(e.cleanup(),e.removeZhibei(),e.showFlag=!1):(e.addZhibei(),e.showFlag=!0)}e.preIndex=a})})},onStretch:function(e){$(e).hasClass("mc-icon-left")?(this.panel.children().not(".mc-stretch").css("display","block"),$(e).removeClass("mc-icon-left"),$(e).addClass("mc-icon-right"),this.panel.animate({width:"323px"},300)):(this.panel.children().not(".mc-stretch").css("display","none"),$(e).removeClass("mc-icon-right"),$(e).addClass("mc-icon-left"),this.panel.animate({width:"40px"},300))},getEarthquakeJson:function(){if(null!=this.earthquakeNodes)return void this.showEarthquakeJson(this.earthquakeNodes);var e="js/data/earthquake.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,o){a.earthquakeNodes=e.nodes,a.showEarthquakeJson(a.earthquakeNodes)},complete:function(e,a){},error:function(){}})},showEarthquakeJson:function(e){this.cleanup(),MapCloud.showProject=!0;for(var a="../images/flag_2.png",o=0;o<e.length;++o){var s=e[o],n=s.x,t=s.y,i=Radi.Earth.addBillboard(n,t,"",a);i.billboard.text=s.title}var r=107,l=30,h=8260681,d=360,c=-90,u=0;Radi.Earth.flyTo(r,l,h,d,c,u)},getExerciseJson:function(){if(MapCloud.showProject=!0,null!=this.exerciseNodes)return void this.showExerciseJson(this.exerciseNodes);var e="js/data/exercise.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,o){a.exerciseNodes=e.nodes,a.showExerciseJson(a.exerciseNodes)},complete:function(e,a){},error:function(){}})},showExerciseJson:function(e){this.cleanup(),MapCloud.showProject=!0;for(var a="../images/marker.png",o=0;o<e.length;++o){var s=e[o],n=s.x,t=s.y,i=Radi.Earth.addBillboard(n,t,"",a);i.billboard.text=s.title}var r=107,l=30,h=8260681,d=360,c=-90,u=0;Radi.Earth.flyTo(r,l,h,d,c,u)},getFluJson:function(){if(MapCloud.showProject=!0,null!=this.fluNodes)return void this.showFluJson(this.fluNodes);var e="js/data/flu.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,o){a.fluNodes=e.nodes,a.showFluJson(a.fluNodes)},complete:function(e,a){},error:function(){}})},showFluJson:function(e){this.cleanup(),MapCloud.showProject=!0;for(var a="../images/flag_2.png",o=0;o<e.length;++o){var s=e[o],n=s.x,t=s.y,i=Radi.Earth.addBillboard(n,t,"",a);i.billboard.text=s.title}var r=107.2598,l=34.4148,h=4633881,d=360,c=-90,u=0;Radi.Earth.flyTo(r,l,h,d,c,u)},getAfricaJson:function(){if(MapCloud.showProject=!0,null!=this.africaNodes)return void this.showAfricaJson(this.africaNodes);var e="js/data/africa.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,o){a.africaNodes=e.nodes,a.showAfricaJson(a.africaNodes)},complete:function(e,a){},error:function(){}})},showAfricaJson:function(e){this.cleanup(),MapCloud.showProject=!0;for(var a="../images/marker.png",o=0;o<e.length;++o){var s=e[o],n=s.x,t=s.y,i=Radi.Earth.addBillboard(n,t,"",a);i.billboard.text=s.title}var r=7.2598,l=15.4148,h=4633881,d=360,c=-90,u=0;Radi.Earth.flyTo(r,l,h,d,c,u)},getUsaJson:function(){if(MapCloud.showProject=!0,null!=this.usaNodes)return void this.showUsaJson(this.usaNodes);var e="js/data/usa.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,o){a.usaNodes=e.nodes,a.showUsaJson(a.usaNodes)},complete:function(e,a){},error:function(){}})},showUsaJson:function(e){this.cleanup(),MapCloud.showProject=!0;for(var a="../images/flag_1.png",o=0;o<e.length;++o){var s=e[o],n=s.x,t=s.y,i=Radi.Earth.addBillboard(n,t,"",a);i.billboard.text=s.title}var r=107,l=30,h=8260681,d=360,c=-90,u=0;Radi.Earth.flyTo(r,l,h,d,c,u)},getChinaJson:function(){if(MapCloud.showProject=!0,null!=this.chinaNodes)return void this.showUsaJson(this.chinaNodes);var e="js/data/china.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,o){a.chinaNodes=e.nodes,a.showChinaJson(a.chinaNodes)},complete:function(e,a){},error:function(){}})},showChinaJson:function(e){this.cleanup(),MapCloud.showProject=!0;for(var a="../images/flag_1.png",o=0;o<e.length;++o){var s=e[o],n=s.x,t=s.y,i=Radi.Earth.addBillboard(n,t,"",a);i.billboard.text=s.title}var r=107,l=30,h=8260681,d=360,c=-90,u=0;Radi.Earth.flyTo(r,l,h,d,c,u)},getNanhaiIslandsJson:function(){if(MapCloud.showProject=!0,null!=this.islandNodes)return void this.showIslandJson(this.islandNodes);var e="js/data/islands.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,o){a.islandNodes=e.nodes,a.showIslandJson(a.islandNodes)},complete:function(e,a){},error:function(){}})},getNodeValue:function(e,a){var o=$(e).find(a)[0];return $(o).text()},showIslandJson:function(e){this.cleanup(),MapCloud.showProject=!0;for(var a="../images/islands.png",o=0;o<e.length;++o){var s=e[o],n=s.x,t=s.y,i=Radi.Earth.addBillboard(n,t,"",a);i.billboard.text=s.title}var r=110,l=8,h=4260681,d=360,c=-90,u=0;Radi.Earth.flyTo(r,l,h,d,c,u)},getNaihaiAirportJson:function(){if(MapCloud.showProject=!0,null!=this.airportNodes)return void this.showAirportJson(this.airportNodes);var e="js/data/airport.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,o){a.airportNodes=e.nodes,a.showAirportJson(a.airportNodes)},complete:function(e,a){},error:function(){}})},showAirportJson:function(e){this.cleanup(),MapCloud.showProject=!0;for(var a="../images/plane_18.png",o=0;o<e.length;++o){var s=e[o],n=s.x,t=s.y,i=Radi.Earth.addBillboard(n,t,"",a);i.billboard.text=s.title}var r=110,l=8,h=8260681,d=360,c=-90,u=0;Radi.Earth.flyTo(r,l,h,d,c,u)},addZhibei:function(){this.cleanup();var e=256*Math.PI/180,a=new Cesium.Rectangle((-e),(-e),e,e),o=g_earth_view.scene.imageryLayers,s=o.addImageryProvider(new Cesium.WebMapTileServiceImageryProvider({url:"/QuadServer/services/maps/wmts100",layer:"zhibei",style:"default",format:"image/jpeg",tileMatrixSetID:"PGIS_TILE_STORE",minimumLevel:0,maximumLevel:19,credit:new Cesium.Credit("zhibei"),tilingScheme:new Cesium.GeographicTilingScheme({rectangle:a})}));this.zhibeiLayer=s;var n=106,t=31,i=10530054,r=360,l=-90,h=0;Radi.Earth.flyTo(n,t,i,r,l,h)},removeZhibei:function(){var e=g_earth_view.scene.imageryLayers;e.remove(this.zhibeiLayer),this.zhibeiLayer=null},cleanup:function(){Radi.Earth.cleanup(),this.removeZhibei()}});
