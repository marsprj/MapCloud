...
MapCloud.ProjectPanel=MapCloud.Class(MapCloud.Panel,{showFlag:!1,server:"/ows/radi/mgr",baseSourceName:"base",earthquakeNodes:null,exerciseNodes:null,fluNodes:null,africaNodes:null,usaNodes:null,chinaNodes:null,initialize:function(e){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent(),this.showFlag=MapCloud.topicPanel.showFlag,Radi.Earth.addMoveModelEventListener()},registerEvent:function(){var e=this;this.panel.find("[data-toggle='tooltip']").tooltip({container:"body"}),this.panel.find(".mc-icon").each(function(a,s){$(this).click(function(){switch(a){case 0:e.onStretch(this);break;case 1:1==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getEarthquakeJson(),e.showFlag=!0);break;case 2:2==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getExerciseJson(),e.showFlag=!0);break;case 3:3==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getFluJson(),e.showFlag=!0);break;case 4:4==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getAfricaJson(),e.showFlag=!0);break;case 5:5==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getUsaJson(),e.showFlag=!0);break;case 6:6==e.preIndex&&e.showFlag?(Radi.Earth.cleanup(),e.showFlag=!1):(e.getChinaJson(),e.showFlag=!0)}e.preIndex=a})})},onStretch:function(e){$(e).hasClass("mc-icon-left")?(this.panel.children().not(".mc-stretch").css("display","block"),$(e).removeClass("mc-icon-left"),$(e).addClass("mc-icon-right"),this.panel.animate({width:"282px"},300)):(this.panel.children().not(".mc-stretch").css("display","none"),$(e).removeClass("mc-icon-right"),$(e).addClass("mc-icon-left"),this.panel.animate({width:"40px"},300))},getEarthquakeJson:function(){if(null!=this.earthquakeNodes)return void this.showEarthquakeJson(this.earthquakeNodes);var e="js/data/earthquake.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,s){a.earthquakeNodes=e.nodes,a.showEarthquakeJson(a.earthquakeNodes)},complete:function(e,a){},error:function(){}})},showEarthquakeJson:function(e){Radi.Earth.cleanup(),MapCloud.showProject=!0;for(var a="../images/flag_2.png",s=0;s<e.length;++s){var o=e[s],t=o.x,n=o.y,i=Radi.Earth.addBillboard(t,n,"",a);i.billboard.text=o.title}var r=107,l=30,c=8260681,h=360,d=-90,u=0;Radi.Earth.flyTo(r,l,c,h,d,u)},getExercise:function(){var e="js/data/exercise.xml",a=this;this.exerciseFeatureType.fields=this.exerciseFeatureType.getFields(null,this.baseSourceName),$.get(e,function(e){var s=a.exerciseFeatureType.parseFeatures(e);a.exerciseFeatures=s,a.showExercise(s)})},getExercise_callback:function(e){if($.isArray(e)){var a=MapCloud.projectPanel;a.exerciseFeatures=e,a.showExercise(e)}},showExercise:function(e){if(null!=e){Radi.Earth.cleanup();for(var a="../images/marker.png",s=null,o=null,t=null,n=null,i=null,r=0;r<e.length;++r)s=e[r],null!=s&&(o=s.values,null!=o&&(t=s.geometry,null!=t&&(n=t.x,i=t.y,null!=n&&null!=i&&Radi.Earth.addBillboard(n,i,"",a))));var l=107,c=30,h=8260681,d=360,u=-90,f=0;Radi.Earth.flyTo(l,c,h,d,u,f);for(var p=this.exerciseFeatureType.getFieldIndex("title"),g=null,w=[],r=0;r<e.length;++r){g=e[r],t=g.geometry;var x=g.values[p],v={x:t.x,y:t.y,title:x};w.push(v)}var y={nodes:w};JSON.stringify(y)}},getExerciseJson:function(){if(MapCloud.showProject=!0,null!=this.exerciseNodes)return void this.showExerciseJson(this.exerciseNodes);var e="js/data/exercise.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,s){a.exerciseNodes=e.nodes,a.showExerciseJson(a.exerciseNodes)},complete:function(e,a){},error:function(){}})},showExerciseJson:function(e){Radi.Earth.cleanup(),MapCloud.showProject=!0;for(var a="../images/marker.png",s=0;s<e.length;++s){var o=e[s],t=o.x,n=o.y,i=Radi.Earth.addBillboard(t,n,"",a);i.billboard.text=o.title}var r=107,l=30,c=8260681,h=360,d=-90,u=0;Radi.Earth.flyTo(r,l,c,h,d,u)},getFluJson:function(){if(MapCloud.showProject=!0,null!=this.fluNodes)return void this.showFluJson(this.fluNodes);var e="js/data/flu.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,s){a.fluNodes=e.nodes,a.showFluJson(a.fluNodes)},complete:function(e,a){},error:function(){}})},showFluJson:function(e){Radi.Earth.cleanup(),MapCloud.showProject=!0;for(var a="../images/flag_2.png",s=0;s<e.length;++s){var o=e[s],t=o.x,n=o.y,i=Radi.Earth.addBillboard(t,n,"",a);i.billboard.text=o.title}var r=107.2598,l=34.4148,c=4633881,h=360,d=-90,u=0;Radi.Earth.flyTo(r,l,c,h,d,u)},getAfricaJson:function(){if(MapCloud.showProject=!0,null!=this.africaNodes)return void this.showAfricaJson(this.africaNodes);var e="js/data/africa.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,s){a.africaNodes=e.nodes,a.showAfricaJson(a.africaNodes)},complete:function(e,a){},error:function(){}})},showAfricaJson:function(e){Radi.Earth.cleanup(),MapCloud.showProject=!0;for(var a="../images/marker.png",s=0;s<e.length;++s){var o=e[s],t=o.x,n=o.y,i=Radi.Earth.addBillboard(t,n,"",a);i.billboard.text=o.title}var r=7.2598,l=15.4148,c=4633881,h=360,d=-90,u=0;Radi.Earth.flyTo(r,l,c,h,d,u)},getUsaJson:function(){if(MapCloud.showProject=!0,null!=this.usaNodes)return void this.showUsaJson(this.usaNodes);var e="js/data/usa.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,s){a.usaNodes=e.nodes,a.showUsaJson(a.usaNodes)},complete:function(e,a){},error:function(){}})},showUsaJson:function(e){Radi.Earth.cleanup(),MapCloud.showProject=!0;for(var a="../images/flag_1.png",s=0;s<e.length;++s){var o=e[s],t=o.x,n=o.y,i=Radi.Earth.addBillboard(t,n,"",a);i.billboard.text=o.title}var r=107,l=30,c=8260681,h=360,d=-90,u=0;Radi.Earth.flyTo(r,l,c,h,d,u)},getChinaJson:function(){if(MapCloud.showProject=!0,null!=this.chinaNodes)return void this.showUsaJson(this.chinaNodes);var e="js/data/china.json",a=this;$.ajax({type:"get",url:e,dataType:"json",async:!0,beforeSend:function(e){},success:function(e,s){a.chinaNodes=e.nodes,a.showChinaJson(a.chinaNodes)},complete:function(e,a){},error:function(){}})},showChinaJson:function(e){Radi.Earth.cleanup(),MapCloud.showProject=!0;for(var a="../images/flag_1.png",s=0;s<e.length;++s){var o=e[s],t=o.x,n=o.y,i=Radi.Earth.addBillboard(t,n,"",a);i.billboard.text=o.title}var r=107,l=30,c=8260681,h=360,d=-90,u=0;Radi.Earth.flyTo(r,l,c,h,d,u)}});
