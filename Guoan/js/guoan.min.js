...
MapCloud.CityPanel=MapCloud.Class(MapCloud.Panel,{initialize:function(i){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerPanelEvent()},show:function(){MapCloud.currentCityPanel.panel.find(".current-city").addClass("open"),this.panel.slideDown()},hide:function(){MapCloud.currentCityPanel.panel.find(".current-city").removeClass("open"),this.panel.slideUp()},registerPanelEvent:function(){var i=this;this.panel.find("li").click(function(){var n=$(this).html(),t=MapCloud.cityPosition.getCityPosition(n);if(null!=t){var e=t.lon,l=t.lat;MapCloud.currentCity=n,MapCloud.currentCityPanel.setCity(n,e,l),i.hide()}}),this.panel.mouseleave(function(){i.hide()})},setCity:function(i){null!=i&&this.panel.find(".city-list-current span").html(i)}});
