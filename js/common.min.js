...
MapCloud.FileDialog=MapCloud.Class(MapCloud.Dialog,{list:null,initialize:function(e){MapCloud.Dialog.prototype.initialize.apply(this,arguments);var l=this;l.registerPanelEvent()},registerPanelEvent:function(){var e=this;this.panel.find('[data-toggle="tooltip"]').tooltip({container:"body"}),this.panel.find(".btn-confirm").click(function(){switch(e.flag){case"choose-shp":var l=e.getImportPaths();if(0==l.length)return void MapCloud.notify.showInfo("请选择要导入的shp文件","Warning");MapCloud.import_dialog.addImportPaths(l);break;case"gps-choose-shp":var l=e.getImportPaths();if(0==l.length)return void MapCloud.notify.showInfo("请选择要导入的shp文件","Warning");MapCloud.gps_feature_import_dialog.addImportPaths(l);break;case"image":var l=e.getImportPaths();if(0==l.length)return void MapCloud.notify.showInfo("请选择要导入的shp文件","Warning");MapCloud.import_raster_dialog.addImportPaths(l);break;case"csv":var i=e.getImportCSVPath();if(null==i)return void MapCloud.notify.showInfo("请选择要导入的csv文件","Warning");MapCloud.importCSV_dialog.setImportCsv(i);break;case"csvImport":var i=e.getImportCSVPath();if(null==i)return void MapCloud.notify.showInfo("请选择要导入的csv文件","Warning");MapCloud.gps_csv_import_dialog.setImportCsv(i)}e.closeDialog()}),this.panel.find(".btn-add-folder").click(function(){MapCloud.create_folder_dialog.showDialog("file")}),this.panel.find(".btn-remove-file").click(function(){var l=e.panel.find("input[type='checkbox']:checked");if(0==l.length){var i=e.panel.find(".tree-folder.selected").attr("fpath");if("/"==i)return void MapCloud.notify.showInfo("无法删除根目录","Warning");var t=e.panel.find(".tree-folder.selected span").html();if(!confirm("确定要删除文件夹["+t+"]?"))return;var a=e.panel.find(".tree-folder.selected").parents(".nav").first().prev();e.panel.find(".tree-folder.selected").parents(".nav").first().remove(),e.panel.find(".tree-folder").removeClass("selected"),a.addClass("selected");var n=a.attr("fpath");return e.panel.find("#current_path").val(n),void e.removeFolder(i)}confirm("确定要删除吗？")&&l.each(function(){var l=$(this).parent().parent().parent(),i=l.attr("fpath");l.hasClass("row-file")?e.removeFile(i):l.hasClass("row-folder")&&e.removeFolder(i)})}),this.panel.find(".btn-upload-file").click(function(){var l=e.panel.find("#current_path").val();MapCloud.importVector_dialog.showDialog(l,"file")}),this.panel.find(".btn-refresh").click(function(){var l=e.panel.find("#current_path").val();e.getListRefresh(l)}),this.panel.find("#file_filter_select").change(function(){var l=e.getFilterList();e.showListPanel(l)}),this.panel.find(".select-list").click(function(){var l=e.panel.find(".file-list-content-div>.row input");$(this).prop("checked")?l.prop("checked",!0):l.prop("checked",!1)})},cleanup:function(){this.list=null,this.flag=null,this.panel.find("#file_filter_select option[value='all']").attr("selected",!0),this.panel.find("#current_path").val("/"),this.panel.find(".select-list").prop("checked",!1)},showDialog:function(e){var l=$("body").width(),i=this.panel.find(".modal-dialog").width();i>l&&(i=l-40,this.panel.find(".modal-dialog").css("width",i+"px")),this.cleanup(),this.flag=e,null!=this.flag?(this.panel.find(".btn-confirm").html("选择"),this.panel.find(".btn-group-tool").css("display","none"),this.panel.find("#current_path").parent().removeClass("col-md-8").addClass("col-md-12 col-xs-12")):(this.panel.find(".btn-confirm").html("确定"),this.panel.find(".btn-group-tool").css("display","block"),this.panel.find("#current_path").parent().addClass("col-md-8 col-xs-8").removeClass("col-md-12 col-xs-12")),this.panel.modal(),this.getList("/")},getList:function(e){MapCloud.notify.loading(),fileManager.getList(e,this.getList_callback)},getList_callback:function(e){MapCloud.notify.hideLoading();var l=MapCloud.file_dialog;l.list=e,l.showListTree(e,!0);var i=l.getFilterList();l.showListPanel(i)},getListRefresh:function(e){MapCloud.notify.loading(),fileManager.getList(e,this.getListRefresh_callback)},getListRefresh_callback:function(e){MapCloud.notify.showInfo("刷新","Info");var l=MapCloud.file_dialog;l.list=e,l.showListTree(e,!0);var i=l.getFilterList();l.showListPanel(i)},getListTreeClick:function(e){MapCloud.notify.loading(),fileManager.getList(e,this.getListTreeClick_callback)},getListTreeClick_callback:function(e){MapCloud.notify.hideLoading();var l=MapCloud.file_dialog;l.list=e;var i=l.getFilterList();l.showListPanel(i)},showListTree:function(e,l){var i=null,t=null,a=null;a=1==l?"<ul class='nav'>":"<ul class='nav' style='display:none'>";for(var n=0;n<e.length;++n)if(i=e[n],null!=i&&i instanceof GeoBeans.Folder){var s=i.name;a+="<li><a href='javascript:void(0)' class='tree-folder' fpath=\""+i.path+'"><i class="fa fa-folder-o"></i><span>'+s+"</span></a></li>"}a+="</ul>",t=this.panel.find("#current_path").val();var o=this.panel.find(".file-tree-div a[fpath='"+t+"']");o.find("i").removeClass("fa-folder-o"),o.find("i").addClass("fa-folder-open-o"),o.parent().find("ul.nav").remove(),o.after(a);var r=this;this.panel.find(".tree-folder").unbind("click"),this.panel.find(".tree-folder").unbind("dblclick");var d=300,c=0,f=null;this.panel.find(".tree-folder").on("click",function(e){if(c++,1===c){var l=this;f=setTimeout(function(){console.log("Single Click");var e=$(l).attr("fpath");r.panel.find("#current_path").val(e),r.getListTreeClick(e),r.panel.find(".tree-folder").removeClass("selected"),$(l).addClass("selected"),c=0},d)}else{clearTimeout(f),console.log("Double Click");var i=$(this).attr("fpath"),t=$(this).parent();0!=t.find("ul.nav").length&&"none"==t.find("ul.nav").first().css("display")?(t.find("ul.nav").first().css("display","block"),$(this).find("i").removeClass("fa-folder-o"),$(this).find("i").addClass("fa-folder-open-o"),r.getListTreeClick(i)):0!=t.find("ul.nav").length&&"block"==t.find("ul.nav").first().css("display")?(t.find("ul.nav").first().css("display","none"),$(this).find("i").addClass("fa-folder-o"),$(this).find("i").removeClass("fa-folder-open-o"),r.getListTreeClick(i)):(r.panel.find("#current_path").val(i),r.getList(i)),r.panel.find(".tree-folder").removeClass("selected"),$(this).addClass("selected"),c=0}}).on("dblclick",function(e){e.preventDefault()})},showListPanel:function(e){var l=null,i="";this.panel.find(".select-list").prop("checked",!1);for(var t=0;t<e.length;++t)if(l=e[t],null!=l)if(l instanceof GeoBeans.File){var a=l.name,n=l.accessTime,s=l.lastTime,o=l.size,r=l.path;if(i+="<div class='row row-file' fpath='"+r+"'><div class='col-md-1 col-xs-1 row'><div class='col-md-6 col-xs-6'>","choose-shp"==this.flag){var d=a.slice(a.lastIndexOf(".")+1,a.length);i+="shp"==d.toLowerCase()?"		<input type='checkbox' name='"+a+"'>":"		<input type='checkbox' name='"+a+"' disabled>"}else if("image"==this.flag){var d=a.slice(a.lastIndexOf(".")+1,a.length);d=d.toLowerCase();var c=["jpeg","jpg","tif","png"];i+=-1!=c.indexOf(d)?"		<input type='checkbox' name='"+a+"'>":"		<input type='checkbox' name='"+a+"' disabled>"}else if("csv"==this.flag||"csvImport"==this.flag){var d=a.slice(a.lastIndexOf(".")+1,a.length);i+="csv"==d.toLowerCase()?"		<input type='radio' name='csv'>":"		<input type='radio' name='csv' disabled>"}else i+="		<input type='checkbox' name='"+a+"'>";i+="</div><div class='col-md-6 col-xs-6'><i class='fa fa-file-o'></i></div>",i+="</div><div class='col-md-3 col-xs-3 row-fname'>		<span>"+a+"</span></div><div class='col-md-1 col-xs-1'>文件</div><div class='col-md-3 col-xs-3'>"+n+"</div><div class='col-md-3 col-xs-3'>"+s+"</div><div class='col-md-1 col-xs-1'>"+o+"</div></div>"}else if(l instanceof GeoBeans.Folder){var a=l.name,n=l.accessTime,s=l.lastTime,r=l.path;i+="<div class='row row-folder' fpath='"+r+"'><div class='col-md-1 col-xs-1 row'><div class='col-md-6 col-xs-6'>",i+=null==this.flag?"	<input type='checkbox' name='"+a+"'>":"	<input type='checkbox' name='"+a+"' disabled>",i+="</div><div class='col-md-6 col-xs-6'><i class='fa fa-folder-o'></i></div>",i+="</div><div class='col-md-3 col-xs-3 row-fname'>		<span>"+a+"</span></div><div class='col-md-1 col-xs-1'>文件夹</div><div class='col-md-3 col-xs-3'>"+n+"</div><div class='col-md-3 col-xs-3'>"+s+"</div><div class='col-md-1 col-xs-1'></div></div>"}this.panel.find(".file-list-content-div").html(i);var f=this;this.panel.find(".row-folder .row-fname").click(function(){var e=$(this).parent().attr("fpath");f.panel.find(".tree-folder").removeClass("selected");var l=f.panel.find(".tree-folder[fpath='"+e+"']");l.parents(".nav").first().css("display","block"),l.addClass("selected"),f.panel.find("#current_path").val(e),f.getList(e)})},setCreateFolderName:function(e){var l=this.panel.find("#current_path").val(),i=null;i="/"==l?"/"+e:l+"/"+e,this.createFolder(i)},createFolder:function(e){MapCloud.notify.loading(),fileManager.createFolder(e,this.createFolder_callback)},createFolder_callback:function(e){var l="新建文件夹";MapCloud.notify.showInfo(e,l);var i=MapCloud.file_dialog,t=i.panel.find("#current_path").val();i.getList(t)},removeFile:function(e){fileManager.removeFile(e,this.removeFile_callback)},removeFile_callback:function(e){var l="删除文件";MapCloud.notify.showInfo(e,l);var i=MapCloud.file_dialog,t=i.panel.find("#current_path").val();i.getList(t)},removeFolder:function(e){fileManager.removeFolder(e,this.removeFolder_callback)},removeFolder_callback:function(e){var l="删除文件夹";MapCloud.notify.showInfo(e,l);var i=MapCloud.file_dialog,t=i.panel.find("#current_path").val();i.panel.find(".tree-folder[fpath='"+t+"']").next().remove(),i.getList(t)},refreshCurrentPath:function(){var e=this.panel.find("#current_path").val();this.getList(e)},getFilterList:function(){var e=this.panel.find("#file_filter_select").val(),l=e.split(",");if(0==l.length)return this.list;if(1==l.length&&"all"==l[0])return this.list;for(var i=null,t=null,a=null,n=[],s=0;s<this.list.length;++s)if(i=this.list[s],i instanceof GeoBeans.Folder)n.push(i);else if(i instanceof GeoBeans.File){a=i.name,a=a.toLowerCase();for(var o=0;o<l.length;++o)t=l[o],t="."+t,a.length<=t.length||a.lastIndexOf(t)==a.length-t.length&&n.push(i)}return n},getImportPaths:function(){for(var e=this.panel.find("input[type='checkbox']:checked"),l=null,i=[],t=0;t<e.length;++t)if(l=e[t],null!=l){var a=$(l).parents(".row-file").attr("fpath");null!=a&&i.push(a)}return i},getImportCSVPath:function(){var e=this.panel.find("input[name='csv']:checked");if(0==e.length)return null;var l=e.parents(".row-file").attr("fpath");return l}});
MapCloud.ImportCSVDialog=MapCloud.Class(MapCloud.Dialog,{dataSourceName:null,csvPath:null,typeName:null,source:null,initialize:function(i){MapCloud.Dialog.prototype.initialize.apply(this,arguments),this.registerPanelEvent()},registerPanelEvent:function(){var i=this;this.panel.find('[data-toggle="tooltip"]').tooltip({container:"body"}),this.panel.find(".import-btn-add").click(function(){MapCloud.file_dialog.showDialog("csv")}),this.panel.find(".import-btn-remove").click(function(){}),this.panel.find(".import-btn-upload").click(function(){var t=i.getFields(),a=(i.csvPath,i.panel.find(".csv-typename").val());if(null==a||""==a)return MapCloud.notify.showInfo("请输入导入后的文件名称","Warning"),void i.panel.find(".csv-typename").focus();var l=/^[a-zA-Z][a-zA-Z0-9_]*$/;if(!l.test(a))return MapCloud.notify.showInfo("请输入有效的文件名称","Warning"),void i.panel.find(".csv-typename").focus();i.typeName=a;var e="<div class='row'>开始新建表格</div>";i.panel.find(".import-log-div").append(e),dbsManager.createDataSet(i.dataSourceName,a,t,i.createDataSet_callback)}),this.panel.find(".import-btn-log").click(function(){$(this).hasClass("log-col")?(i.panel.find(".modal-body").css("height","600px"),i.panel.find(".import-log-wrapper").slideDown(500),$(this).find("i").removeClass("fa-chevron-down").addClass("fa-chevron-up"),$(this).removeClass("log-col").addClass("log-exp")):(i.panel.find(".modal-body").css("height","470px"),i.panel.find(".import-log-wrapper").slideUp(500),$(this).find("i").removeClass("fa-chevron-up").addClass("fa-chevron-down"),$(this).removeClass("log-exp").addClass("log-col"))}),this.panel.on("hidden.bs.modal",function(){i.closeDialog()})},cleanup:function(){this.panel.find(".csv-fields-div").empty(),this.panel.find(".csv-path").val(""),this.panel.find(".csv-typename").val(""),this.panel.find(".import-log-div").empty(),this.dataSourceName=null,this.csvPath=null,this.typeName=null,this.source=null},showDialog:function(i){this.cleanup(),this.panel.modal(),this.source=i},closeDialog:function(){if(this.panel.modal("hide"),"vector"==this.source){var i=MapCloud.vector_db_dialog;i.getDataSets(i.dataSourceCur)}else if("vector-user"==this.source){var i=MapCloud.vectorPanel;null!=i&&i.getDataSets(i.dataSourceCur)}},setDataSourceName:function(i){this.dataSourceName=i},setImportCsv:function(i){if(null!=i){this.csvPath=i,this.panel.find(".csv-path").val(this.csvPath);var t=this.csvPath.slice(this.csvPath.lastIndexOf("/")+1,this.csvPath.length-4);this.panel.find(".csv-typename").val(t),fileManager.describeCsv(this.csvPath,this.describeCsv_callback)}},describeCsv_callback:function(i){if(!$.isArray(i))return void MapCloud.notify.showInfo(i,"Warning");var t=MapCloud.importCSV_dialog;t.setCSVFields(i)},setCSVFields:function(i){if(null!=i){for(var t="",a=null,l=0;l<i.length;++l)a=i[l],null!=a&&(t+="<div class='row'>	<div class='col-md-5 col-xs-5'>		<input class='form-control input-sm csv-field-name' type='text' value='"+a+"' disabled=''>	</div>	<div class='col-md-4 col-xs-4'>		<select class='form-control input-sm csv-field-type'>			<option>int</option>			<option>string</option>			<option>double</option>		</select>	</div>	<div class='col-md-3 col-xs-3'>		<input class='form-control input-sm csv-field-length' type='text' value='32' readonly=''>	</div></div>");this.panel.find(".csv-fields-div").html(t),this.panel.find(".csv-field-type").change(function(){var i=$(this).val();"string"==i?$(this).parents(".row").first().find(".csv-field-length").removeAttr("readonly"):$(this).parents(".row").first().find(".csv-field-length").prop("readonly","true")})}},getFields:function(){var i=[];return this.panel.find(".csv-fields-div .row").each(function(){var t=$(this).find(".csv-field-name").val(),a=$(this).find(".csv-field-type").val(),l=null;"string"==a&&(l=$(this).find(".csv-field-length").val());var e=new GeoBeans.GField(t,a,l);i.push(e)}),i},createDataSet_callback:function(i){var t="<div class='row'>创建表格结束："+i+"</div>",a=MapCloud.importCSV_dialog;a.panel.find(".import-log-div").append(t),"success"==i&&a.importCsv()},importCsv:function(){var i=this.dataSourceName,t=this.typeName,a=(this.csvPath,this.csvPath.slice(this.csvPath.lastIndexOf("/")+1,this.csvPath.length)),l=this.csvPath.slice(0,this.csvPath.lastIndexOf("/")),e="<div class='row'>开始导入到数据中</div>";this.panel.find(".import-log-div").append(e),gpsManager.csvImport(i,t,l,a,null,this.importCsv_callback)},importCsv_callback:function(i){var t="<div class='row'>导入到数据库结束："+i+"</div>",a=MapCloud.importCSV_dialog;a.panel.find(".import-log-div").append(t)}});
MapCloud.ImportDialog=MapCloud.Class(MapCloud.Dialog,{dataSourceName:null,features:null,initialize:function(t){MapCloud.Dialog.prototype.initialize.apply(this,arguments),this.registerPanelEvent()},registerPanelEvent:function(){var t=this;this.panel.find('[data-toggle="tooltip"]').tooltip({container:"body"}),this.panel.find(".import-btn-add").click(function(){MapCloud.file_dialog.showDialog("choose-shp")}),this.panel.find(".import-btn-remove").click(function(){t.removePath()}),this.panel.find(".import-btn-upload").click(function(){t.importFeatures()}),this.panel.find(".import-btn-log").click(function(){$(this).hasClass("log-col")?(t.panel.find(".modal-body").css("height","578px"),t.panel.find(".import-log-wrapper").slideDown(500),$(this).find("i").removeClass("fa-chevron-down").addClass("fa-chevron-up"),$(this).removeClass("log-col").addClass("log-exp")):(t.panel.find(".modal-body").css("height","366px"),t.panel.find(".import-log-wrapper").slideUp(500),$(this).find("i").removeClass("fa-chevron-up").addClass("fa-chevron-down"),$(this).removeClass("log-exp").addClass("log-col"))}),this.panel.find("button.close").click(function(){t.closeDialog()}),this.panel.on("hidden.bs.modal",function(){t.closeDialog()})},showDialog:function(t){MapCloud.Dialog.prototype.showDialog.apply(this,arguments),this.source=t},cleanup:function(){this.panel.find(".import-list-div").html(""),this.panel.find(".import-log-div").html(""),this.paths=[],this.source=null},closeDialog:function(){if(this.panel.modal("hide"),"vector"==this.source){var t=MapCloud.vector_db_dialog;t.getDataSets(t.dataSourceCur)}else if("dataPanel"==this.source){var t=MapCloud.data_source_panel;t.refresh()}else if("vector-user"==this.source){var t=MapCloud.vectorPanel;null!=t&&t.getDataSets(t.dataSourceCur)}},setDataSourceName:function(t){this.dataSourceName=t,this.panel.find(".import-db-name").html(this.dataSourceName)},addImportPaths:function(t){if(null==this.paths)this.paths=t;else for(var i=null,a=0;a<t.length;++a)i=t[a],-1==this.paths.indexOf(i)&&this.paths.push(i);this.setImportPaths(this.paths)},setImportPaths:function(t){for(var i=null,a="",l=null,s=0;s<t.length;++s)if(i=t[s],null!=i){var n=i.lastIndexOf("."),e=i.lastIndexOf("/");l=i.slice(e+1,n),a+="<div class='row'><div class='col-md-4 col-xs-4 fpath'>"+i+"</div><div class='col-md-2 col-xs-2'>public</div><div class='col-md-3 col-xs-3 col-md-edit fname'><span>"+l+"</span></div><div class='col-md-2 col-xs-2 col-md-edit fgeom'><span>shape</span></div><div class='col-md-1 col-xs-1 col-md-edit fsrid'><span>4326</span></div></div>"}this.panel.find(".import-list-div").html(a),this.panel.find(".import-list-div .col-md-edit").dblclick(function(){var t=$(this).find("span").html();if(void 0!=t){var i=$(this).css("width"),a=i.slice(0,i.lastIndexOf("px"));a-=2;var l="<input type='text' value='"+t+"' style='width:"+a+"px;padding:0px'>";$(this).html(l),$(this).css("padding","4px 2px 4px 2px");$(this).find("input").focus(),$(this).find("input").focusout(function(){var t=$(this).val();$(this).parent().html("<span>"+t+"</span>"),$(this).parent().css("padding","6px 2px 6px 2px")})}});var o=this;this.panel.find(".import-list-div .row").click(function(){o.panel.find(".import-list-div .row").removeClass("selected"),$(this).addClass("selected")})},removePath:function(){var t=this.panel.find(".import-list-div .row.selected");if(0==t.length)return void MapCloud.notify.showInfo("请选择一行记录进行删除","Warning");for(var i=t.find(".fpath").html(),a=0;a<this.paths.length;++a){var l=this.paths[a];if(l==i){this.paths.splice(a,1);break}}this.setImportPaths(this.paths)},getFeaturesValid:function(){for(var t=this.panel.find(".import-list-div .row"),i=null,a=null,l=null,s=null,n=null,e=/^([\u4E00-\uFA29]|[\uE7C7-\uE7F3]|[a-zA-Z0-9]|[_])*$/,o=/^[0-9]+$/,d=0;d<t.length;++d){if(i=t[d],a=$(i).find(".fpath").html(),l=$(i).find(".fname span").html(),!e.test(l))return MapCloud.notify.showInfo("请输入有效的表名称","Warning"),!1;if(s=$(i).find(".fgeom span").html(),!e.test(s))return MapCloud.notify.showInfo("请输入有效的空间列","Warning"),!1;if(n=$(i).find(".fsrid span").html(),!o.test(n))return MapCloud.notify.showInfo("请输入有效的空间参考","Warning"),!1}return!0},getFeatures:function(){for(var t=this.panel.find(".import-list-div .row"),i=[],a=null,l=null,s=null,n=null,e=null,o=null,d=0;d<t.length;++d)l=t[d],s=$(l).find(".fpath").html(),n=$(l).find(".fname span").html(),e=$(l).find(".fgeom span").html(),o=$(l).find(".fsrid span").html(),a={path:s,name:n,geom:e,srid:o},i.push(a);return i},importFeatures:function(){if(null==this.paths||0==this.paths.length)return void MapCloud.notify.showInfo("请添加上传数据","Warning");if(null==this.dataSourceName)return void MapCloud.notify.showInfo("请选择要导入的数据库","Warning");var t=this.getFeaturesValid();if(t){var i=this.getFeatures();this.features=i;var a=i[0];null!=a&&this.importFeature(a)}},importFeature:function(t){if(null!=t){var i=t.name,a=t.path,l=t.srid,s=t.geom,n=a.lastIndexOf("/"),e=a.slice(n+1,a.length);e=e.slice(0,e.lastIndexOf(".shp")),a=a.slice(0,n+1),MapCloud.notify.loading(),dbsManager.featureImport(this.dataSourceName,i,a,e,l,s,this.importFeature_callback)}},importFeature_callback:function(t){MapCloud.notify.hideLoading();var i=MapCloud.import_dialog,a=i.features[0];if(null!=a){var l="<div class='row'>"+a.path+" : "+t+"</div>";i.features.splice(0,1),i.panel.find(".import-log-div").append(l)}if(null!=i.features){var s=i.features.length;if(s>=1){var n=i.features[0];i.importFeature(n)}}}});
MapCloud.ImportRasterDialog=MapCloud.Class(MapCloud.Dialog,{sourceName:null,rasterPath:null,rasters:null,path:null,source:null,initialize:function(t){MapCloud.Dialog.prototype.initialize.apply(this,arguments);this.registerPanelEvent()},registerPanelEvent:function(){var t=this;this.panel.find('[data-toggle="tooltip"]').tooltip({container:"body"}),t.panel.find(".import-btn-log").click(function(){if($(this).hasClass("log-col")){var s=t.panel.find(".modal-body").css("height");s=parseInt(s.slice(0,s.lastIndexOf("px")));var a=s+200;t.panel.find(".modal-body").css("height",a+"px"),t.panel.find(".import-log-wrapper").slideDown(500),$(this).find("i").removeClass("fa-chevron-down").addClass("fa-chevron-up"),$(this).removeClass("log-col").addClass("log-exp")}else{var s=t.panel.find(".modal-body").css("height");s=parseInt(s.slice(0,s.lastIndexOf("px")));var i=s-200;t.panel.find(".modal-body").css("height",i+"px"),t.panel.find(".import-log-wrapper").slideUp(500),$(this).find("i").removeClass("fa-chevron-up").addClass("fa-chevron-down"),$(this).removeClass("log-exp").addClass("log-col")}}),this.panel.find(".import-btn-add").click(function(){MapCloud.file_dialog.showDialog("image")}),this.panel.find(".import-btn-remove").click(function(){t.removePath()}),this.panel.find(".import-btn-upload").click(function(){t.addRasters()}),this.panel.on("hidden.bs.modal",function(){t.closeDialog()})},cleanup:function(){this.sourceName=null,this.rasterPath=null,this.rasters=null,this.paths=null,this.source=null,this.panel.find(".import-list-div").empty(),this.panel.find(".import-db-name").val(""),this.panel.find(".import-raster-path").val(""),this.panel.find(".import-log-div").empty()},showDialog:function(t){this.cleanup(),this.panel.modal(),this.source=t},closeDialog:function(){if(this.panel.modal("hide"),"raster"==this.source){var t=MapCloud.raster_db_dialog;t.getListRefresh(this.sourceName,this.rasterPath)}else if("raster-user"==this.source){var s=MapCloud.rasterPanel;null!=s&&s.getListRefresh(this.sourceName,this.rasterPath)}},setRasterPath:function(t,s){this.sourceName=t,this.rasterPath=s,this.panel.find(".import-db-name").val(this.sourceName),this.panel.find(".import-raster-path").val(this.rasterPath)},addImportPaths:function(t){if(null==this.paths)this.paths=t;else for(var s=null,a=0;a<t.length;++a)s=t[a],-1==this.paths.indexOf(s)&&this.paths.push(s);this.setImportPaths(this.paths)},setImportPaths:function(t){for(var s=null,a=null,i="",e=0;e<t.length;++e)if(s=t[e],null!=s){var l=s.lastIndexOf("/");a=s.slice(l+1,s.length),i+="<div class='row'><div class='col-md-6 col-xs-6 fpath'>"+s+"</div><div class='col-md-6 col-xs-6 col-md-edit rname'><span>"+a+"</span></div></div>"}this.panel.find(".import-list-div").html(i),this.panel.find(".import-list-div .col-md-edit").dblclick(function(){var t=$(this).find("span").html();if(void 0!=t){var s=$(this).css("width"),a=s.slice(0,s.lastIndexOf("px"));a-=2;var i="<input type='text' value='"+t+"' style='width:"+a+"px;padding:0px'>";$(this).html(i),$(this).css("padding","4px 2px 4px 2px");$(this).find("input").focus(),$(this).find("input").focusout(function(){var t=$(this).val();$(this).parent().html("<span>"+t+"</span>"),$(this).parent().css("padding","6px 2px 6px 2px")})}});var n=this;this.panel.find(".import-list-div .row").click(function(){n.panel.find(".import-list-div .row").removeClass("selected"),$(this).addClass("selected")})},removePath:function(){var t=this.panel.find(".import-list-div .row.selected");if(0==t.length)return void MapCloud.notify.showInfo("请选择一行记录进行删除","Warning");for(var s=t.find(".fpath").html(),a=0;a<this.paths.length;++a){var i=this.paths[a];if(i==s){this.paths.splice(a,1);break}}this.setImportPaths(this.paths)},getRasterInfos:function(){for(var t=this.panel.find(".import-list-div .row"),s=[],a=null,i=null,e=null,l=null,n=0;n<t.length;++n)l=t[n],e=$(l).find(".fpath").html(),i=$(l).find(".rname span").html(),a={filePath:e,rasterName:i},s.push(a);return s},addRasters:function(){if(null==this.paths||0==this.paths.length)return void MapCloud.notify.showInfo("请添加要导入的影像","Warning");if(null==this.sourceName||null==this.rasterPath)return void MapCloud.notify.showInfo("请设置要导入的数据库和路径","Warning");var t=this.getRasterInfos();this.rasters=t;var s=t[0];null!=s&&this.addRaster(this.sourceName,s.rasterName,this.rasterPath,s.filePath)},addRaster:function(t,s,a,i){rasterDBManager.addRaster(t,s,a,i,this.addRaster_callback)},addRaster_callback:function(t){var s=MapCloud.import_raster_dialog,a=s.rasters,i=a[0];if(null!=i){var e="<div class='row'>"+i.filePath+" : "+t+"</div>";s.rasters.splice(0,1),s.panel.find(".import-log-div").append(e)}if(null!=s.rasters){var l=s.rasters.length;if(l>=1){var i=s.rasters[0];s.addRaster(s.sourceName,i.rasterName,s.rasterPath,i.filePath)}}}});
MapCloud.ImportVectorDialog=MapCloud.Class(MapCloud.Dialog,{uploader:null,uploadBtn:null,uploadList:null,uploadState:null,dataSources:null,dataSourceName:null,uploadPath:null,source:null,initialize:function(l){MapCloud.Dialog.prototype.initialize.apply(this,arguments);var a=this;this.uploadBtn=this.panel.find("#vector_upload"),this.uploadBtn.click(function(){"uploading"===a.uploadState?a.uploader.stop():a.uploader.upload()}),this.panel.on("hidden.bs.modal",function(){a.closeDialog()})},cleanup:function(){this.dataSourceName=null,this.source=null,this.uploadPath=null,this.panel.find("#vector_list").html("")},showDialog:function(l,a){this.cleanup(),this.panel.modal(),this.uploadList=this.panel.find("#vector_list"),this.uploadState="pending";this.source=a,null!=l&&this.setUploadPath(l),null==this.uploader?this.createUploader():(this.panel.find("#picker").html("选择文件"),this.panel.find("#picker").removeClass("webuploader-container"),this.uploader=null,this.createUploader())},closeDialog:function(){if("file"==this.source){var l=MapCloud.file_dialog;l.refreshCurrentPath()}else if("file-user"==this.source){var l=MapCloud.filePanel;l.refreshCurrentPath()}this.panel.modal("hide")},createUploader:function(){var l=this,a=null;null!=user&&(a=user.name),this.uploader=WebUploader.create({server:"/uploader/fileupload.php",pick:"#picker",resize:!1,chunked:!0,path:l.uploadPath,user:a}),this.uploader.on("fileQueued",function(a){var i=l.getFileHtml(a);l.uploadList.append(i),l.panel.find("#"+a.id+" .btn-drop").click(function(){var a=$(this).parents(".list-group-item"),i=a.attr("id"),e=l.panel.find(".list-group-item[fid='"+i+"']");e.hasClass("info-invis")?(e.removeClass("info-invis"),e.addClass("info-vis"),e.slideDown().css("display","block")):(e.addClass("info-invis"),e.removeClass("info-vis"),e.slideUp())})}),this.uploader.on("uploadProgress",function(a,i){var e=l.panel.find("#"+a.id);e.find(".progress .progress-bar").css("width",100*i+"%"),e.find(".state").text("上传中")}),this.uploader.on("uploadSuccess",function(a){var i=null;i=null!=l.dataSourceName?l.dataSourceName:l.panel.find("#"+a.id+" .import-vector-db option:selected").val();var e=l.panel.find("#"+a.id);e.find(".progress").removeClass("active");var t=l.panel.find("#"+a.id).find(".state");t.html("上传完毕");var o=l.panel.find(".list-group-item[fid='"+a.id+"']");o.find(".vector-type-name").val(),o.find(".vector-srid").val()}),this.uploader.on("uploadError",function(a){l.panel.find("#"+a.id).find(".state").text("上传出错")}),this.uploader.on("uploadComplete",function(l){}),this.uploader.on("all",function(a){"startUpload"===a?l.uploadState="uploading":"stopUpload"===a?l.uploadState="paused":"uploadFinished"===a&&(l.uploadState="done"),"uploading"===l.uploadState?l.uploadBtn.text("暂停上传"):l.uploadBtn.text("开始上传")})},getFileHtml:function(l){var a=(l.name,l.name.slice(0,l.name.indexOf(".zip")),"<li class='list-group-item row' id='"+l.id+"'>    <div class='col-md-3 col-xs-3 info'>"+l.name+"    </div>");return a+="    <div class='col-md-6 col-xs-6 progress-div'>        <div class='progress progress-striped active'>            <div class='progress-bar' role='progressbar' style='width: 0%;''></div>        </div>    </div>",a+="   <div class='col-md-3 col-xs-3 state'>等待上传</div></li>"},setUploadPath:function(l){this.uploadPath=l}});
