MapCloud.GPSRasterThresholdDialog = MapCloud.Class(MapCloud.Dialog,{
	...
	registerPanelEvent : function(){
		...
		dialog.panel.find(".btn-choose-input-raster").click(function(){
			MapCloud.raster_db_dialog.showDialog("rasterThreshold",false);
		});


		// choose output sourcename
		dialog.panel.find(".btn-choose-output-source-name").click(function(){
			MapCloud.raster_db_dialog.showDialog("rasterThreshold",true);
		});		
		...
		this.panel.find(".gps-btn-oper-btn").click(function(){
			...
			gpsManager.rasterThreshold(dialog.inputSourceName,dialog.inputRasterName,
				dialog.inputRasterPath,dialog.outputSourceName, outputRasterName,
				dialog.outputRasterPath,dialog.rasterThreshold_callback);
	...
	// 结果
	rasterThreshold_callback : function(result){
		MapCloud.notify.hideLoading();
		var dialog = MapCloud.gps_raster_threshold_dialog;
		var outputRasterName = dialog.panel.find(".gps-output-raster-name").val() 
