MapCloud.GPSRasterGraylizeDialog = MapCloud.Class(MapCloud.Dialog,{
	...
	registerPanelEvent : function(){
		...
		dialog.panel.find(".btn-choose-input-raster").click(function(){
			MapCloud.raster_db_dialog.showDialog("rasterGraylize",false);
		});


		// choose output sourcename
		dialog.panel.find(".btn-choose-output-source-name").click(function(){
			MapCloud.raster_db_dialog.showDialog("rasterGraylize",true);
		});
		...
		this.panel.find(".gps-btn-oper-btn").click(function(){
			...
			gpsManager.rasterGraylize(dialog.inputSourceName,dialog.inputRasterName,
				dialog.inputRasterPath,dialog.outputSourceName, outputRasterName,
				dialog.outputRasterPath,dialog.rasterGraylize_callback);
		});
	...
	rasterGraylize_callback : function(result){
		MapCloud.notify.hideLoading();
		var dialog = MapCloud.gps_raster_graylize_dialog;
		var outputRasterName = dialog.panel.find(".gps-output-raster-name").val() 
