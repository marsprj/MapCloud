MapCloud.GPSRasterReverseDialog = MapCloud.Class(MapCloud.Dialog,{
	...
	registerPanelEvent : function(){
		...
		dialog.panel.find(".btn-choose-input-raster").click(function(){
			MapCloud.raster_db_dialog.showDialog("rasterReverse",false);
		});


		// choose output sourcename
		dialog.panel.find(".btn-choose-output-source-name").click(function(){
			MapCloud.raster_db_dialog.showDialog("rasterReverse",true);
		});
		...
		this.panel.find(".gps-btn-oper-btn").click(function(){
			...
			gpsManager.rasterReverse(dialog.inputSourceName,dialog.inputRasterName,
				dialog.inputRasterPath,dialog.outputSourceName, outputRasterName,
				dialog.outputRasterPath,dialog.rasterReverse_callback);
	...
	// 结果
	rasterReverse_callback : function(result){
		MapCloud.notify.hideLoading();
		var dialog = MapCloud.gps_raster_reverse_dialog;
		var outputRasterName = dialog.panel.find(".gps-output-raster-name").val() 
