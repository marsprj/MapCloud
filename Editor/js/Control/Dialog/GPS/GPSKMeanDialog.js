MapCloud.GPSKMeanDialog = MapCloud.Class(MapCloud.Dialog,{
	// 输入数据库
	...
	registerPanelEvent : function(){
		...
		dialog.panel.find(".btn-choose-input").click(function(){
			MapCloud.vector_db_dialog.showDialog("kmean");
		});
	...
	clusterKmean_callback : function(result){
		MapCloud.notify.hideLoading();
		var dialog = MapCloud.gps_kmean_dialog;
