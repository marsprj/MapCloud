MapCloud.GPSLineToPointsDialog = MapCloud.Class(MapCloud.Dialog,{
	...
	registerPanelEvent : function(){
		...
		dialog.panel.find(".btn-choose-input").click(function(){
			MapCloud.vector_db_dialog.showDialog("lineToPoints");
		});


		// choose output sourcename
		dialog.panel.find(".btn-choose-output-source-name").click(function(){
			MapCloud.gps_output_source_dialog.showDialog("lineToPoints","Feature");
		});
	...
	lineToPoints_callback : function(result){
		MapCloud.notify.hideLoading();
		var dialog = MapCloud.gps_line_to_points_dialog;
