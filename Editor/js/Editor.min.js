...
MapCloud.CreateTileStoreDialog=MapCloud.Class(MapCloud.Dialog,{source:null,sourceName:null,initialize:function(e){MapCloud.Dialog.prototype.initialize.apply(this,arguments);this.registerPanelEvent()},registerPanelEvent:function(){var e=this;this.panel.find(".btn-confirm").click(function(){var a=e.panel.find(".tile-store-name").val();if(null==a||""==a)return MapCloud.notify.showInfo("请输入瓦片库的名称","Warning"),void e.panel.find(".tile-store-name").focus();var o=/^[0-9a-zA-Z_]+$/;if(!o.test(a))return MapCloud.notify.showInfo("请输入有效的瓦片库名称","Warning"),void e.panel.find(".tile-store-name").focus();var i=e.panel.find(".tile-store-type").val();if(null==i||""==i)return void MapCloud.notify.showInfo("请选择切图方式","Warning");if(null==e.sourceName)return void MapCloud.notify.showInfo("当前数据库为空","Warning");var l=e.sourceName;e.createTileStore(l,a,i)})},showDialog:function(e,a){MapCloud.Dialog.prototype.showDialog.apply(this,arguments),this.source=e,this.sourceName=a},cleanup:function(){this.panel.find(".tile-store-name").val("")},createTileStore:function(e,a,o){MapCloud.notify.loading(),dbsManager.createTileStore(e,a,o,this.createTileStore_callback)},createTileStore_callback:function(e){MapCloud.notify.showInfo(e,"新建瓦片库");var a=MapCloud.create_tile_store_dialog;a.closeDialog();var o=a.panel.find(".tile-store-name").val(),i=null;if("tileDB"==a.source){i=MapCloud.tile_db_dialog;var l=a.sourceName;i.getTileStores(l)}else if("cutMap"==a.source){i=MapCloud.cut_map_dialog;var l=a.sourceName;i.getTileStores(l),i.setCreateStoreName(o)}}});
...
MapCloud.GetMapsDialog=MapCloud.Class(MapCloud.Dialog,{initialize:function(a){MapCloud.Dialog.prototype.initialize.apply(this,arguments);var n=this;this.panel.find(".btn-confirm").each(function(){$(this).click(function(){var a=n.panel.find(".maps-thumb .map-thumb.selected");if(0==a.length)return void MapCloud.notify.showInfo("请选择一个地图！","Warning");var t=a.parents(".maps-thumb").attr("name");null!=t&&(n.closeDialog(),n.openMap(t))})})},cleanup:function(){this.panel.find("#maps_list").html("")},showDialog:function(){this.cleanup(),this.panel.modal(),MapCloud.notify.loading(),mapManager.getMaps(this.getMaps_callback)},getMaps_callback:function(a){MapCloud.notify.hideLoading();for(var n=MapCloud.get_maps_dlg,t=n.panel,l="",e=0;e<a.length;++e){var i=a[e],o=i.name,s=i.thumbnail,p="";p=null!=s?"	<a href='#' class='map-thumb' style=\"background-image:url("+s+')"></a>':"	<a href='#' class='map-thumb'></a>",l+="<li class='maps-thumb' name='"+o+"'>"+p+"	<div class='caption text-center'>		<h6>"+o+"</h6>	</div></li>"}t.find("#maps_list").html(l),t.find(".map-thumb").each(function(){$(this).click(function(){t.find(".map-thumb").each(function(){$(this).removeClass("selected")}),$(this).addClass("selected")}).dblclick(function(){var a=$(this).parent().attr("name");n.openMap(a)}).mouseover(function(a){t.find(".map-thumb").each(function(){$(this).removeClass("enter")}),$(this).addClass("enter")})})},openMap:function(a){this.closeDialog(),MapCloud.notify.loading();var n="打开地图 [ "+a+" ]";mapObj=mapManager.getMap("mapCanvas_wrapper",a),null==mapObj?MapCloud.notify.showInfo("failed",n):($("#layers_content").slideDown(),mapObj.setNavControl(!1),mapObj.draw(),MapCloud.refresh_panel.refreshPanel(),MapCloud.dataGrid.cleanup(),MapCloud.notify.showInfo("success",n))}});
MapCloud.HeatMapDialog=MapCloud.Class(MapCloud.Dialog,{layer:null,initialize:function(e){MapCloud.Dialog.prototype.initialize.apply(this,arguments);var l=this;this.panel.find(".field-enable").change(function(){var e=$(this).parents(".form-group");this.checked?e.find("#heat_map_field").prop("disabled",!1):e.find("#heat_map_field").prop("disabled",!0)}),this.panel.find(".btn-confirm").click(function(){if(null==l.layer)return void MapCloud.notify.showInfo("请先设置点图层","Warning");l.closeDialog();var e=l.panel.find(".field-enable").prop("checked"),a=null,i=null;return e?a=l.panel.find("#heat_map_field").val():i=1,null==a&&null==i?void MapCloud.notify.showInfo("请设置有效的字段","Warning"):(mapObj.addHeatMap(l.layer.name,a,i),mapObj.draw(),void MapCloud.refresh_panel.refreshPanel())})},setLayer:function(e){if(null!=e){this.layer=e;var l=e.getHeatMapLayer();if(null==l)this.showFields(e);else{this.showFields(e);var a=l.getUniqueValue(),i=l.getField();null==a&&null!=i&&(this.panel.find(".field-enable").prop("checked",!0),this.panel.find("#heat_map_field").prop("disabled",!1),this.panel.find("#heat_map_field option[value='"+i+"']").attr("selected",!0)),null!=a&&(this.panel.find(".field-enable").prop("checked",!1),this.panel.find("#heat_map_field").prop("disabled",!0))}}},showFields:function(e){if(null!=e&&null!=mapObj){var l=e.getFields();if(null!=l){for(var a="",i=0;i<l.length;++i){var n=l[i],p=n.type;p=p.toLowerCase(),("int"==p||"double"==p||"float"==p)&&(a+="<option value='"+n.name+"'>"+n.name+"</option>")}this.panel.find("#heat_map_field").html(a)}}},cleanup:function(){this.layer=null,this.panel.find("#heat_map_field").empty().prop("disabled",!1),this.panel.find(".field-enable").prop("checked",!0)}});
...
MapCloud.MapMgrDialog=MapCloud.Class(MapCloud.Dialog,{initialize:function(a){MapCloud.Dialog.prototype.initialize.apply(this,arguments);var e=this;e.panel.find("#remove_select_maps").each(function(){$(this).click(function(){e.panel.find(".selected").removeClass("selected")})}),e.panel.find("#remove_maps").each(function(){$(this).click(function(){var a=[];e.panel.find(".selected").each(function(){var e=$(this).parent().attr("name");a.push(e)});for(var i=null,l=null,n=0;n<a.length;++n){i=a[n],l=mapManager.removeMap(i);var s="Remove Map [ "+i+" ]";MapCloud.notify.showInfo(l,s)}mapManager.getMaps(e.getMaps_callback)})}),e.panel.find(".btn-confirm").each(function(){$(this).click(function(){e.closeDialog()})})},cleanup:function(){this.panel.find("#maps_list").html("")},showDialog:function(){this.cleanup(),this.panel.modal(),mapManager.getMaps(this.getMaps_callback)},getMaps_callback:function(a){for(var e=MapCloud.map_mgr_dialog,i=e.panel,l="",n=0;n<a.length;++n){var s=a[n],t=s.name,c=s.thumbnail,p="";p=null!=c?"<a href='#' class='map-thumb' style=\"background-image:url("+c+")\">	<div class='map-check'>		<img src='images/check.png'>	</div></a>":"<a href='#' class='map-thumb'>	<div class='map-check'>		<img src='images/check.png'>	</div></a>",l+="<li class='maps-thumb' name='"+t+"'>"+p+"	<div class='caption text-center'>		<h6>"+t+"</h6>	</div></li>"}i.find("#maps_list").html(l),i.find(".map-thumb").each(function(){$(this).click(function(){$(this).hasClass("selected")?$(this).removeClass("selected"):$(this).addClass("selected")})})}});
...
MapCloud.ProcessDialog=MapCloud.Class(MapCloud.Dialog,{maxCount:15,initialize:function(i){MapCloud.Dialog.prototype.initialize.apply(this,arguments),this.registerPanelEvent()},showDialog:function(){MapCloud.Dialog.prototype.showDialog.apply(this,arguments),this.getJob(GeoBeans.Job.Status.RUNNING,this.maxCount,0)},registerPanelEvent:function(){var i=this;i.panel.find("select").change(function(){var t=$(this).val(),l=null;"running"==t?l=GeoBeans.Job.Status.RUNNING:"finished"==t?l=GeoBeans.Job.Status.FINISHED:"canceled"==t&&(l=GeoBeans.Job.Status.CANCELED),null!=l&&i.getJob(l,i.maxCount,0)}),this.panel.find(".pagination li a").click(function(){})},cleanup:function(){this.panel.find("select option[value='running']").attr("selected",!0),this.panel.find(".job-list").empty()},getJob:function(i,t,l){null!=i&&null!=t&&null!=l&&gpsManager.getJob(i,t,l,this.getJob_callback)},getJob_callback:function(i){if($.isArray(i)){var t=MapCloud.process_dialog;t.showJobList(i)}},showJobList:function(i){for(var t=null,l="",n=0;n<i.length;++n)if(t=i[n],null!=t){var a=t.oper,o=t.server,e=t.startTime,s=t.endTime;l+="<div class='row'><div class='col-md-3 text-ellip' title='"+a+"'>"+a+"</div><div class='col-md-3'>"+o+"</div><div class='col-md-3'>"+e+"</div><div class='col-md-3'>"+s+"</div></div>"}this.panel.find(".job-list").html(l)}});
...
MapCloud.RasterDBDialog=MapCloud.Class(MapCloud.Dialog,{raster:null,rasterPath:null,rasterName:null,source:null,outputFlag:!1,registerDataSourceName:null,initialize:function(a){MapCloud.Dialog.prototype.initialize.apply(this,arguments);this.registerPanelEvent()},registerPanelEvent:function(){var a=this;this.panel.find('[data-toggle="tooltip"]').tooltip({container:"body"}),this.panel.find(".db-list").change(function(){var e=$(this).val();null!=e&&(a.panel.find(".foler-ul").remove(),a.getList(e,"/"))}),this.panel.find(".btn-add-server").click(function(){MapCloud.pgis_connection_dialog.showDialog("raster","raster")}),this.panel.find(".btn-remove-server").click(function(){a.removeDataSource()}),this.panel.find(".btn-add-folder").click(function(){a.createFolder()}),this.panel.find(".btn-remove-file").click(function(){var e=a.panel.find(".db-list").val();if(null==e)return void MapCloud.notify.showInfo("请选择一个数据源","Warning");var l=a.panel.find("input[type='checkbox']:checked");if(0==l.length){var i=a.panel.find(".tree-folder.selected").attr("fpath");if("/"==i)return void MapCloud.notify.showInfo("无法删除根目录","Warning");var t=a.panel.find(".tree-folder.selected span").html();if(null==t)return void MapCloud.notify.showInfo("请选择删除的文件","Warning");if(!confirm("确定要删除文件夹["+t+"]?"))return;var s=a.panel.find(".tree-folder.selected").parents(".nav").first().prev();a.panel.find(".tree-folder").removeClass("selected"),s.addClass("selected");var r=s.attr("fpath");a.panel.find(".current-path").val(r);var e=a.panel.find(".db-list").val();return void a.removeFolder(e,i)}confirm("确定要删除吗？")&&l.each(function(){var e=$(this).parent().parent().parent(),l=e.attr("fpath"),i=a.panel.find(".db-list").val();if(e.hasClass("row-file")){var t=a.panel.find(".current-path").val(),s=e.find(".row-fname span").html();a.removeRaster(i,t,s)}else e.hasClass("row-folder")&&a.removeFolder(i,l)})}),this.panel.find(".btn-upload-raster").click(function(){var e=a.panel.find(".db-list").val();if(null==e)return void MapCloud.notify.showInfo("请选择要上传的数据源","Warning");var l=a.panel.find(".current-path").val();MapCloud.import_raster_dialog.showDialog("raster"),MapCloud.import_raster_dialog.setRasterPath(e,l)}),this.panel.find(".btn-refresh").click(function(){a.getListRefresh()}),this.panel.find(".btn-raster-info").click(function(){null!=a.raster&&(a.panel.find(".btn-raster-info").attr("disabled",!0),a.panel.find(".bbtn-raster-preview").attr("disabled",!1),a.showRasterInfo(a.raster))}),this.panel.find(".btn-raster-preview").click(function(){a.panel.find(".btn-raster-info").attr("disabled",!1),a.panel.find(".bbtn-raster-preview").attr("disabled",!0);var e=a.panel.find(".db-list").val();a.showRasterPreview(e,a.rasterName,a.rasterPath)}),this.panel.find(".btn-confirm").click(function(){if(null==a.source)return void a.closeDialog();var e=null,l=a.panel.find(".db-list").val();switch(a.source){case"newLayer":e=MapCloud.new_raster_dblayer_dialog;break;case"rasterEdgeDetect":e=MapCloud.gps_raster_edge_detect_dialog;break;case"rasterExtract":e=MapCloud.gps_raster_extract_dialog;break;case"rasterReverse":e=MapCloud.gps_raster_reverse_dialog;break;case"rasterGraylize":e=MapCloud.gps_raster_graylize_dialog;break;case"rasterSmooth":e=MapCloud.gps_raster_smooth_dialog;break;case"rasterStretch":e=MapCloud.gps_raster_stretch_dialog;break;case"rasterSubtract-1":case"rasterSubtract-2":case"rasterSubtract":e=MapCloud.gps_raster_subtract_dialog;break;case"rasterPixelBlend-1":case"rasterPixelBlend-2":case"rasterPixelBlend":e=MapCloud.gps_raster_pixel_blend_dialog;break;case"rasterThreshold":e=MapCloud.gps_raster_threshold_dialog;break;case"rasterHisEqual":e=MapCloud.gps_raster_his_equal_dialog;break;case"rasterSepiaTone":e=MapCloud.gps_raster_sepia_tone_dialog;break;case"demAspect":e=MapCloud.gps_dem_aspect_dialog;break;case"demSlope":e=MapCloud.gps_dem_slope_dialog;break;case"demStretch":e=MapCloud.gps_dem_stretch_dialog;break;case"demHillshade":e=MapCloud.gps_dem_hillshade_dialog}if(a.outputFlag){var i=a.panel.find(".current-path").val();null!=e&&e.setOutput(l,i)}else{var t=null,s=null;if(null==a.raster){var r=a.panel.find("input[type='radio']:checked");if(0==r.length)return void MapCloud.notify.showInfo("请选择一张影像","Warning");t=r.parents(".row-file").find(".row-fname span").html(),s=a.panel.find(".current-path").val()}else t=a.rasterName,s=a.rasterPath;if("rasterExtract"==a.source)return a.returnExtractRaster(l,t,s),e.setRaster(l,t,s,a.raster),void a.closeDialog();if("rasterSubtract-1"==a.source)return e.setRaster_1(l,t,s),void a.closeDialog();if("rasterSubtract-2"==a.source)return e.setRaster_2(l,t,s),void a.closeDialog();if("rasterPixelBlend-1"==a.source)return e.setRaster_1(l,t,s),void a.closeDialog();if("rasterPixelBlend-2"==a.source)return e.setRaster_2(l,t,s),void a.closeDialog();null!=e&&e.setRaster(l,t,s)}a.closeDialog()})},showDialog:function(a,e){MapCloud.notify.loading(),this.cleanup(),this.panel.modal(),this.source=a,null!=e&&(this.outputFlag=e),this.getDataSources(),null==this.source?this.panel.find(".btn-confirm").html("确定"):this.panel.find(".btn-confirm").html("选择")},getDataSources:function(){dbsManager.getDataSources(this.getDataSources_callback,"Raster")},cleanup:function(){this.raster=null,this.rasterName=null,this.rasterPath=null,this.source=null,this.outputFlag=!1,this.registerDataSourceName=null,this.panel.find(".db-list").html(""),this.panel.find(".nav.foler-ul").remove(),this.panel.find(".raster-list-content-div").empty(),this.panel.find(".current-path").val("/"),this.panel.find(".current-raster-path").val(""),this.panel.find(".raster-col").css("display","none"),this.panel.find(".raster-list-col").css("display","block")},getDataSources_callback:function(a){MapCloud.notify.hideLoading();var e=MapCloud.raster_db_dialog;e.showDataSources(a)},showDataSources:function(a){if(null!=a){for(var e=null,l=null,i="",t=0;t<a.length;++t)e=a[t],null!=e&&(l=e.name,i+="<option value='"+l+"'>"+l+"</option>");if(this.panel.find(".db-list").html(i),null!=this.registerDataSourceName)this.panel.find(".db-list option[value='"+this.registerDataSourceName+"']").attr("selected",!0),this.getList(this.registerDataSourceName,"/"),this.registerDataSourceName=null;else{var s=this.panel.find(".db-list").val();null!=s&&""!=s&&this.getList(s,"/")}}},getList:function(a,e){null!=a&&null!=e&&(MapCloud.notify.loading(),rasterDBManager.getList(a,e,this.getList_callback))},getList_callback:function(a){MapCloud.notify.hideLoading();var e=MapCloud.raster_db_dialog;e.showListTree(a),e.showListPanel(a)},getListTreeClick:function(a,e){MapCloud.notify.loading(),rasterDBManager.getList(a,e,this.getListTreeClick_callback)},getListTreeClick_callback:function(a){MapCloud.notify.hideLoading();var e=MapCloud.raster_db_dialog;e.list=a,e.showListPanel(a)},showListTree:function(a){for(var e=null,l=null,i="<ul class='nav foler-ul'>",t=0;t<a.length;++t)if(e=a[t],null!=e&&e instanceof GeoBeans.Folder){var s=e.name;i+="<li><a href='javascript:void(0)' class='tree-folder' fpath=\""+e.path+'"><i class="fa fa-folder-o"></i><span>'+s+"</span></a></li>"}i+="</ul>",l=this.panel.find(".current-path").val();var r=this.panel.find(".db-tree a[fpath='"+l+"']");r.find("i").removeClass("fa-folder-o"),r.find("i").addClass("fa-folder-open-o"),r.parent().find("ul.nav").remove(),r.after(i);var n=this;this.panel.find(".tree-folder").unbind("click"),this.panel.find(".tree-folder").unbind("dblclick");var d=300,o=0,c=null;this.panel.find(".tree-folder").on("click",function(a){if(o++,1===o){var e=this;c=setTimeout(function(){var a=$(e).attr("fpath");n.panel.find(".current-path").val(a);var l=n.panel.find(".db-list").val();n.getListTreeClick(l,a),n.panel.find(".tree-folder.selected").removeClass("selected"),$(e).addClass("selected"),o=0},d)}else{clearTimeout(c);var l=$(this).attr("fpath"),i=$(this).parent();if(0!=i.find("ul.nav").length&&"none"==i.find("ul.nav").first().css("display")){i.find("ul.nav").first().css("display","block"),$(this).find("i").removeClass("fa-folder-o"),$(this).find("i").addClass("fa-folder-open-o");var t=n.panel.find(".db-list").val();n.getListTreeClick(t,l)}else if(0!=i.find("ul.nav").length&&"block"==i.find("ul.nav").first().css("display")){i.find("ul.nav").first().css("display","none"),$(this).find("i").addClass("fa-folder-o"),$(this).find("i").removeClass("fa-folder-open-o");var t=n.panel.find(".db-list").val();n.getListTreeClick(t,l)}else{n.panel.find(".current-path").val(l);var t=n.panel.find(".db-list").val();n.getList(t,l)}n.panel.find(".tree-folder").removeClass("selected"),$(this).addClass("selected"),o=0}}).on("dblclick",function(a){a.preventDefault()})},showListPanel:function(a){var e=null,l="";this.panel.find(".raster-col").css("display","none"),this.panel.find(".raster-list-col").css("display","block"),this.rasterName=null,this.rasterPath=null,this.raster=null;for(var i=0;i<a.length;++i)if(e=a[i],null!=e)if(this.outputFlag){if(e instanceof GeoBeans.Folder){var t=e.name,s=e.accessTime,r=e.lastTime,n=e.path;l+="<div class='row row-folder' fpath='"+n+"'><div class='col-md-1 row'><div class='col-md-6'>",l+="</div><div class='col-md-6'><i class='fa fa-folder-o'></i></div>",l+="</div><div class='col-md-3 row-fname'>		<span>"+t+"</span></div><div class='col-md-1'>文件夹</div><div class='col-md-3'>"+s+"</div><div class='col-md-3'>"+r+"</div><div class='col-md-1'></div></div>"}else if(e instanceof GeoBeans.File){var t=e.name,s=e.accessTime,r=e.lastTime,d=e.size,n=e.path;l+="<div class='row row-file' fpath='"+n+"'><div class='col-md-1 row'><div class='col-md-6'>",l+="</div><div class='col-md-6'><i class='fa fa-file-o'></i></div>",l+="</div><div class='col-md-3 row-fname'>		<span>"+t+"</span></div><div class='col-md-1'>文件</div><div class='col-md-3'>"+s+"</div><div class='col-md-3'>"+r+"</div><div class='col-md-1'>"+d+"</div></div>"}}else if(e instanceof GeoBeans.File){var t=e.name,s=e.accessTime,r=e.lastTime,d=e.size,n=e.path;l+="<div class='row row-file' fpath='"+n+"'><div class='col-md-1 row'><div class='col-md-6'>",l+=null!=this.source?"	<input type='radio' name='chooseRaster'>":"		<input type='checkbox' name='"+t+"'>",l+="</div><div class='col-md-6'><i class='fa fa-file-o'></i></div>",l+="</div><div class='col-md-3 row-fname'>		<span>"+t+"</span></div><div class='col-md-1'>文件</div><div class='col-md-3'>"+s+"</div><div class='col-md-3'>"+r+"</div><div class='col-md-1'>"+d+"</div></div>"}else if(e instanceof GeoBeans.Folder){var t=e.name,s=e.accessTime,r=e.lastTime,n=e.path;l+="<div class='row row-folder' fpath='"+n+"'><div class='col-md-1 row'><div class='col-md-6'>",l+=null!=this.source?"	<input type='radio' name='chooseRaster' disabled>":"	<input type='checkbox' name='"+t+"'>",l+="</div><div class='col-md-6'><i class='fa fa-folder-o'></i></div>",l+="</div><div class='col-md-3 row-fname'>		<span>"+t+"</span></div><div class='col-md-1'>文件夹</div><div class='col-md-3'>"+(null==s?" ":s)+"</div><div class='col-md-3'>"+(null==r?" ":r)+"</div><div class='col-md-1'></div></div>"}this.panel.find(".raster-list-content-div").html(l);var o=this;this.panel.find(".row-folder .row-fname").click(function(){var a=$(this).parent().attr("fpath");o.panel.find(".tree-folder").removeClass("selected");var e=o.panel.find(".tree-folder[fpath='"+a+"']");e.parents(".nav").first().css("display","block"),e.addClass("selected"),o.panel.find(".current-path").val(a);var l=o.panel.find(".db-list").val();o.getList(l,a)}),this.outputFlag||this.panel.find(".row-file .row-fname").click(function(){var a=o.panel.find(".db-list").val(),e=$(this).find("span").html(),l=o.panel.find(".current-path").val();o.rasterName=e,o.rasterPath=l,o.showRasterTab(a,e,l)})},createFolder:function(){var a=this.panel.find(".db-list").val();return null==a?void MapCloud.notify.showInfo("请选择一个数据源","Warning"):void MapCloud.create_folder_dialog.showDialog("raster")},setCreateFolderName:function(a){var e=this.panel.find(".current-path").val(),l=null;l="/"==e?"/"+a:e+"/"+a;var i=this.panel.find(".db-list").val();this.rasterCreateFolder(i,l)},rasterCreateFolder:function(a,e){return null==a||null==e?void MapCloud.notify.showInfo("参数无效","Warning"):(MapCloud.notify.loading(),void rasterDBManager.createFolder(a,e,this.createFolder_callback))},createFolder_callback:function(a){var e="新建文件夹";MapCloud.notify.showInfo(a,e);var l=MapCloud.raster_db_dialog,i=l.panel.find(".db-list").val(),t=l.panel.find(".current-path").val();l.getList(i,t)},getListRefresh:function(a,e){var a=this.panel.find(".db-list").val();if(null==a)return void MapCloud.notify.showInfo("请选择一个数据源","Warning");var e=this.panel.find(".current-path").val();null==e&&MapCloud.notify.showInfo("请选择刷新的路径","Warning"),MapCloud.notify.loading(),rasterDBManager.getList(a,e,this.getListRefresh_callback)},getListRefresh_callback:function(a){MapCloud.notify.showInfo("Success","刷新成功");var e=MapCloud.raster_db_dialog;e.showListTree(a),e.showListPanel(a)},removeRaster:function(a,e,l){rasterDBManager.removeRaster(a,l,e,this.removeRaster_callback)},removeRaster_callback:function(a){MapCloud.notify.showInfo(a,"删除影像");var e=MapCloud.raster_db_dialog,l=e.panel.find(".db-list").val(),i=e.panel.find(".current-path").val();e.getList(l,i)},removeFolder:function(a,e){rasterDBManager.removeFolder(a,e,this.removeFolder_callback)},removeFolder_callback:function(a){MapCloud.notify.showInfo(a,"删除文件夹");var e=MapCloud.raster_db_dialog,l=e.panel.find(".db-list").val(),i=e.panel.find(".current-path").val();e.panel.find(".tree-folder[fpath='"+i+"']").next().remove(),e.getList(l,i)},showRasterTab:function(a,e,l){this.panel.find(".raster-list-col").css("display","none"),this.panel.find(".raster-col").css("display","block"),this.panel.find(".btn-raster-info").attr("disabled",!0),this.panel.find(".bbtn-raster-preview").attr("disabled",!1);var i="";i="/"==l?"/"+e:l+"/"+e,this.panel.find(".current-raster-path").val(i),this.panel.find(".raster-tab").css("display","none"),rasterDBManager.describeRaster(a,e,l,this.describeRaster_callback)},describeRaster_callback:function(a){var e=MapCloud.raster_db_dialog;e.raster=a,e.showRasterInfo(a)},showRasterInfo:function(a){if(null!=a){var e="";e+="<div class='row'>		<div class='col-md-4'>名称</div>		<div class='col-md-8'>"+a.name+"</div>	</div>	<div class='row'>		<div class='col-md-4'>格式</div>		<div class='col-md-8'>"+a.format+"</div>	</div>	<div class='row'>		<div class='col-md-4'>波段</div>		<div class='col-md-8'>"+a.bands+"</div>	</div>	<div class='row'>		<div class='col-md-4'>空间参考</div>		<div class='col-md-8'>"+a.srid+"</div>	</div>	<div class='row'>		<div class='col-md-4'>宽度</div>		<div class='col-md-8'>"+a.width+"</div>	</div>	<div class='row'>		<div class='col-md-4'>高度</div>		<div class='col-md-8'>"+a.height+"</div>	</div>";var l=a.extent;null!=l&&(e+="	<div class='row'>		<div class='col-md-4'>范围</div>		<div class='col-md-8'>"+l.xmin+","+l.ymin+","+l.xmax+","+l.ymax+"</div>	</div>"),this.panel.find(".raster-info-div").html(e),this.panel.find(".raster-info-div").css("display","block"),this.panel.find(".raster-preview-div").css("display","none")}},showRasterPreview:function(a,e,l){rasterDBManager.getThumbnail(a,l,e,this.getThumbnail_callback)},getThumbnail_callback:function(a){if(null!=a){var e=a.thumb;if(null!=e){var l=MapCloud.raster_db_dialog;l.panel.find(".raster-preview-div img").attr("src",e),l.panel.find(".raster-info-div").css("display","none"),l.panel.find(".raster-preview-div").css("display","table-cell")}}},returnExtractRaster:function(a,e,l){if(null!=this.raster){var i=MapCloud.gps_raster_extract_dialog;i.setRaster(a,e,l,this.raster),this.closeDialog()}else rasterDBManager.describeRaster(a,e,l,this.rasterExtract_callback)},rasterExtract_callback:function(a){var e=MapCloud.raster_db_dialog;if(null!=a){var l=e.panel.find(".db-list").val(),i=e.panel.find(".current-path").val(),t=a.name,s=MapCloud.gps_raster_extract_dialog;s.setRaster(l,t,i,a)}e.closeDialog()},removeDataSource:function(){var a=this.panel.find(".db-list").val();return null==a||""==a?void MapCloud.notify.showInfo("请选择一个数据源","Warning"):void(confirm("确定要删除["+a+"]数据库吗?")&&(this.panel.find(".db-list").html(""),this.panel.find(".nav.foler-ul").remove(),this.panel.find(".raster-list-content-div").empty(),this.panel.find(".current-path").val("/"),this.panel.find(".current-raster-path").val(""),this.panel.find(".raster-col").css("display","none"),this.panel.find(".raster-list-col").css("display","block"),dbsManager.unRegisterDataSource(a,this.unRegisterDataSource_callback)))},unRegisterDataSource_callback:function(a){var e="注销数据源";MapCloud.notify.showInfo(a,e);var l=MapCloud.raster_db_dialog;l.getDataSources()},setRegisterDataSourceName:function(a){this.registerDataSourceName=a}});
...
MapCloud.TrackOverlay=MapCloud.Class({panel:null,controlPanel:null,trackOverlayControl:null,editOverlay:null,initialize:function(l,a){this.panel=$("#"+l),this.controlPanel=$("#"+a);var t=this;this.controlPanel.find("#track_marker").each(function(){$(this).click(function(l){l.preventDefault(),$(this).toggleClass("normal"),t.trackMarker()})}),this.controlPanel.find("#track_polyline").each(function(){$(this).click(function(l){l.preventDefault(),t.trackPolyline()})}),this.controlPanel.find("#track_polygon").each(function(){$(this).click(function(l){l.preventDefault(),t.trackPolygon()})})},show:function(){if(null!=mapObj&&("block"!=this.panel.css("display")||"block"!=this.controlPanel.css("display"))){null==MapCloud.refresh_panel&&(MapCloud.refresh_panel=new MapCloud.refresh("left_panel")),null==this.trackOverlayControl&&(this.trackOverlayControl=new GeoBeans.Control.TrackOverlayControl,mapObj.controls.add(this.trackOverlayControl)),mapObj.registerOverlayEvent(),MapCloud.refresh_panel.hide(),this.panel.css({display:"block",opacity:"0"}).animate({opacity:"1"},1e3),this.controlPanel.css({display:"block",opacity:"0"}).animate({opacity:"1"},1e3);var l=mapObj.getOverlays();this.showOverlaysList(l)}},hide:function(){MapCloud.refresh_panel.show(),this.panel.css("display","none"),this.controlPanel.css("display","none"),mapObj.unregisterOverlayEvent()},trackMarker:function(){this.trackOverlayControl.trackMarker(this.callbackTrackOverlay)},trackPolyline:function(){this.trackOverlayControl.trackLine(this.callbackTrackOverlay)},trackPolygon:function(){this.trackOverlayControl.trackPolygon(this.callbackTrackOverlay)},callbackTrackOverlay:function(l){if(null==l&&null==MapCloud.overlay_panel.editOverlay){var a=mapObj.getOverlays();return void MapCloud.overlay_panel.showOverlaysList(a)}if(null!=l||null==MapCloud.overlay_panel.editOverlay){var t=l.isEdit;t?MapCloud.overlay_panel.showEditOverlay(l):MapCloud.overlay_panel.showHitOverlay(l)}},showEditOverlay:function(l){if(null!=l){this.editOverlay=l;var a="",t=l.name,e=l.type,n=this.getOverlayTypeSpanHtml(e),r=l.kvMap,o=this.getEditOverlayValuesHtml(r);a='<div class="row left_row">	<button type="button" class="btn btn-default col-md-offset-3 btn-cancel">撤销</button>	<button type="button" class="btn btn-primary btn-confirm col-md-offset-1">保存</button></div><div class="row left_row_wrapper left_row_title">	<div class="col-md-3 left_row_title">名称</div></div><div class="row left_row overlay_row">	<div class="input-group">'+n+'	  <input type="text" class="form-control input-overlay-read" id="overlay_edit_name"		 value="'+t+'">	</div></div>	<div class="row left_row_wrapper left_row_title">	<div class="col-md-3 left_row_title">属性</div></div>'+o,this.panel.html(a);var i=this;this.panel.find(".glyphicon-plus").each(function(){$(this).click(function(){var l='<li class="row left_row">	<div class="col-md-4 overlay_key">		<input type="text" class="form-control" placeholder="key" value="">	</div>	<div class="input-group col-md-8 overlay_value">		<input type="text" class="form-control" placeholder="Value" value="">		<span class="input-group-addon glyphicon glyphicon-trash span-overlay-marker"></span>	</div></li>';i.panel.find("#overlay_edit_values_row").append(l),i.panel.find(".glyphicon-trash").each(function(){$(this).click(function(){$(this).parents("li").remove()})})})}),this.panel.find(".glyphicon-trash").each(function(){$(this).click(function(){$(this).parents("li").remove()})}),this.panel.find(".btn-cancel").each(function(){$(this).click(function(){i.editOverlay.endEdit(),i.editOverlay=null;var l=mapObj.getOverlays();i.showOverlaysList(l)})}),this.panel.find(".btn-confirm").each(function(){$(this).click(function(){i.editOverlay.removeKeys();var l=i.panel.find("#overlay_edit_name").val();i.panel.find("#overlay_edit_values_row li").each(function(){var l=$(this).find(".overlay_key input").val(),a=$(this).find(".overlay_value input").val();i.editOverlay.addKeyValue(l,a)}),i.editOverlay.name=l,i.editOverlay.endEdit(),i.editOverlay=null;var a=mapObj.getOverlays();i.showOverlaysList(a)})})}},showHitOverlay:function(l){if(null==this.editOverlay){var a="",t=l.type,e=this.getOverlayTypeSpanHtml(t),n=l.name,r=l.kvMap,o=this.getHitOverlayValuesHtml(r);a+='<div class="row left_row_wrapper left_row_title">	<div class="col-md-3 left_row_title">名称</div></div><div class="row left_row overlay_row">	<div class="input-group">'+e+'	  <input type="text" class="form-control input-overlay-read" 		 value="'+n+'" readonly>	</div></div>	<div class="row left_row_wrapper left_row_title">	<div class="col-md-3 left_row_title">属性</div></div>'+o,this.panel.html(a)}},showOverlaysList:function(l){var a=this,t='<div class="row left_row_wrapper" style="margin-top: 10px">	<button type="button" class="btn btn-default col-md-offset-3 btn-cancel">清空</button>	<button type="button" class="btn btn-primary btn-confirm col-md-offset-1">返回</button></div>';t+='<ul class="row left_row_wrapper" id="overlays_row">';for(var e=0;e<l.length;++e){var n=l[e];if(null!=n){var r=this.showOverlay(n,e);t+=r}}t+="</ul>",this.panel.html(t),this.panel.find("#overlays_row .input-group").mouseover(function(){$(this).find(".input-group-btn").css("display","table-cell")}),this.panel.find("#overlays_row .input-group").mouseout(function(){$(this).find(".input-group-btn").css("display","none")}),this.panel.find(".btn-edit").each(function(){$(this).click(function(){var l=$(this).parents(".overlay_row").attr("value"),t=mapObj.getOverlay(parseInt(l));a.showEditOverlay(t),t.beginEdit(),mapObj.setFitView(t)})}),this.panel.find(".btn-remove").each(function(){$(this).click(function(){var l=$(this).parents(".overlay_row").attr("value");mapObj.removeOverlay(parseInt(l)),mapObj.draw();var t=mapObj.getOverlays();a.showOverlaysList(t)})}),this.panel.find(".btn-confirm").each(function(){$(this).click(function(){a.hide()})}),this.panel.find(".btn-cancel").each(function(){$(this).click(function(){var l=confirm("确定清空标注吗？");if(l){mapObj.clearOverlays(),mapObj.draw();var t=mapObj.getOverlays();a.showOverlaysList(t)}})})},showOverlay:function(l,a){var t="",e=l.name,n=l.type,r=this.getOverlayTypeSpanHtml(n);return t+='<li class="row left_row overlay_row" value="'+a+'">	<div class="input-group">'+r+'	  <input type="text" class="form-control input-overlay-read" 			readonly value="'+e+'">	  <span class="input-group-btn" style="display: none;">	 	 <button class="btn btn-default btn-edit" type="button">编辑</button>	  	 <button class="btn btn-default btn-remove" type="button">删除</button>	  </span>	</div></li>'},getOverlayTypeSpanHtml:function(l){var a="";switch(l){case GeoBeans.Overlay.Type.MARKER:a='<span class="input-group-addon glyphicon glyphicon-map-marker span-overlay-marker"></span>';break;case GeoBeans.Overlay.Type.PLOYLINE:a='<span class="input-group-addon glyphicon glyphicon-align-justify span-overlay-marker"></span>';break;case GeoBeans.Overlay.Type.POLYGON:a='<span class="input-group-addon glyphicon glyphicon-unchecked span-overlay-marker"></span>';break;default:a='<span class="input-group-addon glyphicon glyphicon-globe span-overlay-marker"></span>'}return a},getHitOverlayValuesHtml:function(l){var a='<ul class="row left_row_wrapper" id="overlay_hit_values_row">';for(var t in l){var e=l[t];a+='<li class="row left_row">	<div class="col-md-5 overlay_key">		<input type="text" class="form-control" value="'+t+'" readonly>	</div>	<div class="col-md-7 overlay_value">		<input type="text" class="form-control" value="'+e+'" readonly>	</div></li>'}return a+="</ul>"},getEditOverlayValuesHtml:function(l){var a='<div class="row left_row_wrapper" id="overlay_add_value_row">	 <button type="button" class="btn glyphicon glyphicon-plus 		col-md-4 col-md-offset-4"></button></div><ul class="row left_row_wrapper" id="overlay_edit_values_row">';for(var t in l){var e=l[t];a+='<li class="row left_row">	<div class="col-md-4 overlay_key">		<input type="text" class="form-control" value="'+t+'">	</div>	<div class="input-group col-md-8 overlay_value">		<input type="text" class="form-control" value="'+e+'">		<span class="input-group-addon glyphicon glyphicon-trash span-overlay-marker"></span>	</div></li>'}return a+="</ul>"}});
