...
MapCloud.NewLayerDialog=MapCloud.Class(MapCloud.Dialog,{dataSource:null,dataSet:null,style:null,initialize:function(a){MapCloud.Dialog.prototype.initialize.apply(this,arguments);var l=this;l.panel.find("#new_layer_select_dbs").each(function(){$(this).click(function(){MapCloud.vector_db_dialog.showDialog("select")})}),l.panel.find("#new_layer_select_style").click(function(){if(null==l.dataSet)return void MapCloud.notify.showInfo("请先选择数据源","Warning");var a=l.dataSet.geometryType;return null==a?void MapCloud.notify.showInfo("请选择有效的数据源","Warning"):void MapCloud.style_list_dialog.showDialog(a)}),l.panel.find(".btn-confirm").each(function(){$(this).click(function(){var a=l.panel.find("#new_layer_name").val();if(null==a||""==a)return MapCloud.notify.showInfo("请输入名称","Warning"),void l.panel.find("#new_layer_name").focus();var e=/^[0-9a-zA-Z_]+$/;if(e.test(a)||MapCloud.notify.showInfo("请输入有效的名称","Warning"),null==l.dataSource||null==l.dataSet)return void MapCloud.notify.showInfo("请选择数据","Warning");var n=l.dataSource.name,t=l.dataSet.name;if(null==mapObj)return void MapCloud.notify.showInfo("当前地图为空","Warning");if(null!=mapObj){var o=new GeoBeans.Layer.FeatureDBLayer(a,null,n,t,null,null);MapCloud.notify.loading(),o.geomType=l.dataSet.geometryType,mapObj.insertLayer(o,l.insertLayer_callback)}l.closeDialog()})})},destory:function(){MapCloud.Dialog.prototype.destory.apply(this,arguments)},cleanup:function(){this.panel.find("#new_layer_name").val(""),this.panel.find("#new_layer_dbs").val(""),this.panel.find("#new_layer_style").val(""),this.style=null,this.dataSource=null,this.dataSet=null},setDataSet:function(a,l){if(null!=a&&null!=l){this.dataSource=a,this.dataSet=l;var e="数据源："+a.name+"; 数据："+l.name;this.panel.find("#new_layer_dbs").val(e),this.panel.find("#new_layer_name").val(l.name)}},insertLayer_callback:function(a){var l=MapCloud.new_layer_dialog,e=l.panel.find("#new_layer_name").val(),n="注册图层 [ "+e+" ]";MapCloud.notify.showInfo(a,n),"success"==a.toLowerCase()&&(MapCloud.refresh_panel.refreshPanel(),null!=l.style&&mapObj.setStyle(e,l.style,l.setStyle_callback)),mapObj.draw()},setStyle:function(a){null!=a&&(this.style=a,this.panel.find("#new_layer_style").val(this.style.name))},setStyle_callback:function(a){"success"!=a.toLowerCase()&&MapCloud.notify.showInfo(a,"设置样式"),mapObj.draw()}});
...
MapCloud.PoiDialog=MapCloud.Class(MapCloud.Dialog,{initialize:function(t){MapCloud.Dialog.prototype.initialize.apply(this,arguments);this.registerPageEvent()},registerPageEvent:function(){},cleanup:function(){this.panel.find("table tbody").empty()},showDialog:function(){MapCloud.Dialog.prototype.showDialog.apply(this,arguments)},setPois:function(t){if($.isArray(t)){for(var l=null,i=null,n=null,a=null,o=null,d=null,e="",p=0;p<t.length;++p)l=t[p],null!=l&&(i=l.name,n=l.x,a=l.y,o=l.address,d=l.type,e+="<tr>\t<td>"+(p+1)+"</td>\t<td>"+i+"</td>\t<td>"+o+"</td>\t<td>"+d+"</td>\t<td>"+n+"</td>\t<td>"+a+"</td></tr>");this.panel.find("table tbody").html(e)}}});
...
MapCloud.AQIChartPanel=MapCloud.Class(MapCloud.Panel,{dbName:"base",timeTableName:"gc_aqi_uptime",timeTableTimeField:"uptime",tableName:"gc_aqi",timeField:"time_point",labelField:"position_name",flagField:"station_code",stationCode:null,positionName:null,chartLayer:null,styleMgr:null,initialize:function(e){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent()},registerEvent:function(){var e=this;this.panel.find(".form_datetime").datetimepicker({format:"yyyy-mm-dd",autoclose:!0,minView:"month",maxView:"year",language:"zh-CN"}).on("changeDate",function(a){var i=a.date;if(null!=i){var t=new Date(i);i.getDate();t.setHours(0),t.setMinutes(0),t.setSeconds(0);var l=MapCloud.dateAdd(t,"day",1);l.setHours(0),e.displayTimeList(t,l)}}),this.panel.find(".btn-add-chart").click(function(){if(null!=e.chartLayer){var a=e.chartLayer.name;mapObj.removeLayer(a)}e.addLayer(),MapCloud.refresh_panel.refreshPanel()}),this.panel.find(".btn-cancel").click(function(){e.hidePanel()}),this.panel.find(".panel-header").dblclick(function(){e.panel.css("display","none"),MapCloud.tools.showToolBox("aqiChart")}),this.panel.find(".aqi-style-div").click(function(){e.panel.find(".aqi-style-div").removeClass("selected"),$(this).addClass("selected")})},showPanel:function(){if("none"==this.panel.css("display")){this.cleanup(),this.panel.css("display","block");var e=styleManager.getColorMaps();this.getColorMaps_callback(e)}},hidePanel:function(){MapCloud.Panel.prototype.hidePanel.apply(this,arguments),MapCloud.refresh_panel.refreshPanel()},cleanup:function(){this.chartLayer=null,this.panel.find(".chart-table-name").val("空气质量指数专题图"),this.panel.find(".aqi-time-points").empty(),this.panel.find(".aqi-index option[value='aqi']").attr("selected",!0),this.panel.find(".form_datetime input").val(""),this.panel.find(".aqi-style-div").removeClass("selected")},getColorMaps_callback:function(e){if(null!=e){for(var a=MapCloud.aqi_chart_panel,i=null,t=null,l="",n=0;n<e.length;++n)i=e[n],t=i.url,l+="<li cid='"+i.id+"'>\t<div class='color-ramp-item' style='background-image:url("+t+")' start='"+i.startColor+"' end='"+i.endColor+"'>\t</div></li>";if(a.panel.find(".color-ramp-div ul").html(l),i=e[0],null!=i){t=i.url;var r=i.id,s="<li cid='"+r+"'>\t<div class='color-ramp-item' style='background-image:url("+t+")' start='"+i.startColor+"' end='"+i.endColor+"'>\t</div></li>";a.panel.find(".select-color-ramp").html(s)}a.panel.find(".color-ramp-div ul li").click(function(){var e=$(this).attr("cid"),i=$(this).find("div").attr("start"),t=$(this).find("div").attr("end");a.panel.find(".select-color-ramp li").attr("cid",e);var l=$(this).find(".color-ramp-item").css("background-image");a.panel.find(".select-color-ramp li .color-ramp-item").css("background-image",l),a.panel.find(".select-color-ramp li .color-ramp-item").attr("start",i),a.panel.find(".select-color-ramp li .color-ramp-item").attr("end",t)})}},displayTimeList:function(e,a){if(null!=e&&null!=a){var i="",t=MapCloud.aqi_24h_dialog.toTimeFormat(e),l=MapCloud.aqi_24h_dialog.toTimeFormat(a),n=new GeoBeans.AQITimePointList("tmp",this.dbName,this.timeTableName,this.timeTableTimeField,t,l);n.setMap(mapObj);var r=n.getTimeList();if(null!=r){for(var s=0;s<r.length;++s)i+="<option value='"+r[s]+"'>"+r[s]+"</option>";this.panel.find(".aqi-time-points").html(i)}}},addChart:function(){var e=this.panel.find(".chart-table-name").val();if(null==e||""==e)return void MapCloud.notify.showInfo("请输入名称","Warning");var a=this.panel.find(".aqi-time-points").val();if(null==a)return void MapCloud.notify.showInfo("请选择一个时刻","Warning");var i=this.panel.find(".aqi-index").val(),t=this.panel.find(".select-color-ramp li").attr("cid"),l={colorMapID:t},n=new GeoBeans.Layer.AQIChartLayer(e,this.dbName,this.tableName,i,this.labelField,this.flagField,this.timeField,a,l);mapObj.addLayer(n,this.addLayer_callback)},addLayer_callback:function(e){var a=MapCloud.aqi_chart_panel;if("success"==e){mapObj.draw();var i=a.panel.find(".chart-table-name").val(),t=a.panel.find(".aqi-index").val(),l="{area}[{position_name}] : {"+t+"}";mapObj.registerRippleHitEvent(i,l);var n=a.panel.find(".chart-table-name").val(),r=mapObj.getLayer(n);null!=r&&(a.chartLayer=r)}else MapCloud.notify.showInfo(e,"Error")},changeChartOption:function(){if(null!=this.chartLayer){var e=this.panel.find(".chart-table-name").val();this.chartLayer.setName(e);var a=this.panel.find(".select-color-ramp li").attr("cid"),i={colorMapID:a},t=this.panel.find(".aqi-index").val();this.chartLayer.setChartField(t);var l=this.panel.find(".aqi-time-points").val();if(null==l)return void MapCloud.notify.showInfo("请选择一个时刻","Warning");this.chartLayer.setTimePoint(l),this.chartLayer.setChartOption(i),mapObj.draw()}},addLayer:function(){var e=this.panel.find(".chart-table-name").val();if(null==e||""==e)return void MapCloud.notify.showInfo("请输入名称","Warning");var a=this.panel.find(".aqi-time-points").val();if(null==a)return void MapCloud.notify.showInfo("请选择一个时刻","Warning");var i=this.panel.find(".aqi-index").val();null==i&&MapCloud.notify.showInfo("请选择一个质量指数","Warning");var t=this.panel.find(".select-color-ramp li").attr("cid");if(null==t)return void MapCloud.notify.showInfo("请选择一个色阶","Warning");var l=this.panel.find(".aqi-style-div.selected");if(0==l.length)return void MapCloud.notify.showInfo("请选择一个样式","Warning");var n=l.attr("astyle");switch(n){case"ripple_effect":this.addLayerEffectRipple(e,a,i,t,!0);break;case"ripple":this.addLayerEffectRipple(e,a,i,t,!1);break;case"info":this.addLayerAQIChart(e,a,i,t)}},addLayerEffectRipple:function(e,a,i,t,l){var n=new GeoBeans.BinaryComparisionFilter;n.operator=GeoBeans.ComparisionFilter.OperatorType.ComOprEqual;var r=new GeoBeans.PropertyName;r.setName(this.timeField);var s=new GeoBeans.Literal;s.setValue(a),n.expression1=r,n.expression2=s;var o=this.getRippleLayerOption(i);o.showEffect=l;var d=new GeoBeans.Layer.RippleLayer(e,this.dbName,this.tableName,o,n);mapObj.addLayer(d,this.addLayer_callback);var p=this.panel.find(".select-color-ramp li div"),c=p.attr("start"),h=p.attr("end");d.begin=c,d.end=h},getRippleLayerOption:function(e){var a=this.panel.find(".aqi-index").val(),i=this.getMinMaxValue(a);i.min,i.max;this.minMaxValue=i;var t={scale:5,type:"stroke",alpha:.8,radiusField:e,colorField:e,period:4,radius:function(e){return e/20},color:this.colorFunctionByColorMap};return t},colorFunctionByColorMap:function(e,a){var i=MapCloud.aqi_chart_panel,t=a.begin,l=a.end,n=i.minMaxValue,r=n.min,s=n.max,o=new GeoBeans.Color;o.setByHex(t,1);var d=o.getHsl(),p=new GeoBeans.Color;p.setByHex(l,1);var c=p.getHsl(),h=d.h+(e-r)*(c.h-d.h)/(s-r),f=d.s+(e-r)*(c.s-d.s)/(s-r),m=d.l+(e-r)*(c.l-d.l)/(s-r),u=new GeoBeans.Color;return u.setByHsl(h,f,m),u.getHex()},getMinMaxValue:function(e){var a=0,i=500;switch(e){case"aqi":a=0,i=500;break;case"co":a=0,i=90;break;case"co_24h":a=0,i=90;break;case"no2":a=0,i=100;break;case"no2_24h":a=0,i=100;break;case"o3":a=0,i=200;break;case"o3_24h":a=0,i=200;break;case"o3_8h":a=0,i=200;break;case"o3_8h_24h":a=0,i=200;break;case"pm10":a=0,i=500;break;case"pm10_24":a=0,i=500;break;case"pm2_5":a=0,i=300;break;case"pm_2_5_24h":a=0,i=300;break;case"so2":a=0,i=500;break;case"so2_24h":a=0,i=500;break;default:a=0,i=500}return{min:a,max:i}},addLayerAQIChart:function(e,a,i,t){var l={colorMapID:t,type:"tip"},n=new GeoBeans.Layer.AQIChartLayer(e,this.dbName,this.tableName,i,this.labelField,this.flagField,this.timeField,a,l);mapObj.addLayer(n,this.addLayer_callback)},setChartLayer:function(e){null!=e&&(e instanceof GeoBeans.Layer.AQIChartLayer?this.setAQIChartLayer(e):e instanceof GeoBeans.Layer.RippleLayer&&this.setRippleLayer(e))},setAQIChartLayer:function(e){if(null!=e){this.chartLayer=e;var a=e.name;this.panel.find(".chart-table-name").val(a);var i=e.getTimePoint();this.setTimePoint(i);var t=e.getChartOption();if(null!=t){var l=t.colorMapID;if(null!=l){l=parseInt(l),this.panel.find(".select-color-ramp li").attr("cid",l);var n=this.panel.find(".dropdown-menu li[cid='"+l+"']"),r=n.find(".color-ramp-item").css("background-image");this.panel.find(".select-color-ramp li .color-ramp-item").css("background-image",r)}}var s=e.getChartField();null!=s&&this.panel.find(".aqi-index option[value='"+s+"']").attr("selected",!0),this.panel.find(".aqi-style-div[astyle='info']").addClass("selected")}},setRippleLayer:function(e){if(null!=e){this.chartLayer=e;var a=e.filter,i=null;if(null!=a){var t=a.expression1;t.type==GeoBeans.Expression.Type.Literal&&(i=t.value);var l=a.expression2;l.type==GeoBeans.Expression.Type.Literal&&(i=l.value)}this.setTimePoint(i);var n=e.option,r=n.radiusField;this.panel.find(".aqi-index option[value='"+r+"']").attr("selected",!0);var s=n.showEffect;s?this.panel.find(".aqi-style-div[astyle='ripple_effect']").addClass("selected"):this.panel.find(".aqi-style-div[astyle='ripple']").addClass("selected")}},setTimePoint:function(e){if(null!=e){var a=e.slice(0,10);this.panel.find(".form_datetime input").val(a),this.panel.find(".form_datetime").datetimepicker("update");var i=new Date(a),t=i.getDate(),l=new Date(i),n=new Date(i);l.setHours(0),l.setMinutes(0),l.setSeconds(0),n.setHours(0),n.setMinutes(0),n.setSeconds(0),n.setDate(t+1),this.displayTimeList(l,n),this.panel.find(".aqi-time-points option[value='"+e+"']").attr("selected",!0)}}});
MapCloud.AQITimelineChartPanel=MapCloud.Class(MapCloud.Panel,{dbName:"base",timeTableName:"gc_aqi_uptime",timeTableTimeField:"uptime",tableName:"gc_aqi",timeField:"time_point",labelField:"position_name",flagField:"station_code",styleMgr:null,initialize:function(a){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent()},showPanel:function(){if("none"==this.panel.css("display")){this.cleanup(),this.panel.css("display","block");var a=styleManager.getColorMaps();this.getColorMaps_callback(a)}},cleanup:function(){this.chartLayer=null,this.panel.find(".chart-table-name").val("空气质量指数时间序列图"),this.panel.find(".aqi-start-time-points").empty(),this.panel.find(".aqi-end-time-points").empty(),this.panel.find(".aqi-index option[value='aqi']").attr("selected",!0),this.panel.find(".date input").val(""),this.panel.find(".chart-interval").html("3000")},getColorMaps_callback:function(a){if(null!=a){for(var t=MapCloud.aqi_timeline_chart_panel,i=null,e=null,n="",l=0;l<a.length;++l)i=a[l],e=i.url,n+="<li cid='"+i.id+"'>\t<div class='color-ramp-item' style='background-image:\turl("+e+")'>\t</div></li>";if(t.panel.find(".color-ramp-div ul").html(n),i=a[0],null!=i){e=i.url;var r=i.id,o="<li cid='"+r+"'>\t<div class='color-ramp-item' style='background-image:\turl("+e+")'>\t</div></li>";t.panel.find(".select-color-ramp").html(o)}t.panel.find(".color-ramp-div ul li").click(function(){var a=$(this).attr("cid");t.panel.find(".select-color-ramp li").attr("cid",a);var i=$(this).find(".color-ramp-item").css("background-image");t.panel.find(".select-color-ramp li .color-ramp-item").css("background-image",i)})}},registerEvent:function(){var a=this;this.panel.find(".start_form_datetime").datetimepicker({format:"yyyy-mm-dd",autoclose:!0,minView:"month",maxView:"year",language:"zh-CN"}).on("changeDate",function(t){var i=t.date;if(null!=i){var e=i.getUTCFullYear(),n=i.getUTCMonth(),l=i.getUTCDate(),r=new Date(e+"-"+(n+1)+"-"+l+" 00:00:00"),o=a.panel.find(".aqi-start-time-points"),s=MapCloud.dateAdd(i,"day",1);s.setHours(0),a.displayTimeList(r,s,o)}}),this.panel.find(".end_form_datetime").datetimepicker({format:"yyyy-mm-dd",autoclose:!0,minView:"month",maxView:"year",language:"zh-CN"}).on("changeDate",function(t){var i=t.date;if(null!=i){var e=i.getUTCFullYear(),n=i.getUTCMonth(),l=i.getUTCDate(),r=new Date(e+"-"+(n+1)+"-"+l+" 00:00:00"),o=a.panel.find(".aqi-end-time-points"),s=MapCloud.dateAdd(r,"day",1);s.setHours(0),a.displayTimeList(r,s,o)}}),this.panel.find(".btn-add-chart").click(function(){null==a.chartLayer?a.addChart():a.changeChartOption(),MapCloud.refresh_panel.refreshPanel()}),this.panel.find(".btn-cancel").click(function(){a.hidePanel()}),this.panel.find(".panel-header").dblclick(function(){a.panel.css("display","none"),MapCloud.tools.showToolBox("aqiTimeline")}),this.panel.find(".aqi-style-div").click(function(){a.panel.find(".aqi-style-div").removeClass("selected"),$(this).addClass("selected")})},displayTimeList:function(a,t,i){if(null!=a&&null!=t&&null!=i){var e="",n=MapCloud.dateFormat(a,"yyyy-MM-dd hh:mm:ss"),l=MapCloud.dateFormat(t,"yyyy-MM-dd hh:mm:ss"),r=new GeoBeans.AQITimePointList("tmp",this.dbName,this.timeTableName,this.timeTableTimeField,n,l);r.setMap(mapObj);var o=r.getTimeList();if(null!=o){for(var s=0;s<o.length;++s)e+="<option value='"+o[s]+"'>"+o[s]+"</option>";i.html(e)}}},addChart:function(){var a=this.panel.find(".chart-table-name").val();if(null==a||""==a)return MapCloud.notify.showInfo("请输入名称","Warning"),void this.panel.find(".chart-table-name").focus();var t=this.panel.find(".aqi-start-time-points").val();if(null==t)return void MapCloud.notify.showInfo("请选择一个时刻","Warning");var i=this.panel.find(".aqi-end-time-points").val();if(null==i)return void MapCloud.notify.showInfo("请选择一个时刻","Warning");if(t==i)return void MapCloud.notify.showInfo("请至少选择两个时刻","Warning");var e=this.panel.find(".aqi-index").val(),n=this.panel.find(".select-color-ramp li").attr("cid"),l={colorMapID:n},r=new GeoBeans.AQITimePointList("tmp",this.dbName,this.timeTableName,this.timeTableTimeField,t,i);r.setMap(mapObj);var o=r.getTimeList();if(0==o.length)return void MapCloud.notify.showInfo("请选择一个有效的时间段","Warning");if(o.length>20)return void MapCloud.notify.showInfo("请选择少于20个时间点的时间段","Warning");var s=this.panel.find(".aqi-style-div.selected");if(0==s.length)return void MapCloud.notify.showInfo("请选择一个样式","Warning");var d=s.attr("astyle"),p=null;"point"==d?p="point":"tip"==d&&(p="tip");var n=this.panel.find(".select-color-ramp li").attr("cid"),l={colorMapID:n,type:p},h=this.panel.find(".chart-interval").val();if(h=parseInt(h),!($.isNumeric(h)&&h>0))return void MapCloud.notify.showInfo("请设置一个有效的时间间隔","Warning");var c=new GeoBeans.Layer.AQITimelineLayer(a,this.dbName,this.tableName,e,this.labelField,this.flagField,this.timeField,o,h,l);mapObj.addLayer(c,this.addLayer_callback)},addLayer_callback:function(a){var t=MapCloud.aqi_timeline_chart_panel;if("success"==a){mapObj.draw();var i=t.panel.find(".chart-table-name").val(),e=mapObj.getLayer(i);null!=e&&(t.chartLayer=e)}else MapCloud.notify.showInfo(a,"Error")},changeChartOption:function(){var a=this.panel.find(".chart-table-name").val();this.chartLayer.setName(a);var t=this.panel.find(".aqi-start-time-points").val();if(null==t)return void MapCloud.notify.showInfo("请选择一个时刻","Warning");var i=this.panel.find(".aqi-end-time-points").val();if(null==i)return void MapCloud.notify.showInfo("请选择一个时刻","Warning");if(t==i)return void MapCloud.notify.showInfo("请至少选择两个时刻","Warning");var e=this.chartLayer.getTimePoints();if(null!=e&&e.length>=2){var n=e.length,l=e[0],r=e[n-1];if(l!=t||r!=i){var o=new GeoBeans.AQITimePointList("tmp",this.dbName,this.timeTableName,this.timeTableTimeField,t,i);o.setMap(mapObj);var s=o.getTimeList();if(0==s.length)return void MapCloud.notify.showInfo("请选择一个有效的时间段","Warning");if(s.length>20)return void MapCloud.notify.showInfo("请选择少于20个时间点的时间段","Warning");this.chartLayer.setTimePoints(s)}}var d=this.panel.find(".chart-interval").val();if(d=parseInt(d),!($.isNumeric(d)&&d>0))return void MapCloud.notify.showInfo("请设置一个有效的时间间隔","Warning");this.chartLayer.setInterval(d);var p=this.panel.find(".select-color-ramp li").attr("cid"),h=this.chartLayer.getChartOption().type,c=this.panel.find(".aqi-style-div.selected").attr("astyle");if(this.chartLayer.getChartOption().colorMapID!=p||c!=h){var m={colorMapID:p,type:c};this.chartLayer.setChartOption(m)}var f=this.panel.find(".aqi-index").val();this.chartLayer.getChartField()!=f&&this.chartLayer.setChartField(f),mapObj.draw()},setChartLayer:function(a){if(this.chartLayer=a,null!=this.chartLayer){var t=this.chartLayer.name;this.panel.find(".chart-table-name").val(t);var i=this.chartLayer.getChartOption();if(null!=i){var e=i.colorMapID;if(null!=e){e=parseInt(e),this.panel.find(".select-color-ramp li").attr("cid",e);var n=this.panel.find(".dropdown-menu li[cid='"+e+"']"),l=n.find(".color-ramp-item").css("background-image");this.panel.find(".select-color-ramp li .color-ramp-item").css("background-image",l)}}var r=this.chartLayer.getChartField();null!=r&&this.panel.find(".aqi-index option[value='"+r+"']").attr("selected",!0);var o=this.chartLayer.getTimePoints();if(null!=o&&o.length>=2){var s=o.length,d=o[0],p=o[s-1],h=d.slice(0,10);this.panel.find(".start_form_datetime input").val(h),this.panel.find(".start_form_datetime").datetimepicker("update");var c=new Date(h),m=c.getUTCFullYear(),f=c.getUTCMonth(),u=c.getUTCDate(),v=new Date(m+"-"+(f+1)+"-"+u+" 00:00:00"),y=new Date(m+"-"+(f+1)+"-"+(u+1)+" 00:00:00"),g=this.panel.find(".aqi-start-time-points");this.displayTimeList(v,y,g),this.panel.find(".aqi-start-time-points option[value='"+d+"']").attr("selected",!0);var C=p.slice(0,10);this.panel.find(".end_form_datetime input").val(C),this.panel.find(".end_form_datetime").datetimepicker("update");var M=new Date(h),b=M.getUTCFullYear(),T=M.getUTCMonth(),L=M.getUTCDate(),w=new Date(b+"-"+(T+1)+"-"+L+" 00:00:00"),I=new Date(b+"-"+(T+1)+"-"+(L+1)+" 00:00:00"),_=this.panel.find(".aqi-end-time-points");this.displayTimeList(w,I,_),this.panel.find(".aqi-end-time-points option[value='"+p+"']").attr("selected",!0)}var q=this.chartLayer.getInterval();this.panel.find(".chart-interval").val(q)}}});
MapCloud.BarChartPanel=MapCloud.Class(MapCloud.Panel,{chartLayer:null,dbName:null,tableName:null,chartFields:null,initialize:function(a){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerEvent()},showPanel:function(){if("none"==this.panel.css("display")){this.cleanup(),this.panel.css("display","block"),this.panel.find(".panel-collapse:not(:eq(0))").each(function(){$(this).hasClass("in")&&$(this).collapse("hide")});var a=this.panel.find(".panel-collapse").first();a.hasClass("in")||a.collapse("show"),this.showLayerTab()}},hidePanel:function(){MapCloud.Panel.prototype.hidePanel.apply(this,arguments),MapCloud.refresh_panel.refreshPanel()},cleanup:function(){this.chartLayer=null,this.chartFields=[],this.dbName=null,this.tableName=null,this.panel.find(".form-group-field").remove(),this.panel.find(".chart-table").val(""),this.panel.find(".chart-table-fields").empty(),this.panel.find(".chart-base-layer").empty(),this.panel.find(".chart-base-layer-fields").empty(),this.panel.find(".chart-table-name").val("柱状图"),this.panel.find(".chart-table-radius").val("100"),this.panel.find(".chart-table-offset-x").val("0"),this.panel.find(".chart-table-offset-y").val("0"),this.panel.find(".chart-table-show-label").prop("checked",!1),this.panel.find(".chart-fields").empty(),this.panel.find("input.slider").slider("setValue",100),this.panel.find(".chart-opacity").html("1")},registerEvent:function(){var a=this;this.panel.find('[data-toggle="tooltip"]').tooltip(),this.panel.find(".btn-chose-chart").click(function(){MapCloud.vector_db_dialog.showDialog("bar")}),this.panel.find(".chart-base-layer").change(function(){var t=$(this).val();a.showFields(),null!=a.chartLayer&&a.chartLayer.setBaseLayer(t)}),this.panel.find(".chart-base-layer-fields").change(function(){var t=$(this).val();null!=a.chartLayer&&a.chartLayer.setBaseLayerField(t)}),this.panel.find(".chart-table-fields").change(function(){var t=$(this).val();null!=a.chartLayer&&a.chartLayer.setTableField(t)}),this.panel.find(".btn-add-chart").click(function(){null==a.chartLayer?a.addChart():a.changeChartOption(),MapCloud.refresh_panel.refreshPanel()}),this.panel.find(".btn-cancel").click(function(){a.hidePanel()}),this.panel.find(".slider").each(function(){$(this).slider({tooltip:"hide"}),$(this).on("slide",function(t){var e=t.value;a.panel.find(".chart-opacity").html(e/100),a.changeOpacity(e/100),a.changeDisplayOpacity()})}),this.panel.find(".panel-header").dblclick(function(){a.panel.css("display","none"),MapCloud.tools.showToolBox("barChart")})},setDataSet:function(a,t){this.dbName=a,this.tableName=t,this.panel.find(".chart-table").val(this.tableName),this.showTableFields(this.dbName,this.tableName),null!=this.chartLayer&&(this.chartLayer.setDbName(this.dbName),this.chartLayer.setTableName(this.tableName))},showTableFields:function(a,t){var e=new GeoBeans.WFSWorkspace("tmp",mapObj.server,"1.0.0"),l=new GeoBeans.FeatureType(e,t),i=l.getFields(null,a);if(null!=i){for(var n=null,h=null,r="",s=0;s<i.length;++s)n=i[s],null!=n&&(h=n.name,r+="<option value='"+h+"'>"+h+"</option>");this.panel.find(".chart-table-fields").html(r),this.showChartFields(i)}},showChartFields:function(a){for(var t=null,e=null,l="<list-group>",i=0;i<a.length;++i)t=a[i],null!=t&&(e=t.name,l+="<a href='#' class='list-group-item'>"+e+"<input type='checkbox' value='"+e+"'></a>");this.panel.find(".chart-fields").html(l);var n=this,h=this.panel.find(".chart-fields .list-group-item input[type='checkbox']");h.change(function(){var a=$(this).val(),t=$(this).prop("checked");t?n.addChartField(a):n.removeChartField(a),n.displayChartFields()})},showLayerTab:function(){if(null!=mapObj){for(var a=mapObj.getLayers(),t=null,e="",l=null,i=0;i<a.length;++i)t=a[i],null!=t&&t instanceof GeoBeans.Layer.DBLayer&&t.geomType==GeoBeans.Geometry.Type.POINT&&(l=t.name,e+="<option value='"+l+"'>"+l+"</option>");this.panel.find(".chart-base-layer").html(e);var n=this.panel.find(".chart-base-layer").val();this.showFields(n)}},showFields:function(a){var t=mapObj.getLayer(a);if(null!=t){var e=t.getFields();if(null!=e){for(var l=null,i=null,n="",h=0;h<e.length;++h)l=e[h],null!=l&&(i=l.name,n+="<option value ='"+i+"'>"+i+"</option>");this.panel.find(".chart-base-layer-fields").html(n)}}},addChartField:function(a){if(null!=a){var t=new GeoBeans.Color,e=this.panel.find(".chart-opacity").html();t.setOpacity(parseFloat(e));var l={name:a,color:t};this.chartFields.push(l)}},removeChartField:function(a){if(null!=a)for(var t=null,e=null,l=0;l<this.chartFields.length;++l)t=this.chartFields[l],null!=t&&(e=t.name,e==a&&this.chartFields.splice(l,1))},getChartField:function(a){if(null==a)return null;for(var t=null,e=0;e<this.chartFields.length;++e)if(t=this.chartFields[e],null!=t&&t.name==a)return t;return null},changeChartFieldColor:function(a,t){if(null!=a)for(var e=$(a).parents(".form-group-field"),l=e.attr("fname"),i=null,n=0;n<this.chartFields.length;++n)i=this.chartFields[n],null!=i&&i.name==l&&(i.color=t)},changeOpacity:function(a){if(null!=a)for(var t=null,e=0;e<this.chartFields.length;++e)if(t=this.chartFields[e],null!=t){var l=t.color;null!=l&&l.setOpacity(a)}},changeDisplayOpacity:function(){var a=this;this.panel.find(".colorSelector").each(function(){var t=$(this).parents(".form-group-field"),e=t.attr("fname"),l=a.getChartField(e);if(null!=l){var i=l.color;$(this).find("div").css("background-color",i.getRgba())}})},displayChartFields:function(){for(var a=null,t=null,e="",l=0;l<this.chartFields.length;++l)a=this.chartFields[l],null!=a&&(t=a.name,e+="<div class='form-group form-group-sm form-group-field' fname='"+t+"'>\t<div class='col-md-1 col-xs-1 col-md-offset-3 col-xs-offset-3'>\t\t<div class='btn btn-default colorSelector'>\t\t\t<div></div>\t\t</div>\t</div>\t<div class='col-md-6 col-xs-6'>\t\t<span>"+t+"\t\t</span>\t</div></div>");this.panel.find(".form-group-field").remove(),this.panel.find("#bar_chart_table_style_coll .panel-body .form-horizontal").append(e);var i=this;this.panel.find(".colorSelector").each(function(){$(this).colpick({color:"EEEEEE",onChange:function(a,t,e,l,n){var h=i.panel.find(".chart-opacity").html(),r=new GeoBeans.Color;r.setByHex("#"+t,parseFloat(h)),$(l).children().css("background-color",r.getRgba()),i.changeChartFieldColor(l,r)},onSubmit:function(a,t,e,l,n){var h=i.panel.find(".chart-opacity").html(),r=new GeoBeans.Color;r.setByHex("#"+t,parseFloat(h)),$(l).children().css("background-color",r.getRgba()),i.changeChartFieldColor(l,r),$(l).colpickHide()}});for(var a=$(this).parents(".form-group-field"),t=a.attr("fname"),e=null,l=null,n=0;n<i.chartFields.length;++n)e=i.chartFields[n],null!=e&&e.name==t&&(l=e.color);if(null!=l){var h=l.getHex();$(this).colpickSetColor(h);var r=l.getRgba();$(this).find("div").css("background-color",r)}})},getChartOption:function(){for(var a=this.panel.find(".chart-table-height").val(),t=this.panel.find(".chart-table-width").val(),e=this.panel.find(".chart-table-offset-x").val(),l=this.panel.find(".chart-table-offset-y").val(),i=this.panel.find(".chart-table-top").val(),n=this.panel.find(".chart-table-bottom").val(),h=this.panel.find(".chart-table-left").val(),r=this.panel.find(".chart-table-right").val(),s=this.panel.find(".chart-table-x-axisLine").prop("checked"),o=this.panel.find(".chart-table-x-splitLine").prop("checked"),c=this.panel.find(".chart-table-y-axisLine").prop("checked"),d=this.panel.find(".chart-table-y-splitLine").prop("checked"),p=[],f=null,u=null,b=0;b<this.chartFields.length;++b)u=this.chartFields[b],null!=u&&(f=u.color,null!=f&&p.push(f.getHex()));var v=this.panel.find(".chart-opacity").html(),y=this.panel.find(".chart-table-show-label").prop("checked"),m={height:parseFloat(a),width:parseFloat(t),colors:p,offsetX:parseFloat(e),offsetY:parseFloat(l),left:parseFloat(h),right:parseFloat(r),top:parseFloat(i),bottom:parseFloat(n),showLabel:y,opacity:parseFloat(v),x_axisLine:s,x_splitLine:o,y_axisLine:c,y_splitLine:d};return m},getChartFields:function(){for(var a=[],t=null,e=0;e<this.chartFields.length;++e)t=this.chartFields[e],null!=t&&a.push(t.name);return a},addChart:function(){if(null==mapObj)return void MapCloud.notify.showInfo("当前地图为空","Warning");var a=this.panel.find(".chart-table-name").val();if(""==a)return MapCloud.notify.showInfo("请输入专题图名称","Warning"),void this.panel.find(".chart-table-name").focus();var t=this.panel.find(".chart-base-layer").val();if(null==t||""==t)return void MapCloud.notify.showInfo("请选择底图","Warning");var e=this.panel.find(".chart-base-layer-fields").val();if(null==e||""==e)return void MapCloud.notify.showInfo("请选择空间字段","Warning");var l=this.dbName,i=this.tableName;if(null==l||null==i)return void MapCloud.notify.showInfo("请设置表格","Warning");var n=this.panel.find(".chart-table-fields").val();if(null==n||""==n)return void MapCloud.notify.showInfo("请设置关联字段","Warning");var h=this.getChartFields();if(null==h||0==h.length)return void MapCloud.notify.showInfo("请选择专题图字段","Warning");var r=this.getChartOption(),s=new GeoBeans.Layer.BarChartLayer(a,t,e,l,i,n,h,r);mapObj.addLayer(s,this.addChartLayer_callback)},addChartLayer_callback:function(a){if("success"==a){mapObj.draw();var t=MapCloud.bar_chart_panel,e=t.panel.find(".chart-table-name").val();t.chartLayer=mapObj.getLayer(e)}else MapCloud.notify.showInfo(a,"添加柱状图")},changeChartOption:function(){if(null!=this.chartLayer){var a=this.panel.find(".chart-table-name").val();if(null==a||""==a)return MapCloud.notify.showInfo("请输入专题图名称","Warning"),void this.panel.find(".chart-table-name").focus();var t=this.getChartOption(),e=this.getChartFields();this.chartLayer.setChartFields(e),this.chartLayer.setChartOption(t),this.chartLayer.setName(a),mapObj.draw()}},setChartLayer:function(a){if(this.chartLayer=a,null!=this.chartLayer){var t=this.chartLayer.name;this.panel.find(".chart-table-name").val(t);var e=this.chartLayer.getBaseLayer(),l=this.chartLayer.getBaseLayerField(),i=this.chartLayer.getDbName(),n=this.chartLayer.getTableName(),h=this.chartLayer.getTableField();this.dbName=i,this.tableName=n,this.panel.find(".chart-table").val(this.tableName),this.showTableFields(this.dbName,this.tableName),this.panel.find(".chart-table-fields option[value='"+h+"']").attr("selected",!0),this.panel.find(".chart-base-layer option[value='"+e+"']").attr("selected",!0),this.panel.find(".chart-base-layer-fields option[value='"+l+"']").attr("selected",!0);for(var r=this.chartLayer.getChartFields(),s=null,o=0;o<r.length;++o)s=r[o],this.panel.find(".list-group-item input[value='"+s+"']").attr("checked",!0);var c=this.chartLayer.getChartOption();if(null!=c){var d=c.height,p=c.width,f=c.colors,u=c.offsetX,b=c.offsetY,v=c.left,y=c.right,m=c.top,g=c.bottom,F=c.showLabel,L=c.opacity,C=c.x_axisLine,x=c.x_axisLabel,w=c.x_axisTick,k=c.x_splitLine,N=c.y_axisLine,_=c.y_axisLabel,O=c.y_axisTick,B=c.y_splitLine;this.panel.find(".chart-table-height").val(d),this.panel.find(".chart-table-width").val(p),this.panel.find(".chart-table-offset-x").val(u),this.panel.find(".chart-table-offset-y").val(b),this.panel.find(".chart-table-top").val(m),this.panel.find(".chart-table-bottom").val(g),this.panel.find(".chart-table-left").val(v),this.panel.find(".chart-table-right").val(y),this.panel.find(".chart-table-x-axisLine").prop("checked",C),this.panel.find(".chart-table-x-axisLabel").prop("checked",x),this.panel.find(".chart-table-x-axisTick").prop("checked",w),this.panel.find(".chart-table-x-splitLine").prop("checked",k),this.panel.find(".chart-table-y-axisLine").prop("checked",N),this.panel.find(".chart-table-y-axisLabel").prop("checked",_),this.panel.find(".chart-table-y-axisTick").prop("checked",O),this.panel.find(".chart-table-y-splitLine").prop("checked",B),this.panel.find(".chart-table-show-label").prop("checked",F),this.panel.find(".chart-opacity").html(L),this.panel.find("input.slider").slider("setValue",100*L);var M=null,$=null,s=null,T=null;this.chartFields=[];for(var o=0;o<r.length;++o)s=r[o],$=f[o],T=new GeoBeans.Color,T.setByHex($,L),M={name:s,color:T},this.chartFields.push(M);this.displayChartFields()}}}});
...
MapCloud.refresh=MapCloud.Class({panel:null,layerID:null,mapLayerID:null,styleID:null,layerName:null,getStyleLayerName:null,initialize:function(a){this.panel=$("#"+a),this.registerEvent()},registerEvent:function(){var a=this;this.panel.find('[data-toggle="tooltip"]').tooltip({container:"body"}),this.panel.find(".glyphicon-plus").click(function(){MapCloud.new_layer_dialog.showDialog()}),this.panel.find(".glyphicon-minus").click(function(){if(0==$("#layers_row .layer_row.layer_row_selected").length)return void MapCloud.notify.showInfo("请选择图层","Warning");var a=$("#layers_row .layer_row.layer_row_selected").attr("lname");null!=a&&confirm("你确定要删除图层吗？")&&mapObj.removeLayer(a,MapCloud.refresh_panel.removeLayer_callback)}),this.panel.find("#layers_content_btn").click(function(){"none"==$("#layers_content").css("display")?$("#layers_content").slideDown():$("#layers_content").slideUp()}),this.panel.find("#create_service_btn").click(function(){a.createService()}),this.panel.find("#cut_map_btn").click(function(){return null==mapObj?void MapCloud.notify.showInfo("当前地图为空","Warning"):void MapCloud.cut_map_dialog.showDialog()}),this.panel.find("#map_globe_btn").click(function(){return null==mapObj?void MapCloud.notify.showInfo("当前地图为空","Warning"):void mapManager.zoomToGlobeMap(mapObj,a.zoomToGlobeMap_callback)}),this.panel.find("#save_map_btn").click(function(){return null==mapObj?void MapCloud.notify.showInfo("当前地图为空","Warning"):void mapManager.saveMap(mapObj,a.saveMap_callback)}),this.panel.find("#refresh_map_btn").click(function(){return null==mapObj?void MapCloud.notify.showInfo("当前地图为空","Warning"):void mapManager.refreshMap(mapObj,a.refreshMap_callback)})},cleanup:function(){this.panel.find("#map_name").html("Map Name"),this.panel.find("#layers_row").empty(),this.panel.find("#baseLayer_row").empty()},hide:function(){this.panel.css("display","none")},show:function(){this.panel.css({display:"block",opacity:"0"}).animate({opacity:"1"},1e3)},refreshPanel:function(){if(this.panel.find("#layers_row").empty(),null!=mapObj){var a=mapObj.name;this.panel.find("#map_name").html(a);var t="",l=mapObj.baseLayer;if(null!=l){var e=this.getBaseLayerHtml(l);$("#baseLayer_row").html(e),$("#baseLayer_row").css("padding","6px 0px"),$("#baseLayer_row").removeClass("sm")}else $("#baseLayer_row").empty();for(var i=mapObj.getLayers(),o=this,s=0;s<i.length;++s){var r=i[s];null!=r&&(r instanceof GeoBeans.Layer.WFSLayer?t+=this.getWFSLayerHtml(s,r):r instanceof GeoBeans.Layer.WMSLayer?t+=this.getWMSLayerHtml(s,r):r instanceof GeoBeans.Layer.DBLayer?t+=this.getDBLayerHtml(s,r):r instanceof GeoBeans.Layer.ChartLayer?t+=this.getChartLayerHtml(s,r):r instanceof GeoBeans.Layer.ClusterLayer?t+=this.getClusterLayer(s,r):r instanceof GeoBeans.Layer.RippleLayer?t+=this.getRippleLayer(s,r):r instanceof GeoBeans.Layer.AirLineLayer&&(t+=this.getAirlineLayer(s,r)))}$("#layers_row").html(t);var n=$(".layers-items").css("height");n=parseInt(n.slice(0,n.lastIndexOf("px"))),n<600?$(".layers-items").css("overflow-y","visible"):$(".layers-items").css("overflow-y","auto"),this.panel.find(".glyphicon-chevron-right").click(function(){var a=$(this).parents(".layer_row").first(),t=a.attr("lname"),l=mapObj.getLayer(t);if(null!=l){if(l instanceof GeoBeans.Layer.WMSLayer)return void($(this).hasClass("mc-icon-right")?($(a).find(".wms_layer_row").slideDown(),$(this).removeClass("mc-icon-right"),$(this).addClass("mc-icon-down"),$(this).css("transform","rotate(90deg) translate(3px,0px)")):($(a).find(".wms_layer_row").slideUp(),$(this).css("transform","rotate(0deg) translate(0px,0px)"),$(this).addClass("mc-icon-right"),$(this).removeClass("mc-icon-down")));if(l instanceof GeoBeans.Layer.WFSLayer)if($(this).hasClass("mc-icon-right")){if(0==a.find(".row").length){var e=l.style;if(null!=e){var i=o.getStyleHtml(-1,e);a.append(i),o.registerStyleSymbolClickEvent()}}else $(a).find(".row").slideDown();$(this).removeClass("mc-icon-right"),$(this).addClass("mc-icon-down"),$(this).css("transform","rotate(90deg) translate(3px,0px)")}else $(a).find(".row").slideUp(),$(this).css("transform","rotate(0deg) translate(0px,0px)"),$(this).addClass("mc-icon-right"),$(this).removeClass("mc-icon-down");else if(l.type==GeoBeans.Layer.DBLayer.Type.Feature){var e=l.style;if($(this).hasClass("mc-icon-right")){if(0==a.find(".row").length){var s=l.styleName;MapCloud.notify.loading(),o.getStyleLayerName=l.name,styleManager.getStyleXML(s,o.getStyleXML_callback)}else a.find(".row").slideDown();$(this).removeClass("mc-icon-right"),$(this).addClass("mc-icon-down"),$(this).css("transform","rotate(90deg) translate(3px,0px)")}else $(this).css("transform","rotate(0deg) translate(0px,0px)"),$(this).addClass("mc-icon-right"),$(this).removeClass("mc-icon-down"),a.find(".row").slideUp()}}}),this.registerStyleSymbolClickEvent(),this.registerSymbolIconClickEvent(),this.panel.find(".glyphicon-eye-open,.glyphicon-eye-close").each(function(){$(this).click(function(){if("baseLayer_row"==$(this).parents(".row").attr("id"))return void($(this).hasClass("glyphicon-eye-open")?($(this).removeClass("glyphicon-eye-open"),$(this).addClass("glyphicon-eye-close"),mapObj.baseLayer.setVisiable(!1),mapObj.draw()):($(this).removeClass("glyphicon-eye-close"),$(this).addClass("glyphicon-eye-open"),mapObj.baseLayer.setVisiable(!0),mapObj.draw()));var a=$(this).parents("li"),t=a.attr("lname"),l=mapObj.getLayer(t);if(null!=l){var e=$(this).parents(".wms_layer_row").attr("mname");null!=e&&(l=l.getMapLayer(e)),null!=l&&($(this).hasClass("glyphicon-eye-open")?($(this).removeClass("glyphicon-eye-open"),$(this).addClass("glyphicon-eye-close"),l.setVisiable(!1),mapObj.draw()):($(this).removeClass("glyphicon-eye-close"),$(this).addClass("glyphicon-eye-open"),l.setVisiable(!0),mapObj.draw()))}})}),this.panel.find(".layer_name").each(function(){$(this).click(function(){var a=$(".layer_row_selected").attr("lname");$(".layer_row").removeClass("layer_row_selected"),$("#baseLayer_row").removeClass("layer_row_selected");var t=$(this).parent();t.addClass("layer_row_selected");var l=t.attr("lname");o.registerAQILayerHitEvent(a,l),MapCloud.mapBar.returnEndQuery()})}),this.panel.find(".layer_row_quick_tool_zoom").each(function(){$(this).click(function(){if("baseLayer_row"==$(this).parents(".row").attr("id"))mapObj.zoomToBaseLayer();else{var a=$(this).parents("li.layer_row"),t=a.attr("lname");mapObj.zoomToLayer(t)}})}),this.panel.find(".layer_row_quick_tool_layer_info").click(function(){var a=$(this).parents("li.layer_row"),t=a.attr("lname");null!=t&&MapCloud.layer_info_dialog.showDialog(t)}),this.panel.find(".layer_row_quick_tool_features").click(function(){var a=$(this).parents("li.layer_row"),t=a.attr("lname");null!=t&&(MapCloud.features_dialog.setLayerName(t),MapCloud.features_dialog.showDialog())}),this.panel.find(".layer_row_quick_tool_search").click(function(){var a=$(this).parents("li.layer_row"),t=a.attr("lname");if(null!=t){var l=mapObj.getLayer(t);null!=l&&MapCloud.search_panel.showPanel(l)}}),this.panel.find(".layer_row_quick_tool_edit").each(function(){$(this).click(function(){})}),this.panel.find(".layer_row_quick_tool_share").each(function(){$(this).click(function(){alert("share")})}),this.panel.find(".layer_row_quick_tool_remove").each(function(){$(this).click(function(){var a=$(this).parents("li.layer_row"),t=a.attr("lname");confirm("确定删除图层["+t+"]?")&&mapObj.removeLayer(t,o.removeLayer_callback)})}),this.panel.find(".layer_row_quick_tool_heatMap span").each(function(){$(this).click(function(){var a=($(this).prop("checked"),$(this).parents("li.layer_row")),t=a.attr("lname"),l=mapObj.getLayer(t);null!=l&&(MapCloud.heatMap_dialog.showDialog(),MapCloud.heatMap_dialog.setLayer(l))})}),this.panel.find(".layer_row_quick_tool_heatMap input").each(function(){$(this).change(function(){var a=$(this).prop("checked"),t=$(this).parents("li.layer_row"),l=t.attr("lname"),e=mapObj.getLayer(l);if(null!=e){var i=e.getHeatMapLayer();if(null==i)return MapCloud.heatMap_dialog.showDialog(),void MapCloud.heatMap_dialog.setLayer(e);mapObj.setHeatMapVisible(l,a),mapObj.draw()}})}),this.panel.find(".layer_row_quick_tool_stretch input").each(function(){$(this).change(function(){var a=$(this).prop("checked"),t=$(this).parents("li.layer_row"),l=t.attr("lname"),e=mapObj.getLayer(l);null!=e&&MapCloud.notify.showInfo(a.toString(),"影像拉伸")})}),this.panel.find(".layer_row_quick_tool_remove_base").each(function(){$(this).click(function(){confirm("确定要删除底图吗？")&&mapObj.unRegisterBaseLayer(o.removeBaseLayer_callback)})}),this.panel.find(".layer_row .layer_oper").click(function(){var a=$(this).parents("li"),t=a.attr("lname"),l=mapObj.getLayer(t);null!=l&&($(this).hasClass("fa-arrow-up")?l.up(o.layerOper_callback):$(this).hasClass("fa-arrow-down")&&l.down(o.layerOper_callback))}),this.panel.find(".mc-icon-wmslayer").each(function(){$(this).click(function(){})}),this.panel.find(".mc-icon-wfslayer").each(function(){$(this).click(function(){var a=$(this).parents("li"),t=a.attr("lname"),l=mapObj.getLayer(t);if(null!=l){var e=l.style;null!=e&&(MapCloud.styleManager_dialog.showDialog(!1),MapCloud.styleManager_dialog.setWFSLayer(l))}})}),this.panel.find(".mc-icon-dblayer").each(function(){$(this).click(function(){var a=$(this).parents("li"),t=a.attr("lname"),l=mapObj.getLayer(t);null!=l&&l.type==GeoBeans.Layer.DBLayer.Type.Feature&&(MapCloud.styleManager_dialog.showDialog(!1),MapCloud.styleManager_dialog.setDBLayer(l))})}),this.panel.find(".mc-icon-chartlayer").click(function(){var a=$(this).parents("li"),t=a.attr("lname"),l=mapObj.getLayer(t);if(null!=l){var e=l.type;switch(e){case GeoBeans.Layer.ChartLayer.Type.RANGE:MapCloud.chart_panel.showPanel(),MapCloud.chart_panel.setChartLayer(l);break;case GeoBeans.Layer.ChartLayer.Type.BAR:MapCloud.bar_chart_panel.showPanel(),MapCloud.bar_chart_panel.setChartLayer(l);break;case GeoBeans.Layer.ChartLayer.Type.PIE:MapCloud.pie_chart_panel.showPanel(),MapCloud.pie_chart_panel.setChartLareyer(l);break;case GeoBeans.Layer.ChartLayer.Type.SYMBOL:MapCloud.symbol_chart_panel.showPanel(),MapCloud.symbol_chart_panel.setChartLayer(l);break;case GeoBeans.Layer.ChartLayer.Type.RANGESYMBOL:MapCloud.range_symbol_chart_panel.showPanel(),MapCloud.range_symbol_chart_panel.setChartLayer(l);break;case GeoBeans.Layer.ChartLayer.Type.AQI:MapCloud.aqi_chart_panel.showPanel(),MapCloud.aqi_chart_panel.setChartLayer(l);break;case GeoBeans.Layer.ChartLayer.Type.AQITIMELINE:MapCloud.aqi_timeline_chart_panel.showPanel(),MapCloud.aqi_timeline_chart_panel.setChartLayer(l)}}}),this.panel.find(".mc-icon-cluster-layer").click(function(){var a=$(this).parents("li"),t=a.attr("lname"),l=mapObj.getLayer(t);null!=l&&(MapCloud.cluster_chart_panel.showPanel(),MapCloud.cluster_chart_panel.setLayer(l))}),this.panel.find(".mc-icon-ripple-layer").click(function(){var a=$(this).parents("li"),t=a.attr("lname"),l=mapObj.getLayer(t);null!=l&&(MapCloud.aqi_chart_panel.showPanel(),MapCloud.aqi_chart_panel.setChartLayer(l))}),this.panel.find(".mc-icon-airline-layer").click(function(){var a=$(this).parents("li"),t=a.attr("lname"),l=mapObj.getLayer(t);null!=l&&(MapCloud.airline_panel.showPanel(),MapCloud.airline_panel.setLayer(l))})}},registerStyleSymbolClickEvent:function(){var a=this;this.panel.find(".style-symbol").each(function(){$(this).click(function(){var t=$(this).parents(".layer_row"),l=t.attr("lname"),e=mapObj.getLayer(l);if(null!=e){var i=e.style;if(null!=i){var o=i.rules;if(null!=o){var s=$(this).parents(".layer_style_row"),r=s.first().attr("sID"),n=o[r];if(null!=n){var c=null;if(e instanceof GeoBeans.Layer.DBLayer){var d=new GeoBeans.WFSWorkspace("tmp",mapObj.server,"1.0.0"),p=new GeoBeans.FeatureType(d,e.name);c=p.getFields(mapObj.name)}else e instanceof GeoBeans.Layer.WFSLayer&&(c=e.featureType.getFields());null!=c&&(a.layerName=l,a.styleID=r,MapCloud.style_dialog.showDialog(),MapCloud.style_dialog.setRule(n,c,"refresh"))}}}}})})},registerSymbolIconClickEvent:function(){var a=this;this.panel.find(".symbol-icon").click(function(){var t=$(this).parents(".layer_row"),l=t.attr("lname"),e=mapObj.getLayer(l);if(null!=e&&!(e instanceof GeoBeans.Layer.WFSLayer)){var i=e.style;if(null!=i){var o=i.rules;if(null!=o){var s=$(this).parents(".layer_style_row"),r=s.first().attr("sID"),n=o[r];if(null!=n){var c=n.symbolizer;if(null!=c){var d=c.symbol;a.layerName=l,a.styleID=r;var p=MapCloud.styleManager_dialog.getSymbolIconType(c.type),y=null;null!=d&&(y=d.name),MapCloud.symbol_dialog.showDialog("refresh",p,y)}}}}}})},createSymbolizerIcon:function(a,t){if(null==a||null==t)return null;var l="",e=t.toLowerCase();switch(e){case"point":case"multipolygon":case"polygon":var i=a.fillColor,o=a.outLineColor;l="background-color:"+i+";border:1px solid "+o+";";break;case"multilinestring":case"linestring":var s=a.color;l="background-color:"+s}return l},getTextSymbolizerIndexByFilter:function(a,t){for(var l=0;l<t.length;++l){var e=t[l],i=e.symbolizer;if(i instanceof GeoBeans.Style.TextSymbolizer){var o=e.filter;if(null==o&&null==a)return l;if(null!=o&&null!=a&&o.field==a.field&&o.value==a.value)return l}}return-1},setSymoblizerCallback:function(a,t,l,e){null==MapCloud.refresh_panel&&(MapCloud.refresh_panel=new MapCloud.refresh("left_panel"));var i=mapObj.layers[e];if(null!=i){var o=i.style;if(null!=o){var s=o.rules;if(null!=s){var r=s[l];if(null!=r){s[l].symbolizer=a;var n=s[l].filter,c=new GeoBeans.Style.Rule;c.filter=n,c.symbolizer=t;var d=MapCloud.refresh_panel.getTextSymbolizerIndexByFilter(r.filter,s);d==-1&&null!=t&&s.push(c),d!=-1&&null!=t&&(s[d].symbolizer=t),d!=-1&&null==t&&s.splice(d,1),MapCloud.refresh_panel.refreshPanel(),mapObj.draw()}}}}},getBaseLayerHtml:function(a){var t="",l=a.name,e="mc-icon-image",i=a.url,o=i.slice(i.lastIndexOf("=")+1,i.length);return"world_vector"==o?e="mc-icon-vector":"world_image"==o&&(e="mc-icon-image"),t+='\t<div class="col-md-1 col-xs-1">\t\t<div class="glyphicon glyphicon-chevron-down mc-icon"></div>\t</div>\t<div class="col-md-1 col-xs-1">',t+=a.visible?'\t\t<div class="glyphicon glyphicon-eye-open mc-icon"></div>':'\t\t<div class="glyphicon glyphicon-eye-close mc-icon"></div>',t+='\t</div>\t<div class="col-md-1 col-xs-1">\t\t<div class="mc-icon '+e+'"></div>\t</div>\t<div class="col-md-5 col-xs-5 layer_name">\t\t<strong title=\''+l+"'>"+l+'</strong>\t</div>\t<div class="col-md-1 col-xs-1 layer_name">\t</div>\t<div class="col-md-1 col-xs-1 layer_name">\t</div>\t<div class="col-md-1 col-xs-1 layer_row_quick_tool">\t\t<ul>\t\t\t<li class="dropdown pull-right">\t\t\t\t<a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">\t\t\t\t\t<b class="glyphicon glyphicon-cog"></b>\t\t\t\t</a>\t\t\t\t<ul class="dropdown-menu">\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_zoom"><i class=\'dropdown-menu-icon glyphicon glyphicon-zoom-in\'></i>放大到图层</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_remove_base"><i class=\'dropdown-menu-icon glyphicon glyphicon-remove\'></i>删除图层</a></li>\t\t\t\t</ul>\t\t\t</li>\t\t</ul>\t</div>'},getWMSLayerHtml:function(a,t){var l="",e=t.name;l='<li class="row layer_row" lname="'+e+'">\t<div class="col-md-1 col-xs-1">\t\t<div class="glyphicon glyphicon-chevron-right mc-icon mc-icon-right mc-icon-rotate"></div>\t</div>\t<div class="col-md-1 col-xs-1">',l+=t.visible?'\t\t<div class="glyphicon glyphicon-eye-open mc-icon"></div>':'\t\t<div class="glyphicon glyphicon-eye-close mc-icon"></div>',l+='\t</div>\t<div class="col-md-1 col-xs-1">\t\t<div class="mc-icon mc-icon-color"></div>\t</div>\t<div class="col-md-5 col-xs-5 layer_name">\t\t<strong>'+e+'</strong>\t</div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1 layer_row_quick_tool">\t\t<ul class="layer_row_quick_tool_ul">\t\t\t<li class="dropdown pull-right">\t\t\t\t<a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">\t\t\t\t\t<b class="glyphicon glyphicon-cog"></b>\t\t\t\t</a>\t\t\t\t<ul class="dropdown-menu">\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_zoom"><i class=\'dropdown-menu-icon glyphicon glyphicon-zoom-in\'></i>放大到图层</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_remove"><i class=\'dropdown-menu-icon glyphicon glyphicon-remove\'></i>删除图层</a></li>\t\t\t\t</ul>\t\t\t</li>\t\t</ul>\t</div>\t<br/>';for(var i=(t.layers,t.mapLayers),o=0;o<i.length;++o){var s=i[o];if(null!=s){var e=s.name,r='<div class="row wms_layer_row" mname="'+e+'" style="display:none">\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1">';r+=s.visible?'\t<div class="glyphicon glyphicon-eye-open mc-icon"></div>':'\t<div class="glyphicon glyphicon-eye-close mc-icon"></div>',r+=' </div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-5 col-xs-5">\t\t<strong class=\'wms-map-layer\'>'+e+"</strong>\t</div></div>",l+=r;var n=this.getStyleHtml(o,s.style);l+=n}}return l+="</li>"},getStyleHtml:function(a,t){if(null==t)return"";var l="",e=t.rules;if(0==e.length)return"";if(1!=e.length){var l="";if(t.styleClass==GeoBeans.Style.FeatureStyle.StyleClass.UNIQUE||t.styleClass==GeoBeans.Style.FeatureStyle.StyleClass.QUANTITIES){var i=MapCloud.styleManager_dialog.getProperyNameByRule(e[0]);l+='<div class="row layer_style_row" lID="'+a+'">\t<div class="col-md-1 col-xs-1"></div>\t<div class="col-md-1 col-xs-1"></div>\t<div class="col-md-1 col-xs-1"></div>\t<div class="col-md-5 col-xs-5"><strong>'+i+"\t</strong></div></div>"}for(var o=0;o<e.length;++o){var s=e[o];if(null!=s){var r=s.filter;if(null!=r){var n=MapCloud.styleManager_dialog.getSqlExpression(r),c=s.symbolizer,d=this.getSymbolizerHtml(c),p=this.getSymbolIconHtml(c.type,c.symbol);l+='<div class="row layer_style_row" lID="'+a+'" sID="'+o+'">\t<div class="col-md-1 col-xs-1"></div>\t<div class="col-md-1 col-xs-1"></div>\t<div class="col-md-1 col-xs-1"></div>\t<div class="col-md-1 col-xs-1">'+d+'\t</div>\t<div class="col-md-1 col-xs-1">'+p+'\t</div>\t<div class="col-md-5 col-xs-5">'+n+"\t</div></div>"}}}return l}var s=e[0];if(null!=s){var r=s.filter;if(null==r){var c=s.symbolizer;if(null!=c){var d=this.getSymbolizerHtml(c);if(null==d)return"";var p=this.getSymbolIconHtml(c.type,c.symbol);return null==p?"":l+='<div class="row layer_style_row" lID="'+a+'" sID="0">\t<div class="col-md-1 col-xs-1"></div>\t<div class="col-md-1 col-xs-1"></div>\t<div class="col-md-1 col-xs-1"></div>\t<div class="col-md-1 col-xs-1">'+d+'\t</div>\t<div class="col-md-1 col-xs-1">'+p+"\t</div></div>"}}}return""},getSymbolizerHtml:function(a){var t=MapCloud.styleManager_dialog.getSymbolHtml(a);return t},getSymbolIconHtml:function(a,t){var l=MapCloud.styleManager_dialog.getSymbolIconHtml(a,t);return l},getWFSLayerHtml:function(a,t){var l=t.name;t.style;return html='<li class="row layer_row" lname="'+l+'">\t<div class="col-md-1 col-xs-1">\t\t<div class="glyphicon glyphicon-chevron-right mc-icon mc-icon-right mc-icon-rotate"></div>\t</div>\t<div class="col-md-1 col-xs-1">',t.visible?html+='\t\t<div class="glyphicon glyphicon-eye-open mc-icon"></div>':html+='\t\t<div class="glyphicon glyphicon-eye-close mc-icon"></div>',html+='\t</div>\t<div class="col-md-1 col-xs-1">\t\t<div class="mc-icon mc-icon-layer mc-icon-wfslayer"></div>\t</div>\t<div class="col-md-5 col-xs-5 layer_name">\t\t<strong>'+l+'</strong>\t</div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1 layer_row_quick_tool">\t\t<ul class="layer_row_quick_tool_ul">\t\t\t<li class="dropdown pull-right">\t\t\t\t<a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">\t\t\t\t\t<b class="glyphicon glyphicon-cog"></b>\t\t\t\t</a>\t\t\t\t<ul class="dropdown-menu">\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_zoom"><i class=\'dropdown-menu-icon glyphicon glyphicon-zoom-in\'></i>放大到图层</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_remove"><i class=\'dropdown-menu-icon glyphicon glyphicon-remove\'></i>删除图层</a></li>\t\t\t\t</ul>\t\t\t</li>\t\t</ul>\t</div>\t<br/>',html+="</li>",html},setRule:function(a){var t=mapObj.getLayer(this.layerName);if(null!=t){var l=t.style;if(null!=l){var e=l.rules;if(null!=e){var i=e[this.styleID];if(null!=i){var o=i.symbolizer.symbol;a.symbolizer.symbol=o,i.symbolizer=a.symbolizer,i.textSymbolizer=a.textSymbolizer;var s=l.name;if("default"==s)mapObj.draw(),MapCloud.refresh_panel.refreshPanel();else{var r=styleManager.writer.write(l);styleManager.updateStyle(r,s,this.updateCallback),mapObj.setStyle(this.layerName,l,this.setStyle_callback)}}}}}},updateCallback:function(a){MapCloud.notify.showInfo(a,"更新样式"),MapCloud.refresh_panel.refreshPanel()},setStyle_callback:function(a){MapCloud.notify.showInfo(a,"设置样式"),mapObj.draw(),MapCloud.refresh_panel.refreshPanel()},getDBLayerHtml:function(a,t){if(null==t)return"";var l=t.type,e="";return l==GeoBeans.Layer.DBLayer.Type.Raster?e=this.getRasterDBLayerHtml(t):l==GeoBeans.Layer.DBLayer.Type.Feature&&(e=this.getFeatureDBLayerHtml(t)),e},getFeatureDBLayerHtml:function(a){var t=a.name,l='<li class="row layer_row" lname="'+t+'">\t<div class="col-md-1 col-xs-1">\t\t<div class="glyphicon glyphicon-chevron-right mc-icon mc-icon-right mc-icon-rotate"></div>\t</div>\t<div class="col-md-1 col-xs-1">';l+=a.visible?'\t\t<div class="glyphicon glyphicon-eye-open mc-icon"></div>':'\t\t<div class="glyphicon glyphicon-eye-close mc-icon"></div>';var e="";if(a.geomType==GeoBeans.Geometry.Type.POINT||a.geomType==GeoBeans.Geometry.Type.MULTIPOINT){var i=a.getHeatMapLayer();e='<li><a href="javascript:void(0)" class="layer_row_quick_tool_heatMap">',e+=null!=i&&i.visible?"<i class='dropdown-menu-icon'><input type='checkbox' checked></i>":"<i class='dropdown-menu-icon'><input type='checkbox'></i>",e+="<span>热力图</span></a></li>"}else e="";return l+='\t</div>\t<div class="col-md-1 col-xs-1">\t\t<div class="mc-icon mc-icon-dblayer"></div>\t</div>\t<div class="col-md-5  col-xs-5 layer_name">\t\t<strong title=\''+t+"'>"+t+'</strong>\t</div>\t<div class=\'col-md-1 col-xs-1\'>\t\t<div class=\'fa fa-arrow-up mc-icon layer_oper\'></div>\t</div>\t<div class=\'col-md-1 col-xs-1\'>\t\t<div class=\'fa fa-arrow-down mc-icon layer_oper\'></div>\t</div>\t<div class="col-md-1 col-xs-1 layer_row_quick_tool">\t\t<ul class="layer_row_quick_tool_ul">\t\t\t<li class="dropdown pull-right">\t\t\t\t<a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">\t\t\t\t\t<b class="glyphicon glyphicon-cog"></b>\t\t\t\t</a>\t\t\t\t<ul class="dropdown-menu">\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_zoom"><i class=\'dropdown-menu-icon glyphicon glyphicon-zoom-in\'></i>放大到图层</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_layer_info"><i class=\'dropdown-menu-icon fa fa-list-ul\'></i>图层属性</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_features"><i class=\'dropdown-menu-icon fa fa-list-ul\'></i>属性数据</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_search"><i class=\'dropdown-menu-icon fa fa-search\'></i>属性查询</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_remove"><i class=\'dropdown-menu-icon glyphicon glyphicon-remove\'></i>删除图层</a></li>'+e+"\t\t\t\t</ul>\t\t\t</li>\t\t</ul>\t</div>\t<br/>",l+="</li>"},getRasterDBLayerHtml:function(a){var t=a.name,l='<li class="row layer_row" lname="'+t+'">\t<div class="col-md-1 col-xs-1">\t\t<div class="glyphicon glyphicon-chevron-right mc-icon mc-icon-right mc-icon-rotate"></div>\t</div>\t<div class="col-md-1 col-xs-1">';l+=a.visible?'\t\t<div class="glyphicon glyphicon-eye-open mc-icon"></div>':'\t\t<div class="glyphicon glyphicon-eye-close mc-icon"></div>';var e='<li><a href="javascript:void(0)" class="layer_row_quick_tool_stretch"><i class="dropdown-menu-icon"><input type="checkbox"></i><span>影像拉伸</span></a></li>';return l+='\t</div>\t<div class="col-md-1 col-xs-1">\t\t<div class="mc-icon mc-icon-dblayer mc-icon-dblayer-raster"></div>\t</div>\t<div class="col-md-5 col-xs-5 layer_name">\t\t<strong title=\''+t+"'>"+t+'</strong>\t</div>\t<div class=\'col-md-1\' col-xs-1>\t\t<div class=\'fa fa-arrow-up mc-icon layer_oper\'></div>\t</div>\t<div class=\'col-md-1 col-xs-1\'>\t\t<div class=\'fa fa-arrow-down mc-icon layer_oper\'></div>\t</div>\t<div class="col-md-1 col-xs-1 layer_row_quick_tool">\t\t<ul class="layer_row_quick_tool_ul">\t\t\t<li class="dropdown pull-right">\t\t\t\t<a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">\t\t\t\t\t<b class="glyphicon glyphicon-cog"></b>\t\t\t\t</a>\t\t\t\t<ul class="dropdown-menu">\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_zoom"><i class=\'dropdown-menu-icon glyphicon glyphicon-zoom-in\'></i>放大到图层</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_layer_info"><i class=\'dropdown-menu-icon fa fa-list-ul\'></i>图层属性</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_remove"><i class=\'dropdown-menu-icon glyphicon glyphicon-remove\'></i>删除图层</a></li>'+e+"\t\t\t\t</ul>\t\t\t</li>\t\t</ul>\t</div>\t<br/>",l+="</li>"},removeLayer_callback:function(a){MapCloud.notify.showInfo(a,"删除图层");var t=MapCloud.refresh_panel;t.refreshPanel(),mapObj.draw()},removeBaseLayer_callback:function(a){MapCloud.notify.showInfo(a,"删除底图");var t=MapCloud.refresh_panel;t.refreshPanel(),mapObj.draw()},getChartLayerHtml:function(a,t){if(null==t)return"";var l=t.name,e='<li class="row layer_row" lname="'+l+'">\t<div class="col-md-1 col-xs-1">\t\t<div class="glyphicon glyphicon-chevron-right mc-icon mc-icon-right mc-icon-rotate"></div>\t</div>\t<div class="col-md-1 col-xs-1">';return e+=t.visible?'\t\t<div class="glyphicon glyphicon-eye-open mc-icon"></div>':'\t\t<div class="glyphicon glyphicon-eye-close mc-icon"></div>',e+="\t</div>\t<div class=\"col-md-1 col-xs-1\">\t\t<a href='javascript:void(0)' class='mc-icon-chartlayer'>\t\t\t<i class='fa fa-bar-chart'></i>\t\t</a>\t</div>\t<div class=\"col-md-5 col-xs-5 layer_name\">\t\t<strong title='"+l+"'>"+l+'</strong>\t</div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1 layer_row_quick_tool">\t\t<ul class="layer_row_quick_tool_ul">\t\t\t<li class="dropdown pull-right">\t\t\t\t<a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">\t\t\t\t\t<b class="glyphicon glyphicon-cog"></b>\t\t\t\t</a>\t\t\t\t<ul class="dropdown-menu">\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_layer_info"><i class=\'dropdown-menu-icon fa fa-list-ul\'></i>图层属性</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_remove"><i class=\'dropdown-menu-icon glyphicon glyphicon-remove\'></i>删除图层</a></li>\t\t\t\t</ul>\t\t\t</li>\t\t</ul>\t</div>\t<br/>',e+="</li>"},registerAQILayerHitEvent:function(a,t){var l=mapObj.getLayer(a),e=mapObj.getLayer(t);if(null!=e&&(l instanceof GeoBeans.Layer.AQIChartLayer&&(l.unRegisterHitEvent(),MapCloud.aqi_stat_comp_dialog.cleanupStations()),e instanceof GeoBeans.Layer.AQIChartLayer)){var i="<div>\t\t<div style='margin:5px;text-align:center'>\t\t\t<a href='javascript:void(0)' style='width:100%' \t\t\tclass='aqi_24_h btn btn-sm btn-primary'>查看24小时变化图</a>\t\t</div>\t\t<div style='margin:5px;text-align:center'>\t\t\t<a href='javascript:void(0)' style='width:100%'\t\t\t\tclass='aqi_add_stat btn btn-sm btn-success'>加入对比</a>\t\t</div></div>";e.registerHitEvent(i,this.aqiHitCallback)}},aqiHitCallback:function(a,t,l){var e=MapCloud.refresh_panel;e.aqiChartLayer=l,e.stationCode=a,e.positionName=t,$(".aqi_24_h").click(function(){mapObj.closeInfoWindow();var a=MapCloud.aqi_24h_dialog;a.showDialog(),a.setStationCode(e.stationCode);var t=l.getTimeField();a.setTimeField(t);var i=l.timePoint;a.setTimePoint(i);var o=l.getDbName();a.setDbName(o);var s=l.getTableName();a.setTableName(s);var r=l.getChartField();a.setChartField(r);var n=l.getFlagField();a.setStationCodeField(n),a.setPositionName(e.positionName),a.showAQIIndexChart()}),$(".aqi_add_stat").click(function(){mapObj.closeInfoWindow();var a={name:e.positionName,code:e.stationCode};MapCloud.aqi_stat_comp_dialog.addStation(a),MapCloud.aqi_stat_comp_dialog.setChartLayer(l)})},saveMap_callback:function(a){MapCloud.notify.showInfo(a,"保存地图")},layerOper_callback:function(a){var t=MapCloud.refresh_panel;"success"==a?mapManager.saveMap(mapObj,t.saveMapLayers_callback):MapCloud.notify.showInfo(a,"调整底图顺序")},saveMapLayers_callback:function(a){MapCloud.notify.showInfo(a,"调整底图顺序"),MapCloud.refresh_panel.refreshPanel(),mapObj.draw()},setSymbol:function(a){if(null!=a){var t=("url("+a.icon+")",mapObj.getLayer(this.layerName));if(null!=t){var l=t.style;if(null!=l){var e=l.rules;if(null!=e){var i=e[this.styleID];if(null!=i){var o=i.symbolizer;if(null!=o){o.symbol=a;var s=l.name;if("default"==s)mapObj.draw(),this.refreshPanel();else{var r=styleManager.writer.write(l);styleManager.updateStyle(r,s,this.updateCallback),mapObj.setStyle(this.layerName,l,this.setStyle_callback)}}}}}}}},getStyleXML_callback:function(a){MapCloud.notify.hideLoading();var t=MapCloud.refresh_panel,l=t.panel.find(".layer_row[lname='"+t.getStyleLayerName+"']"),e=t.getStyleHtml(-1,a);l.append(e);var i=$(".layers-items").css("height");i=parseInt(i.slice(0,i.lastIndexOf("px"))),i<600?$(".layers-items").css("overflow-y","visible"):$(".layers-items").css("overflow-y","auto"),t.registerSymbolIconClickEvent(),t.registerStyleSymbolClickEvent();var o=mapObj.getLayer(t.getStyleLayerName);o.style=a,t.getStyleLayerName=null},refreshMap_callback:function(a){MapCloud.notify.showInfo(a,"刷新地图"),mapObj.draw(),MapCloud.refresh_panel.refreshPanel()},zoomToGlobeMap_callback:function(a){MapCloud.notify.showInfo(a,"全图显示"),MapCloud.refresh_panel.refreshPanel()},getClusterLayer:function(a,t){if(null!=t){var l=t.name,e='<li class="row layer_row" lname="'+l+'">\t<div class="col-md-1 col-xs-1">\t\t<div class="glyphicon glyphicon-chevron-right mc-icon mc-icon-right mc-icon-rotate"></div>\t</div>\t<div class="col-md-1 col-xs-1">';return e+=t.visible?'\t\t<div class="glyphicon glyphicon-eye-open mc-icon"></div>':'\t\t<div class="glyphicon glyphicon-eye-close mc-icon"></div>',e+="\t</div>\t<div class=\"col-md-1 col-xs-1\">\t\t<a href='javascript:void(0)' class='mc-icon-cluster-layer'>\t\t\t<i class='fa fa-bar-chart'></i>\t\t</a>\t</div>\t<div class=\"col-md-5 col-xs-5 layer_name\">\t\t<strong title='"+l+"'>"+l+'</strong>\t</div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1 layer_row_quick_tool">\t\t<ul class="layer_row_quick_tool_ul">\t\t\t<li class="dropdown pull-right">\t\t\t\t<a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">\t\t\t\t\t<b class="glyphicon glyphicon-cog"></b>\t\t\t\t</a>\t\t\t\t<ul class="dropdown-menu">\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_layer_info"><i class=\'dropdown-menu-icon fa fa-list-ul\'></i>图层属性</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_remove"><i class=\'dropdown-menu-icon glyphicon glyphicon-remove\'></i>删除图层</a></li>\t\t\t\t</ul>\t\t\t</li>\t\t</ul>\t</div>\t<br/>',e+="</li>"}},getRippleLayer:function(a,t){if(null!=t){var l=t.name,e='<li class="row layer_row" lname="'+l+'">\t<div class="col-md-1 col-xs-1">\t\t<div class="glyphicon glyphicon-chevron-right mc-icon mc-icon-right mc-icon-rotate"></div>\t</div>\t<div class="col-md-1 col-xs-1">';return e+=t.visible?'\t\t<div class="glyphicon glyphicon-eye-open mc-icon"></div>':'\t\t<div class="glyphicon glyphicon-eye-close mc-icon"></div>',e+="\t</div>\t<div class=\"col-md-1 col-xs-1\">\t\t<a href='javascript:void(0)' class='mc-icon-ripple-layer'>\t\t\t<i class='fa fa-bar-chart'></i>\t\t</a>\t</div>\t<div class=\"col-md-5 col-xs-5 layer_name\">\t\t<strong title='"+l+"'>"+l+'</strong>\t</div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1">\t</div>\t<div class="col-md-1 col-xs-1 layer_row_quick_tool">\t\t<ul class="layer_row_quick_tool_ul">\t\t\t<li class="dropdown pull-right">\t\t\t\t<a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">\t\t\t\t\t<b class="glyphicon glyphicon-cog"></b>\t\t\t\t</a>\t\t\t\t<ul class="dropdown-menu">\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_layer_info"><i class=\'dropdown-menu-icon fa fa-list-ul\'></i>图层属性</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_remove"><i class=\'dropdown-menu-icon glyphicon glyphicon-remove\'></i>删除图层</a></li>\t\t\t\t</ul>\t\t\t</li>\t\t</ul>\t</div>\t<br/>',
e+="</li>"}},getAirlineLayer:function(a,t){if(null!=t){var l=t.name,e='<li class="row layer_row" lname="'+l+'">\t<div class="col-md-1 col-xs-1">\t\t<div class="glyphicon glyphicon-chevron-right mc-icon mc-icon-right mc-icon-rotate"></div>\t</div>\t<div class="col-md-1 col-xs-1">';return e+=t.visible?'\t\t<div class="glyphicon glyphicon-eye-open mc-icon"></div>':'\t\t<div class="glyphicon glyphicon-eye-close mc-icon"></div>',e+="\t</div>\t<div class=\"col-md-1 col-xs-1\">\t\t<a href='javascript:void(0)' class='mc-icon-airline-layer'>\t\t\t<i class='fa fa-bar-chart'></i>\t\t</a>\t</div>\t<div class=\"col-md-5 col-xs-5 layer_name\">\t\t<strong title='"+l+"'>"+l+'</strong>\t</div>\t<div class="col-md-1">\t</div>\t<div class="col-md-1">\t</div>\t<div class="col-md-1 col-xs-1 layer_row_quick_tool">\t\t<ul class="layer_row_quick_tool_ul">\t\t\t<li class="dropdown pull-right">\t\t\t\t<a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">\t\t\t\t\t<b class="glyphicon glyphicon-cog"></b>\t\t\t\t</a>\t\t\t\t<ul class="dropdown-menu">\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_layer_info"><i class=\'dropdown-menu-icon fa fa-list-ul\'></i>图层属性</a></li>\t\t\t\t\t<li><a href="javascript:void(0)" class="layer_row_quick_tool_remove"><i class=\'dropdown-menu-icon glyphicon glyphicon-remove\'></i>删除图层</a></li>\t\t\t\t</ul>\t\t\t</li>\t\t</ul>\t</div>\t<br/>',e+="</li>"}},createService:function(){if(null==mapObj)return void MapCloud.notify.showInfo("当前地图为空","Warning");var a=mapObj.name,t="http://www.radi.ac.cn/"+a;serviceManager.createService(a,a,t,this.createService_callback)},createService_callback:function(a){MapCloud.notify.showInfo(a,"发布服务")}});
MapCloud.SearchPanel=MapCloud.Class(MapCloud.Panel,{layer:null,operList:["=","<>","Like",">",">=","<","<="],fitler:null,initialize:function(e){MapCloud.Panel.prototype.initialize.apply(this,arguments),this.registerPanelEvent()},setLayer:function(e){if(null!=e){this.layer=e;var l=this.layer.getFields();this.setFields(l)}},showPanel:function(e){if(null!=e){var l=e.getFields();if(!$.isArray(l))return void MapCloud.notify.showInfo(l,"Warning");MapCloud.Panel.prototype.showPanel.apply(this,arguments),this.setFields(l),this.layer=e}},cleanup:function(){this.layer=null,this.filter=null,this.panel.find(".search-fields-div").html(""),this.panel.find(".search-unique-values").html(""),this.panel.find("#get_unique_btn").removeClass("disabled"),this.panel.find("#search-sql-content").val("")},registerPanelEvent:function(){var e=this;this.panel.find("#get_unique_btn").click(function(){var l=e.panel.find(".search-fields-div .list-group-item.active"),i=l.attr("value");null!=i&&($(this).addClass("disabled"),e.getUniqueValues(i))}),this.panel.find(".search-oper .oper-row .btn").each(function(l,i){$(this).click(function(i){var n=null;switch(l){case 0:n="=";break;case 1:n="<>";break;case 2:n="Like";break;case 3:n=">";break;case 4:n=">=";break;case 5:n="<";break;case 6:n="<="}var a=e.panel.find("#search-sql-content").val();e.sqlAddOper(a,n)})}),this.panel.find(".sql-clear-btn").click(function(){e.panel.find("#search-sql-content").val("")}),this.panel.find(".btn-search").click(function(){e.searchFeatures()})},setFields:function(e){if(null!=e){for(var l=null,i=null,n="",a=0;a<e.length;++a)l=e[a],null!=l&&(i=l.name,"geometry"!=l.type&&(n+="<a href='#' class='list-group-item' value='"+i+"'>\""+i+'"</a>'));this.panel.find(".search-fields-div").html(n),this.registerFieldEvent()}},registerFieldEvent:function(){var e=this;this.panel.find(".search-fields-div .list-group-item").click(function(){var l=e.panel.find(".search-fields-div .list-group-item.active");l.attr("value")!=$(this).attr("value")&&($(this).parent().children().removeClass("active"),$(this).addClass("active"),e.panel.find(".search-unique-values").html(""),e.panel.find("#get_unique_btn").removeClass("disabled"))}).dblclick(function(){var l=$(this).attr("value"),i=e.panel.find("#search-sql-content").val();e.sqlAddField(i,l)})},getUniqueValues:function(e){if(null!=e&&null!=this.layer){var l=this.layer.featureType;if(null!=l){var i=l.workspace;null!=i&&i.getValue(this.layer.name,e,mapObj.name,this.getUniqueValues_callback)}}},getUniqueValues_callback:function(e){if(null!=e){var l=MapCloud.search_panel;l.displayUniqueValues(e)}},displayUniqueValues:function(e){if(null!=e){for(var l=null,i="",n=0;n<e.length;++n)l=e[n],i+="<a href='#' class='list-group-item'>"+l+"</a>";this.panel.find(".search-unique-values").html(i),this.registerUniqueValuesEvent()}},registerUniqueValuesEvent:function(){var e=this;this.panel.find(".search-unique-values .list-group-item").click(function(){$(this).parent().children().removeClass("active"),$(this).addClass("active")}).dblclick(function(){var l=$(this).html(),i=e.panel.find("#search-sql-content").val();e.sqlAddValue(i,l)})},searchFeatures:function(){var e=this.panel.find("#search-sql-content").val(),l=this.getFilter(e);this.filter=l;var i=mapObj.getFeatureFilterCount(this.layer.name,l);MapCloud.dataGrid.setQuery(this.layer,i,this.query_function),MapCloud.dataGrid.setOutput(this.output_function)},query_function:function(e,l){var i=MapCloud.search_panel,n=mapObj.getFeatureFilter(i.layer.name,i.filter,e,l);return n},output_function:function(e,l){var i=MapCloud.search_panel,n=mapObj.queryByFilterOutput(i.layer.name,i.filter,e,l);return n},sqlAddField:function(e,l){if(null!=e&&null!=l){for(var i=e.split(" "),n=0;n<i.length;++n){var a=i[n];if(this.isField(a)){var t=new RegExp(a,"g");return e=e.replace(t,l),void this.panel.find("#search-sql-content").val(e)}}var r=this.panel.find("#search-sql-content").val();this.panel.find("#search-sql-content").val(l+r)}},isField:function(e){if(null!=e){var l=this.layer.getFields();if(null!=l){for(var i=null,n=0;n<l.length;++n)if(i=l[n],i.name==e)return!0;return!1}}},sqlAddOper:function(e,l){if(null!=e&&null!=l){for(var i=e.split(" "),n=!1,a=0;a<i.length;++a){var t=i[a];if(this.isOper(t)){var r=new RegExp(t,"g");return e=e.replace(r,l),void this.panel.find("#search-sql-content").val(e)}this.isField(t)&&(n=!0,field=t)}if(n&&null!=field){var s=(e.indexOf(field)+field.length,[e.slice(0,e.indexOf(field)+field.length)," "+l,e.slice(e.indexOf(field)+field.length,e.length)]);e=s.join(""),this.panel.find("#search-sql-content").val(e)}}},isOper:function(e){if(null!=e)return this.operList.indexOf(e)!=-1},sqlAddValue:function(e,l){if(null!=e&&null!=l){for(var i=e.split(" "),n=null,a=0;a<i.length;++a){var t=i[a];if(""!=t&&!this.isOper(t)&&!this.isField(t)&&(null==n?n=t:n+=" "+t,a==i.length-1)){var r=new RegExp(n,"g");return e=e.replace(r,l),void this.panel.find("#search-sql-content").val(e)}}var s=this.panel.find("#search-sql-content").val();this.panel.find("#search-sql-content").val(s+" "+l)}},getFilter:function(e){if(null==e)return null;for(var l=e.split(" "),i=null,n=null,a=null,t=0;t<l.length;++t){var r=l[t];this.isOper(r)&&(i=r),this.isField(r)&&(n=r),this.isOper(r)||this.isField(r)||(null==a?a=r:a+=" "+r)}if(null==i||null==n||null==a)return null;var s=this.createFilter(i,n,a);return s},createFilter:function(e,l,i){if(null==e||null==l||null==i)return null;var n=this.getComparisionOperator(e);if(null!=n){var a=new GeoBeans.PropertyName;a.setName(l);var t=new GeoBeans.Literal;if(t.setValue(i),n==GeoBeans.ComparisionFilter.OperatorType.ComOprIsLike){var r=new GeoBeans.IsLikeFilter;return r.properyName=a,r.literal=t,r.operator=n,r}var s=new GeoBeans.BinaryComparisionFilter;return s.expression1=a,s.expression2=t,s.operator=n,s}},getComparisionOperator:function(e){if(null==e)return null;var l=null;switch(e){case"=":l=GeoBeans.ComparisionFilter.OperatorType.ComOprEqual;break;case"<>":l=GeoBeans.ComparisionFilter.OperatorType.ComOprNotEqual;break;case"Like":l=GeoBeans.ComparisionFilter.OperatorType.ComOprIsLike;break;case">":l=GeoBeans.ComparisionFilter.OperatorType.ComOprGreaterThan;break;case">=":l=GeoBeans.ComparisionFilter.OperatorType.ComOprGreaterThanOrEqual;break;case"<":l=GeoBeans.ComparisionFilter.OperatorType.ComOprLessThan;break;case"<=":l=GeoBeans.ComparisionFilter.OperatorType.ComOprLessThanOrEqual}return l}});
...
MapCloud.GPSSridDialog=MapCloud.Class(MapCloud.Dialog,{maxCount:10,pageCount:null,pageNumber:5,source:null,initialize:function(i){MapCloud.Dialog.prototype.initialize.apply(this,arguments);this.registerPanelEvent()},registerPanelEvent:function(){var i=this;this.panel.find(".btn-search-srid").click(function(){var a=i.panel.find(".search-srid-name").val();if(null==a||""==a)return MapCloud.notify.showInfo("请输入查询Srid","Warning"),void i.panel.find(".search-srid-name").focus();var t=/^[0-9]+$/;return t.test(a)?(MapCloud.notify.loading(),i.panel.find(".srid-list-div").html(""),void gpsManager.getSpatialReferenceBySrid(a,i.getSpatialReferenceBySrid_callback)):(MapCloud.notify.showInfo("请输入一个有效的查询值","Warning"),void i.panel.find(".search-srid-name").focus())}),this.panel.find(".btn-confirm").click(function(){if("featureProject"==i.source){var a=i.panel.find(".srid-list-div .row.selected"),t=a.attr("sname");if(null==t)return void MapCloud.notify.showInfo("请选择一个空间参考","Warning");var e=MapCloud.gps_feature_project_dialog;e.setSrid(t)}else if("genRandomPoints"==i.source){var a=i.panel.find(".srid-list-div .row.selected"),t=a.attr("sname");if(null==t)return void MapCloud.notify.showInfo("请选择一个空间参考","Warning");var e=MapCloud.gps_gen_random_points_dialog;e.setSrid(t)}i.closeDialog()})},showDialog:function(i){var a=$("body").width(),t=this.panel.find(".modal-dialog").width();a<t&&(t=a-40,this.panel.find(".modal-dialog").css("width",t+"px")),MapCloud.Dialog.prototype.showDialog.apply(this,arguments),this.source=i,this.getSpatialReferenceListCount()},cleanup:function(){this.panel.find(".srid-list-div").empty(),this.panel.find(".search-srid-name").val(),this.panel.find(".pagination").empty(),this.panel.find(".search-srid-name").val("")},getSpatialReferenceList:function(i,a){gpsManager.getSpatialReferenceList(i,a,this.getSpatialReferenceList_callback)},getSpatialReferenceListCount:function(){gpsManager.getSpatialReferenceCount(this.getSpatialReferenceListCount_callback)},getSpatialReferenceListCount_callback:function(i){if(null!=i){var a=MapCloud.gps_srid_dialog,t=Math.ceil(i/a.maxCount);a.pageCount=t,a.initPageControl(1,a.pageCount)}},getSpatialReferenceList_callback:function(i){var a=MapCloud.gps_srid_dialog;a.showSridList(i)},setSpatialReferenceList:function(i){this.list=i;var a=Math.ceil(i.length/this.maxCount);this.pageCount=a,this.initPageControl(1,this.pageCount)},initPageControl:function(i,a){if(!(i<=0||i>a)){var t="";if(t+=1==i?'<li class="disabled">\t\t<a href="#" aria-label="Previous">\t\t\t<span aria-hidden="true">«</span>\t\t</a>\t</li>':'<li>\t\t<a href="#" aria-label="Previous">\t\t\t<span aria-hidden="true">«</span>\t\t</a>\t</li>',a<=this.pageNumber)for(var e=1;e<=a;++e)t+=e==i?'<li class="active">\t<a href="#">'+i.toString()+'\t\t<span class="sr-only">(current)</span></a></li>':"<li><a href='#'>"+e+"</a></li>";else{var n=a-this.pageNumber+1;if(i<=n)for(var e=i;e<i+this.pageNumber;++e)t+=e==i?'<li class="active">\t<a href="#">'+i+"</a></li>":"<li><a href='#'>"+e+"</a></li>";else for(var e=n;e<=a;++e)t+=e==i?'<li class="active">\t<a href="#">'+i+"</a></li>":"<li><a href='#'>"+e+"</a></li>"}t+=i==a?'<li class="disabled">\t\t<a href="#" aria-label="Next">\t\t\t<span aria-hidden="true">»</span>\t\t</a>\t</li>':'<li>\t\t<a href="#" aria-label="Next">\t\t\t<span aria-hidden="true">»</span>\t\t</a>\t</li>',this.panel.find(".pagination").html(t),this.registerPageEvent();var l=(i-1)*this.maxCount;this.getSpatialReferenceList(this.maxCount,l)}},registerPageEvent:function(){var i=this;this.panel.find(".pagination li a").click(function(){var a=i.panel.find(".pagination li.active a").html(),t=parseInt(a),e=$(this).attr("aria-label");"Previous"==e?t-=1:"Next"==e?t+=1:t=parseInt($(this).html()),i.initPageControl(t,i.pageCount)})},showSridList:function(i){if(null!=i){for(var a=null,t="",e=0;e<=i.length;++e)a=i[e],null!=a&&(t+="<div class='row' sname='"+a.srid+"'><div class='col-md-1 col-xs-1'>"+a.srid+"</div><div class='col-md-11 col-xs-11 text-ellip'>"+a.srtext+"</div></div>");this.panel.find(".srid-list-div").html(t);var n=this;this.panel.find(".srid-list-div .row").click(function(){n.panel.find(".srid-list-div .row.selected").removeClass("selected"),$(this).addClass("selected")})}},getSpatialReferenceBySrid_callback:function(i){if(MapCloud.notify.hideLoading(),null!=i&&0!=i.length){var a=MapCloud.gps_srid_dialog;a.showSridList(i)}}});
